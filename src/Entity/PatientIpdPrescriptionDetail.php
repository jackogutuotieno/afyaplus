...
/**
 * Entity class for "patient_ipd_prescription_details" table
 */
#[Entity]
#[Table(name: "patient_ipd_prescription_details")]
class PatientIpdPrescriptionDetail extends AbstractEntity
{
    #[Id]

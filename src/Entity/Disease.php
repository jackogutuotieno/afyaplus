...
/**
 * Entity class for "diseases" table
 */
#[Entity]
#[Table(name: "diseases")]
class Disease extends AbstractEntity
{
    ...
    #[Column(name: "icd10_code", type: "string")]
    ...
    {
        return HtmlDecode($this->icd10Code);
    }

    public function setIcd10Code(string $value): static
    {
        $this->icd10Code = RemoveXss($value);
        return $this;
    }

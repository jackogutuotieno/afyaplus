...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/afyaplus.css", // Project stylesheet file name
    ...
    "AES_ENCRYPTION_KEY" => "f18CVb7kM6w9E6XqYaksTeZfxyYd2fxWQTLQs1ZH4+Q=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\afyaplus\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\afyaplus\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-32536b8d-f37b-4419-80d5-260932800712", // Export folder

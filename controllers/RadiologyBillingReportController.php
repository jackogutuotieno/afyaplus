...
class RadiologyBillingReportController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/radiologybillingreportlist[/{id}]", [PermissionMiddleware::class], "list.radiology_billing_report")]

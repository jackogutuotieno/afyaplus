...
<?php if ($Page->national_id->Visible) { ?>
    <th data-name="national_id" class="<?= $Page->national_id->headerCellClass() ?>"><div class="Registered_Patients_national_id"><?= $Page->renderFieldHeader($Page->national_id) ?></div></th>
<?php } ?>
...
<?php if ($Page->age->Visible) { ?>
    <th data-name="age" class="<?= $Page->age->headerCellClass() ?>"><div class="Registered_Patients_age"><?= $Page->renderFieldHeader($Page->age) ?></div></th>
<?php } ?>

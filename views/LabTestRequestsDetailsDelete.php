...
// Page object
$LabTestRequestsDetailsDelete = &$Page;
?>
<script>
...
var currentForm;
var flab_test_requests_detailsdelete;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("flab_test_requests_detailsdelete")
        .setPageId("delete")
        .build();
    window[form.id] = form;
    currentForm = form;
...
$Page->showMessage();
?>
<form name="flab_test_requests_detailsdelete" id="flab_test_requests_detailsdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">

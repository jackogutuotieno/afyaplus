...
<span id="el_radiology_reports_created_by_user_id">
    <select
        ...
        data-select2-id="fradiology_reportsedit_x_created_by_user_id"
        <?php } ?>
        data-table="radiology_reports"
...
loadjs.ready("fradiology_reportsedit", function() {
    var options = { name: "x_created_by_user_id", selectId: "fradiology_reportsedit_x_created_by_user_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fradiology_reportsedit.lists.created_by_user_id?.lookupOptions.length) {
        options.data = { id: "x_created_by_user_id", form: "fradiology_reportsedit" };
    } else {
        options.ajax = { id: "x_created_by_user_id", form: "fradiology_reportsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }

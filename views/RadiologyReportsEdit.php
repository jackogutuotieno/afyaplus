...
<script>
loadjs.ready(["fradiology_reportsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fradiology_reportsedit", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fradiology_reportsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fradiology_reportsedit", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

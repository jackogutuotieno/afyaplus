...
<?php
if ($Page->DbMasterFilter != "" && $Page->getCurrentMasterTable() == "invoices") {
    if ($Page->MasterRecordExists) {
        include_once "views/InvoicesMaster.php";
    }
}
?>
<?php } ?>
...
<?php } ?>
<?php if ($Page->getCurrentMasterTable() == "invoices" && $Page->CurrentAction) { ?>

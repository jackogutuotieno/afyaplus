...
loadjs.ready(["finvoicesadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("finvoicesadd", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["finvoicesadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("finvoicesadd", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

...
// Page object
$FullHaemogramParametersDelete = &$Page;
?>
<script>
...
var currentForm;
var ffull_haemogram_parametersdelete;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("ffull_haemogram_parametersdelete")
        .setPageId("delete")
        .build();
    window[form.id] = form;
    currentForm = form;
...
$Page->showMessage();
?>
<form name="ffull_haemogram_parametersdelete" id="ffull_haemogram_parametersdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_full_haemogram_parameters_id" class="full_haemogram_parameters_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>

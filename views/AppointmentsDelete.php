...
<?php if ($Page->_title->Visible) { // title ?>
        <th class="<?= $Page->_title->headerCellClass() ?>"><span id="elh_Appointments__title" class="Appointments__title"><?= $Page->_title->caption() ?></span></th>
<?php } ?>
<?php if ($Page->description->Visible) { // description ?>
        <th class="<?= $Page->description->headerCellClass() ?>"><span id="elh_Appointments_description" class="Appointments_description"><?= $Page->description->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->start_date->Visible) { // start_date ?>
        <th class="<?= $Page->start_date->headerCellClass() ?>"><span id="elh_Appointments_start_date" class="Appointments_start_date"><?= $Page->start_date->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->date_created->Visible) { // date_created ?>
        <th class="<?= $Page->date_created->headerCellClass() ?>"><span id="elh_Appointments_date_created" class="Appointments_date_created"><?= $Page->date_created->caption() ?></span></th>
<?php } ?>

...
$Page->showMessage();
?>
<form name="ffloorsdelete" id="ffloorsdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->floor_name->Visible) { // floor_name ?>
        <td<?= $Page->floor_name->cellAttributes() ?>>
<span id="">

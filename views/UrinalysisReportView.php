...
?>
<main class="view">
<form name="furinalysis_reportview" id="furinalysis_reportview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_urinalysis_report_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->lab_test_reports_id->Visible) { // lab_test_reports_id ?>
    <tr id="r_lab_test_reports_id"<?= $Page->lab_test_reports_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_urinalysis_report_lab_test_reports_id"><?= $Page->lab_test_reports_id->caption() ?></span></td>
...
<?php if ($Page->_template->Visible) { // template ?>
    <tr id="r__template"<?= $Page->_template->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_urinalysis_report__template"><?= $Page->_template->caption() ?></span></td>
...
<?php if ($Page->date_created->Visible) { // date_created ?>
    <tr id="r_date_created"<?= $Page->date_created->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_urinalysis_report_date_created"><?= $Page->date_created->caption() ?></span></td>
...
<?php if ($Page->date_updated->Visible) { // date_updated ?>
    <tr id="r_date_updated"<?= $Page->date_updated->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_urinalysis_report_date_updated"><?= $Page->date_updated->caption() ?></span></td>

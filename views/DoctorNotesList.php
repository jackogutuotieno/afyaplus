...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_doctor_notes_id" class="doctor_notes_id"><?= $Page->renderFieldHeader($Page->id) ?></div></th>
<?php } ?>
...
<?php if ($Page->date_updated->Visible) { // date_updated ?>
        <th data-name="date_updated" class="<?= $Page->date_updated->headerCellClass() ?>"><div id="elh_doctor_notes_date_updated" class="doctor_notes_date_updated"><?= $Page->renderFieldHeader($Page->date_updated) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_doctor_notes_id" class="el_doctor_notes_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_doctor_notes_date_updated" class="el_doctor_notes_date_updated">

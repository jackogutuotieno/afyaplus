...
<?php } ?>
<?php
    if (in_array("medicine_dispensation", explode(",", $Page->getCurrentDetailTable())) && $medicine_dispensation->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patients_radiology_reports", explode(",", $Page->getCurrentDetailTable())) && $patients_radiology_reports->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>

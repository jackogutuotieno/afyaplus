...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_expenses_id" class="expenses_id"><?= $Page->renderFieldHeader($Page->id) ?></div></th>
<?php } ?>
...
<?php if ($Page->created_by_user_id->Visible) { // created_by_user_id ?>
        <th data-name="created_by_user_id" class="<?= $Page->created_by_user_id->headerCellClass() ?>"><div id="elh_expenses_created_by_user_id" class="expenses_created_by_user_id"><?= $Page->renderFieldHeader($Page->created_by_user_id) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_expenses_id" class="el_expenses_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_expenses_created_by_user_id" class="el_expenses_created_by_user_id">

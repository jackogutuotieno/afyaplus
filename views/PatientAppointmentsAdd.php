...
loadjs.ready(["fpatient_appointmentsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpatient_appointmentsadd", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpatient_appointmentsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpatient_appointmentsadd", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

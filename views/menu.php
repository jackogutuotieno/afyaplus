...
$sideMenu->addMenuItem(438, "mi_patients_radiology_reports", $Language->menuPhrase("438", "MenuText"), "patientsradiologyreportslist?cmd=resetall", 102, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}patients_radiology_reports'), false, false, "fa-list", "", false, true);
...
$sideMenu->addMenuItem(643, "mi_invoice_report", $Language->menuPhrase("643", "MenuText"), "invoicereportlist", 53, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}invoice_report'), false, false, "fa-file-invoice", "", false, true);
...
$sideMenu->addMenuItem(751, "mi_leave_balance", $Language->menuPhrase("751", "MenuText"), "leavebalancelist", 49, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}leave_balance'), false, false, "fa-list", "", false, true);
$sideMenu->addMenuItem(752, "mi_leave_approvals", $Language->menuPhrase("752", "MenuText"), "leaveapprovalslist", 49, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}leave_approvals'), false, false, "fa-check", "", false, true);

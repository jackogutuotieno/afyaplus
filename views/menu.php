...
$sideMenu->addMenuItem(325, "mi_Facility_Overview", $Language->menuPhrase("325", "MenuText"), "facilityoverview", -1, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}Facility Overview'), false, false, "fa-tachometer", "", false, true);
...
$sideMenu->addMenuItem(51, "mci_Patients", $Language->menuPhrase("51", "MenuText"), "", -1, "", true, false, true, "fa-hospital-user", "", false, true);
$sideMenu->addMenuItem(48, "mi_patients", $Language->menuPhrase("48", "MenuText"), "patientslist", 51, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}patients'), false, false, "fa-cog", "", false, true);
$sideMenu->addMenuItem(24, "mi_patient_visits", $Language->menuPhrase("24", "MenuText"), "patientvisitslist?cmd=resetall", 51, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}patient_visits'), false, false, "fa-list", "", false, true);
$sideMenu->addMenuItem(114, "mi_patient_queue", $Language->menuPhrase("114", "MenuText"), "patientqueuelist?cmd=resetall", 51, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}patient_queue'), false, false, "fa-list", "", false, true);
$sideMenu->addMenuItem(22, "mi_patient_appointments", $Language->menuPhrase("22", "MenuText"), "patientappointmentslist?cmd=resetall", 51, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}patient_appointments'), false, false, "fa-calendar", "", false, true);
$sideMenu->addMenuItem(109, "mi_Appointments", $Language->menuPhrase("109", "MenuText"), "appointments", 51, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}Appointments'), false, false, "fa-calendar", "", false, true);
$sideMenu->addMenuItem(25, "mi_patient_vitals", $Language->menuPhrase("25", "MenuText"), "patientvitalslist?cmd=resetall", 51, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}patient_vitals'), false, false, "fa-weight-scale", "", false, true);
$sideMenu->addMenuItem(23, "mi_patient_vaccinations", $Language->menuPhrase("23", "MenuText"), "patientvaccinationslist?cmd=resetall", 51, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}patient_vaccinations'), false, false, "fa-syringe", "", false, true);
...
$sideMenu->addMenuItem(7, "mi_doctor_notes", $Language->menuPhrase("7", "MenuText"), "doctornoteslist?cmd=resetall", 51, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}doctor_notes'), false, false, "fa-file-medical", "", false, true);
$sideMenu->addMenuItem(28, "mi_prescriptions", $Language->menuPhrase("28", "MenuText"), "prescriptionslist?cmd=resetall", 51, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}prescriptions'), false, false, "fa-prescription-bottle", "", false, true);
$sideMenu->addMenuItem(38, "mi_visit_types", $Language->menuPhrase("38", "MenuText"), "visittypeslist", 51, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}visit_types'), false, false, "fa-list", "", false, true);
...
$sideMenu->addMenuItem(6, "mi_doctor_charges", $Language->menuPhrase("6", "MenuText"), "doctorchargeslist", 50, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}doctor_charges'), false, false, "fa-money-bil", "", false, true);
...
$sideMenu->addMenuItem(15, "mi_lab_test_requests_queue", $Language->menuPhrase("15", "MenuText"), "labtestrequestsqueuelist?cmd=resetall", 52, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}lab_test_requests_queue'), false, false, "fa-list", "", false, true);
$sideMenu->addMenuItem(12, "mi_lab_test_reports", $Language->menuPhrase("12", "MenuText"), "labtestreportslist?cmd=resetall", 52, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}lab_test_reports'), false, false, "fa-list", "", false, true);
...
$sideMenu->addMenuItem(32, "mi_radiology_requests_queue", $Language->menuPhrase("32", "MenuText"), "radiologyrequestsqueuelist?cmd=resetall", 102, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}radiology_requests_queue'), false, false, "fa-list", "", false, true);
...
$sideMenu->addMenuItem(54, "mci_Pharmacy", $Language->menuPhrase("54", "MenuText"), "", -1, "", true, false, true, "fa-suitcase-medical", "", false, true);
$sideMenu->addMenuItem(21, "mi_medicine_suppliers", $Language->menuPhrase("21", "MenuText"), "medicinesupplierslist", 54, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}medicine_suppliers'), false, false, "fa-suitcase-medical", "", false, true);
$sideMenu->addMenuItem(17, "mi_medicine_brands", $Language->menuPhrase("17", "MenuText"), "medicinebrandslist", 54, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}medicine_brands'), false, false, "fa-suitcase-medical", "", false, true);
$sideMenu->addMenuItem(47, "mi_medicine_stock", $Language->menuPhrase("47", "MenuText"), "medicinestocklist", 54, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}medicine_stock'), false, false, "fa-box", "", false, true);
$sideMenu->addMenuItem(18, "mi_medicine_categories", $Language->menuPhrase("18", "MenuText"), "medicinecategorieslist", 54, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}medicine_categories'), false, false, "fa-box", "", false, true);
$sideMenu->addMenuItem(19, "mi_medicine_dispensation", $Language->menuPhrase("19", "MenuText"), "medicinedispensationlist", 54, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}medicine_dispensation'), false, false, "fa-tablets", "", false, true);
$sideMenu->addMenuItem(236, "mci_Billing", $Language->menuPhrase("236", "MenuText"), "", -1, "", true, false, true, "fa-money-bill", "", false, true);
$sideMenu->addMenuItem(174, "mi_laboratory_billing_report", $Language->menuPhrase("174", "MenuText"), "laboratorybillingreportlist", 236, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}laboratory_billing_report'), false, false, "fa-money-bill", "", false, true);
$sideMenu->addMenuItem(237, "mi_radiology_billing_report", $Language->menuPhrase("237", "MenuText"), "radiologybillingreportlist", 236, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}radiology_billing_report'), false, false, "fa-money-bill", "", false, true);
$sideMenu->addMenuItem(239, "mi_pharmacy_billing_report", $Language->menuPhrase("239", "MenuText"), "pharmacybillingreportlist", 236, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}pharmacy_billing_report'), false, false, "fa-money-bill", "", false, true);
$sideMenu->addMenuItem(53, "mci_Financials", $Language->menuPhrase("53", "MenuText"), "", -1, "", true, false, true, "fa-money-bill", "", false, true);
...
$sideMenu->addMenuItem(10, "mi_invoices", $Language->menuPhrase("10", "MenuText"), "invoiceslist?cmd=resetall", 53, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}invoices'), false, false, "fa-invoice", "", false, true);
$sideMenu->addMenuItem(241, "mi_income", $Language->menuPhrase("241", "MenuText"), "incomelist", 53, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}income'), false, false, "fa-invoice", "", false, true);
...
$sideMenu->addMenuItem(35, "mi_service_charges", $Language->menuPhrase("35", "MenuText"), "servicechargeslist", 53, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}service_charges'), false, false, "fa-money-bill", "", false, true);
...
$sideMenu->addMenuItem(316, "mi_Laboratory_Reports", $Language->menuPhrase("316", "MenuText"), "laboratoryreports", 312, "", AllowListMenu('{32536B8D-F37B-4419-80D5-260932800712}Laboratory Reports'), false, false, "fa-file", "", false, true);

...
<script>
loadjs.ready(["fsuppliersedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsuppliersedit", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fsuppliersedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsuppliersedit", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

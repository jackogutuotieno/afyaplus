...
// Page object
$PatientIpdPrescriptionDetailsEdit = &$Page;
?>
...
?>
<main class="edit">
<form name="fpatient_ipd_prescription_detailsedit" id="fpatient_ipd_prescription_detailsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { patient_ipd_prescription_details: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var fpatient_ipd_prescription_detailsedit;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fpatient_ipd_prescription_detailsedit")
        .setPageId("edit")
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id"<?= $Page->id->rowAttributes() ?>>
        <label id="elh_patient_ipd_prescription_details_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->id->cellAttributes() ?>>
<span id="el_patient_ipd_prescription_details_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
<input type="hidden" data-table="patient_ipd_prescription_details" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<span id="el_patient_ipd_prescription_details_medicine_stock_id">
    <select
        ...
        data-select2-id="fpatient_ipd_prescription_detailsedit_x_medicine_stock_id"
        <?php } ?>
...
<?php if (!$Page->medicine_stock_id->IsNativeSelect) { ?>
<script>
loadjs.ready("fpatient_ipd_prescription_detailsedit", function() {
    var options = { name: "x_medicine_stock_id", selectId: "fpatient_ipd_prescription_detailsedit_x_medicine_stock_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fpatient_ipd_prescription_detailsedit.lists.medicine_stock_id?.lookupOptions.length) {
        options.data = { id: "x_medicine_stock_id", form: "fpatient_ipd_prescription_detailsedit" };
    } else {
        options.ajax = { id: "x_medicine_stock_id", form: "fpatient_ipd_prescription_detailsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_patient_ipd_prescription_details_method">
    <select
        ...
        data-select2-id="fpatient_ipd_prescription_detailsedit_x_method"
        <?php } ?>
        data-table="patient_ipd_prescription_details"
        data-field="x_method"
...
<script>
loadjs.ready("fpatient_ipd_prescription_detailsedit", function() {
    var options = { name: "x_method", selectId: "fpatient_ipd_prescription_detailsedit_x_method" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fpatient_ipd_prescription_detailsedit.lists.method?.lookupOptions.length) {
        options.data = { id: "x_method", form: "fpatient_ipd_prescription_detailsedit" };
    } else {
        options.ajax = { id: "x_method", form: "fpatient_ipd_prescription_detailsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_patient_ipd_prescription_details_dose_type">
    <select
        ...
        data-select2-id="fpatient_ipd_prescription_detailsedit_x_dose_type"
        <?php } ?>
        data-table="patient_ipd_prescription_details"
...
<script>
loadjs.ready("fpatient_ipd_prescription_detailsedit", function() {
    var options = { name: "x_dose_type", selectId: "fpatient_ipd_prescription_detailsedit_x_dose_type" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fpatient_ipd_prescription_detailsedit.lists.dose_type?.lookupOptions.length) {
        options.data = { id: "x_dose_type", form: "fpatient_ipd_prescription_detailsedit" };
    } else {
        options.ajax = { id: "x_dose_type", form: "fpatient_ipd_prescription_detailsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_patient_ipd_prescription_details_formulation">
    <select
        ...
        data-select2-id="fpatient_ipd_prescription_detailsedit_x_formulation"
        <?php } ?>
        data-table="patient_ipd_prescription_details"
...
<script>
loadjs.ready("fpatient_ipd_prescription_detailsedit", function() {
    var options = { name: "x_formulation", selectId: "fpatient_ipd_prescription_detailsedit_x_formulation" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fpatient_ipd_prescription_detailsedit.lists.formulation?.lookupOptions.length) {
        options.data = { id: "x_formulation", form: "fpatient_ipd_prescription_detailsedit" };
    } else {
        options.ajax = { id: "x_formulation", form: "fpatient_ipd_prescription_detailsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_patient_ipd_prescription_details_dose_interval">
    <select
        ...
        data-select2-id="fpatient_ipd_prescription_detailsedit_x_dose_interval"
        <?php } ?>
        data-table="patient_ipd_prescription_details"
...
<script>
loadjs.ready("fpatient_ipd_prescription_detailsedit", function() {
    var options = { name: "x_dose_interval", selectId: "fpatient_ipd_prescription_detailsedit_x_dose_interval" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fpatient_ipd_prescription_detailsedit.lists.dose_interval?.lookupOptions.length) {
        options.data = { id: "x_dose_interval", form: "fpatient_ipd_prescription_detailsedit" };
    } else {
        options.ajax = { id: "x_dose_interval", form: "fpatient_ipd_prescription_detailsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fpatient_ipd_prescription_detailsedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fpatient_ipd_prescription_detailsedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->

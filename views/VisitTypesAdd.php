...
<script>
loadjs.ready(["fvisit_typesadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fvisit_typesadd", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fvisit_typesadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fvisit_typesadd", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

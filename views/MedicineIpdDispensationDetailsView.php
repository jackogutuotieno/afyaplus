...
// Page object
$MedicineIpdDispensationDetailsView = &$Page;
?>
...
?>
<main class="view">
<form name="fmedicine_ipd_dispensation_detailsview" id="fmedicine_ipd_dispensation_detailsview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
var currentForm;
var fmedicine_ipd_dispensation_detailsview;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fmedicine_ipd_dispensation_detailsview")
        .setPageId("view")
        .build();
    window[form.id] = form;
    currentForm = form;
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_medicine_ipd_dispensation_details_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->medicine_dispensation_id->Visible) { // medicine_dispensation_id ?>
    <tr id="r_medicine_dispensation_id"<?= $Page->medicine_dispensation_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_medicine_ipd_dispensation_details_medicine_dispensation_id"><?= $Page->medicine_dispensation_id->caption() ?></span></td>
...
<?php if ($Page->medicine_stock_id->Visible) { // medicine_stock_id ?>
    <tr id="r_medicine_stock_id"<?= $Page->medicine_stock_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_medicine_ipd_dispensation_details_medicine_stock_id"><?= $Page->medicine_stock_id->caption() ?></span></td>
...
<?php if ($Page->quantity->Visible) { // quantity ?>
    <tr id="r_quantity"<?= $Page->quantity->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_medicine_ipd_dispensation_details_quantity"><?= $Page->quantity->caption() ?></span></td>

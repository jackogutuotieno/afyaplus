...
loadjs.ready("fradiology_reportsadd", function() {
    fradiology_reportsadd.createAutoSuggest(Object.assign({"id":"x_radiology_requests_id","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->radiology_requests_id->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.radiology_reports.fields.radiology_requests_id.autoSuggestOptions));
});
</script>

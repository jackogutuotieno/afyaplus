...
loadjs.ready(["fpayment_methodsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpayment_methodsadd", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpayment_methodsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpayment_methodsadd", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

...
<?php if ($Page->supplier_name->Visible) { // supplier_name ?>
        <th data-name="supplier_name" class="<?= $Page->supplier_name->headerCellClass() ?>"><div id="elh_medicine_stock_report_supplier_name" class="medicine_stock_report_supplier_name"><?= $Page->renderFieldHeader($Page->supplier_name) ?></div></th>
<?php } ?>
<?php if ($Page->phone->Visible) { // phone ?>
        <th data-name="phone" class="<?= $Page->phone->headerCellClass() ?>"><div id="elh_medicine_stock_report_phone" class="medicine_stock_report_phone"><?= $Page->renderFieldHeader($Page->phone) ?></div></th>
<?php } ?>
<?php if ($Page->email_address->Visible) { // email_address ?>
        <th data-name="email_address" class="<?= $Page->email_address->headerCellClass() ?>"><div id="elh_medicine_stock_report_email_address" class="medicine_stock_report_email_address"><?= $Page->renderFieldHeader($Page->email_address) ?></div></th>
<?php } ?>
<?php if ($Page->physical_address->Visible) { // physical_address ?>
        <th data-name="physical_address" class="<?= $Page->physical_address->headerCellClass() ?>"><div id="elh_medicine_stock_report_physical_address" class="medicine_stock_report_physical_address"><?= $Page->renderFieldHeader($Page->physical_address) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_medicine_stock_report_supplier_name" class="el_medicine_stock_report_supplier_name">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_medicine_stock_report_phone" class="el_medicine_stock_report_phone">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_medicine_stock_report_email_address" class="el_medicine_stock_report_email_address">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_medicine_stock_report_physical_address" class="el_medicine_stock_report_physical_address">

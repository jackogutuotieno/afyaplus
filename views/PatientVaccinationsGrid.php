        ...
        .setEmptyRow(
            function (rowIndex) {
                let fobj = this.getForm(),
                    fields = [["patient_id",false],["visit_id",false],["service_id",false],["status",false],["created_by_user_id",false],["date_created",false],["date_updated",false]];
...
<?php if ($Grid->date_updated->Visible) { // date_updated ?>
        <th data-name="date_updated" class="<?= $Grid->date_updated->headerCellClass() ?>"><div id="elh_patient_vaccinations_date_updated" class="patient_vaccinations_date_updated"><?= $Grid->renderFieldHeader($Grid->date_updated) ?></div></th>
<?php } ?>
<?php
...
<input type="<?= $Grid->service_id->getInputTextType() ?>" name="x<?= $Grid->RowIndex ?>_service_id" id="x<?= $Grid->RowIndex ?>_service_id" data-table="patient_vaccinations" data-field="x_service_id" value="<?= $Grid->service_id->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Grid->service_id->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Grid->service_id->formatPattern()) ?>"<?= $Grid->service_id->editAttributes() ?>>
...
<input type="hidden" data-table="patient_vaccinations" data-field="x_created_by_user_id" data-hidden="1" name="x<?= $Grid->RowIndex ?>_created_by_user_id" id="x<?= $Grid->RowIndex ?>_created_by_user_id" value="<?= HtmlEncode($Grid->created_by_user_id->CurrentValue) ?>">
<?php } else { ?>
...
<?php if ($Grid->RowType == RowType::ADD) { // Add record ?>
<span id="el<?= $Grid->RowIndex == '$rowindex$' ? '$rowindex$' : $Grid->RowCount ?>_patient_vaccinations_date_updated" class="el_patient_vaccinations_date_updated">
<input type="<?= $Grid->date_updated->getInputTextType() ?>" name="x<?= $Grid->RowIndex ?>_date_updated" id="x<?= $Grid->RowIndex ?>_date_updated" data-table="patient_vaccinations" data-field="x_date_updated" value="<?= $Grid->date_updated->EditValue ?>" placeholder="<?= HtmlEncode($Grid->date_updated->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Grid->date_updated->formatPattern()) ?>"<?= $Grid->date_updated->editAttributes() ?>>
...
loadjs.ready(["fpatient_vaccinationsgrid", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpatient_vaccinationsgrid", "x<?= $Grid->RowIndex ?>_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
<input type="hidden" data-table="patient_vaccinations" data-field="x_date_updated" data-hidden="1" data-old name="o<?= $Grid->RowIndex ?>_date_updated" id="o<?= $Grid->RowIndex ?>_date_updated" value="<?= HtmlEncode($Grid->date_updated->OldValue) ?>">
<?php } ?>
<?php if ($Grid->RowType == RowType::EDIT) { // Edit record ?>
<span id="el<?= $Grid->RowIndex == '$rowindex$' ? '$rowindex$' : $Grid->RowCount ?>_patient_vaccinations_date_updated" class="el_patient_vaccinations_date_updated">
<input type="<?= $Grid->date_updated->getInputTextType() ?>" name="x<?= $Grid->RowIndex ?>_date_updated" id="x<?= $Grid->RowIndex ?>_date_updated" data-table="patient_vaccinations" data-field="x_date_updated" value="<?= $Grid->date_updated->EditValue ?>" placeholder="<?= HtmlEncode($Grid->date_updated->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Grid->date_updated->formatPattern()) ?>"<?= $Grid->date_updated->editAttributes() ?>>
...
<?php if ($Grid->isConfirm()) { ?>
<input type="hidden" data-table="patient_vaccinations" data-field="x_date_updated" data-hidden="1" name="fpatient_vaccinationsgrid$x<?= $Grid->RowIndex ?>_date_updated" id="fpatient_vaccinationsgrid$x<?= $Grid->RowIndex ?>_date_updated" value="<?= HtmlEncode($Grid->date_updated->FormValue) ?>">
<input type="hidden" data-table="patient_vaccinations" data-field="x_date_updated" data-hidden="1" data-old name="fpatient_vaccinationsgrid$o<?= $Grid->RowIndex ?>_date_updated" id="fpatient_vaccinationsgrid$o<?= $Grid->RowIndex ?>_date_updated" value="<?= HtmlEncode($Grid->date_updated->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
    <?php } ?>

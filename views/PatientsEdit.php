...
loadjs.ready(["fpatientsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpatientsedit", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpatientsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpatientsedit", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

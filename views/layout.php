...
<script src="<?= $basePath ?>js/ewcore.js?v=24.16.6"></script>
<script>
var $rowindex$ = null;
Object.assign(ew, <?= JsonEncode(ConfigClientVars()) ?>, <?= JsonEncode(GlobalClientVars()) ?>);
loadjs(ew.PATH_BASE + "jquery/jquery.js?v=24.16.6", "jquery");
loadjs(ew.PATH_BASE + "js/popper.js?v=24.16.6", "popper");
loadjs(ew.PATH_BASE + "js/luxon.js?v=24.16.6", "luxon");
loadjs([
    ew.PATH_BASE + "js/mobile-detect.js?v=24.16.6",
    ew.PATH_BASE + "js/purify.js?v=24.16.6",
    ew.PATH_BASE + "js/cropper.js?v=24.16.6",
    ew.PATH_BASE + "jquery/load-image.all.js?v=24.16.6"
], "others");
loadjs(ew.PATH_BASE + "js/sweetalert2.all.js?v=24.16.6", "swal");
<?= $Language->toJson() ?>
ew.vars = <?= JsonEncode(GetClientVar()) ?>;
ew.ready(["wrapper", "jquery"], ew.PATH_BASE + "jquery/jsrender.js?v=24.16.6", "jsrender", ew.renderJsTemplates);
ew.ready("jquery", ew.PATH_BASE + "jquery/jquery-ui.js?v=24.16.6", "widget");
</script>
...
<?php } ?>
var jqueryjs = [
    ew.PATH_BASE + "jquery/select2.full.js?v=24.16.6",
    ew.PATH_BASE + "jquery/jqueryfileupload.js?v=24.16.6",
    ew.PATH_BASE + "jquery/typeahead.jquery.js?v=24.16.6"
];
jqueryjs.push(ew.PATH_BASE + "colorbox/jquery.colorbox.js?v=24.16.6");
jqueryjs.push(ew.PATH_BASE + "js/pdfobject.js?v=24.16.6");
ew.ready(["jquery", "dom", "popper"], ew.PATH_BASE + "bootstrap5/js/bootstrap.js?v=24.16.6", "bootstrap"); // Bootstrap
ew.ready("popper", ew.PATH_BASE + "js/tippy-bundle.umd.js?v=24.16.6", "tippy"); // Tippy
ew.ready("bootstrap", ew.PATH_BASE + "adminlte3/js/adminlte.js?v=24.16.6", "adminlte"); // AdminLTE (After Bootstrap)
ew.ready(["jquery", "widget"], [jqueryjs], "jqueryjs");
ew.ready(["bootstrap", "adminlte", "jqueryjs", "luxon", "others"], ew.PATH_BASE + "js/ew.js?v=24.16.6", "makerjs");
ew.ready("makerjs", [
    cssjs,
...
ew.ready(["chartjs", "luxon"], [
    ew.PATH_BASE + "js/chartjs-adapter-luxon.umd.js?v=24.16.0",
    ew.PATH_BASE + "js/chartjs-plugin-annotation.js?v=24.16.0",
    ew.PATH_BASE + "js/chartjs-plugin-datalabels.js?v=24.16.0",
    ew.PATH_BASE + "js/chartjs-plugin-stacked100.js?v=24.16.0",
    ew.PATH_BASE + "js/ewchart.js?v=24.16.0",
], "chart");
</script>
<script>
ew.ready("head", [ew.PATH_BASE + "tinymce/tinymce.js?v=24.16.0", ew.PATH_BASE + "js/eweditor.js?v=24.16.0"], "editor");
</script>
<style>

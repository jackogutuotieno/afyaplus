...
$FacilityOverview = $Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { Facility_Overview: currentTable } });
var currentPageID = ew.PAGE_ID = "dashboard";
var currentForm;
var fFacility_Overviewsrch;
        ...
        <div class="card-group">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?= $FacilityOverview->renderItem($this, 1) ?>
                    </div>
                </div>
            </div>
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?= $FacilityOverview->renderItem($this, 2) ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php if ($FacilityOverview->isExport() && !$FacilityOverview->isExport("print")) { ?>
<script class="ew-export-dashboard">
loadjs.ready("load", function() {
    ew.exportCustom("ew-dashboard", "<?= $FacilityOverview->Export ?>", "Facility_Overview");

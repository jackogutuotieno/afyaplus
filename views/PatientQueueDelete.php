...
$Page->showMessage();
?>
<form name="fpatient_queuedelete" id="fpatient_queuedelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->patient_id->Visible) { // patient_id ?>
        <th class="<?= $Page->patient_id->headerCellClass() ?>"><span id="elh_patient_queue_patient_id" class="patient_queue_patient_id"><?= $Page->patient_id->caption() ?></span></th>
<?php } ?>

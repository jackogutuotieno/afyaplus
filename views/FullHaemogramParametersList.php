...
// Page object
$FullHaemogramParametersList = &$Page;
?>
...
<table id="tbl_full_haemogram_parameterslist" class="<?= $Page->TableClass ?>"><!-- .ew-table -->
<thead>
...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_full_haemogram_parameters_id" class="full_haemogram_parameters_id"><?= $Page->renderFieldHeader($Page->id) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_full_haemogram_parameters_id" class="el_full_haemogram_parameters_id">

...
<span id="el_lab_test_requests_details_specimen_id">
    <select
        ...
        data-select2-id="flab_test_requests_detailsedit_x_specimen_id"
        <?php } ?>
...
<?php if (!$Page->specimen_id->IsNativeSelect) { ?>
<script>
loadjs.ready("flab_test_requests_detailsedit", function() {
    var options = { name: "x_specimen_id", selectId: "flab_test_requests_detailsedit_x_specimen_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (flab_test_requests_detailsedit.lists.specimen_id?.lookupOptions.length) {
        options.data = { id: "x_specimen_id", form: "flab_test_requests_detailsedit" };
    } else {
        options.ajax = { id: "x_specimen_id", form: "flab_test_requests_detailsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_lab_test_requests_details_service_id">
    <select
        ...
        data-select2-id="flab_test_requests_detailsedit_x_service_id"
        <?php } ?>
        data-table="lab_test_requests_details"
...
<script>
loadjs.ready("flab_test_requests_detailsedit", function() {
    var options = { name: "x_service_id", selectId: "flab_test_requests_detailsedit_x_service_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (flab_test_requests_detailsedit.lists.service_id?.lookupOptions.length) {
        options.data = { id: "x_service_id", form: "flab_test_requests_detailsedit" };
    } else {
        options.ajax = { id: "x_service_id", form: "flab_test_requests_detailsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
?>
<?php
    if (in_array("laboratory_billing_report", explode(",", $Page->getCurrentDetailTable())) && $laboratory_billing_report->DetailEdit) {
?>

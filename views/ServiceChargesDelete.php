...
$Page->showMessage();
?>
<form name="fservice_chargesdelete" id="fservice_chargesdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_service_charges_id" class="service_charges_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->service_category_id->Visible) { // service_category_id ?>
        <th class="<?= $Page->service_category_id->headerCellClass() ?>"><span id="elh_service_charges_service_category_id" class="service_charges_service_category_id"><?= $Page->service_category_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->service_subcategory_id->Visible) { // service_subcategory_id ?>
        <th class="<?= $Page->service_subcategory_id->headerCellClass() ?>"><span id="elh_service_charges_service_subcategory_id" class="service_charges_service_subcategory_id"><?= $Page->service_subcategory_id->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($Page->service_subcategory_id->Visible) { // service_subcategory_id ?>
        <td<?= $Page->service_subcategory_id->cellAttributes() ?>>
<span id="">

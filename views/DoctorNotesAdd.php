...
<script>
loadjs.ready(["fdoctor_notesadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoctor_notesadd", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdoctor_notesadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdoctor_notesadd", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

...
<script>
loadjs.ready(["flab_test_reportsadd", "editor"], function() {
    ew.createEditor("flab_test_reportsadd", "x_details", 0, 0, <?= $Page->details->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
...
<input type="hidden" name="fa_x_report_template" id= "fa_x_report_template" value="0">

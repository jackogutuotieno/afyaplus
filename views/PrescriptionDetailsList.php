...
<?php
if ($Page->DbMasterFilter != "" && $Page->getCurrentMasterTable() == "prescriptions") {
    if ($Page->MasterRecordExists) {
        include_once "views/PrescriptionsMaster.php";
    }
}
?>
<?php } ?>
...
<?php } ?>
<?php if ($Page->getCurrentMasterTable() == "prescriptions" && $Page->CurrentAction) { ?>

...
<?php if ($Page->lab_test_request_id->Visible) { // lab_test_request_id ?>
        <th data-name="lab_test_request_id" class="<?= $Page->lab_test_request_id->headerCellClass() ?>"><div id="elh_lab_test_requests_details_lab_test_request_id" class="lab_test_requests_details_lab_test_request_id"><?= $Page->renderFieldHeader($Page->lab_test_request_id) ?></div></th>
<?php } ?>
...
<?php if ($Page->created_by_user_id->Visible) { // created_by_user_id ?>
        <th data-name="created_by_user_id" class="<?= $Page->created_by_user_id->headerCellClass() ?>"><div id="elh_lab_test_requests_details_created_by_user_id" class="lab_test_requests_details_created_by_user_id"><?= $Page->renderFieldHeader($Page->created_by_user_id) ?></div></th>
<?php } ?>
<?php if ($Page->date_created->Visible) { // date_created ?>
        <th data-name="date_created" class="<?= $Page->date_created->headerCellClass() ?>"><div id="elh_lab_test_requests_details_date_created" class="lab_test_requests_details_date_created"><?= $Page->renderFieldHeader($Page->date_created) ?></div></th>
<?php } ?>
<?php if ($Page->date_updated->Visible) { // date_updated ?>
        <th data-name="date_updated" class="<?= $Page->date_updated->headerCellClass() ?>"><div id="elh_lab_test_requests_details_date_updated" class="lab_test_requests_details_date_updated"><?= $Page->renderFieldHeader($Page->date_updated) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_lab_test_requests_details_lab_test_request_id" class="el_lab_test_requests_details_lab_test_request_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_lab_test_requests_details_created_by_user_id" class="el_lab_test_requests_details_created_by_user_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_lab_test_requests_details_date_created" class="el_lab_test_requests_details_date_created">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_lab_test_requests_details_date_updated" class="el_lab_test_requests_details_date_updated">

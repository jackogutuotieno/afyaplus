...
<script>
loadjs.ready(["fprescription_detailsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fprescription_detailsadd", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fprescription_detailsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fprescription_detailsadd", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fprescription_detailsadd")
        .setPageId("add")
...
$Page->showMessage();
?>
<form name="fprescription_detailsadd" id="fprescription_detailsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<span id="el_prescription_details_medicine_stock_id">
    <select
        ...
        data-select2-id="fprescription_detailsadd_x_medicine_stock_id"
        <?php } ?>
...
loadjs.ready("fprescription_detailsadd", function() {
    var options = { name: "x_medicine_stock_id", selectId: "fprescription_detailsadd_x_medicine_stock_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprescription_detailsadd.lists.medicine_stock_id?.lookupOptions.length) {
        options.data = { id: "x_medicine_stock_id", form: "fprescription_detailsadd" };
    } else {
        options.ajax = { id: "x_medicine_stock_id", form: "fprescription_detailsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_prescription_details_dose_type">
    <select
        ...
        data-select2-id="fprescription_detailsadd_x_dose_type"
        <?php } ?>
        data-table="prescription_details"
...
<script>
loadjs.ready("fprescription_detailsadd", function() {
    var options = { name: "x_dose_type", selectId: "fprescription_detailsadd_x_dose_type" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprescription_detailsadd.lists.dose_type?.lookupOptions.length) {
        options.data = { id: "x_dose_type", form: "fprescription_detailsadd" };
    } else {
        options.ajax = { id: "x_dose_type", form: "fprescription_detailsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_prescription_details_dose_interval">
    <select
        ...
        data-select2-id="fprescription_detailsadd_x_dose_interval"
        <?php } ?>
        data-table="prescription_details"
...
<script>
loadjs.ready("fprescription_detailsadd", function() {
    var options = { name: "x_dose_interval", selectId: "fprescription_detailsadd_x_dose_interval" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fprescription_detailsadd.lists.dose_interval?.lookupOptions.length) {
        options.data = { id: "x_dose_interval", form: "fprescription_detailsadd" };
    } else {
        options.ajax = { id: "x_dose_interval", form: "fprescription_detailsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fprescription_detailsadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fprescription_detailsadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->

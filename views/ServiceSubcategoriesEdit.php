...
<script>
loadjs.ready(["fservice_subcategoriesedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fservice_subcategoriesedit", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fservice_subcategoriesedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fservice_subcategoriesedit", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

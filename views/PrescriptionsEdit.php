...
<script>
loadjs.ready(["fprescriptionsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fprescriptionsedit", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fprescriptionsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fprescriptionsedit", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

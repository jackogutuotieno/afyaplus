...
<script>
loadjs.ready(["fdiagnosisedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdiagnosisedit", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdiagnosisedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdiagnosisedit", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

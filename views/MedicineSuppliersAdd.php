...
<script>
loadjs.ready(["fmedicine_suppliersadd", "editor"], function() {
    ew.createEditor("fmedicine_suppliersadd", "x_physical_address", 0, 0, <?= $Page->physical_address->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>

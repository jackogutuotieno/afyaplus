...
<?php } ?>
<?php
    if (in_array("invoices", explode(",", $Page->getCurrentDetailTable())) && $invoices->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("cash_payments", explode(",", $Page->getCurrentDetailTable())) && $cash_payments->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("radiology_billing_report", explode(",", $Page->getCurrentDetailTable())) && $radiology_billing_report->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("pharmacy_billing_report", explode(",", $Page->getCurrentDetailTable())) && $pharmacy_billing_report->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patients_lab_report", explode(",", $Page->getCurrentDetailTable())) && $patients_lab_report->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
<h4 class="ew-detail-caption"><?= $Language->tablePhrase("patients_lab_report", "TblCaption") ?></h4>
<?php } ?>
<?php include_once "PatientsLabReportGrid.php" ?>
<?php } ?>
<?php
    if (in_array("medicine_dispensation", explode(",", $Page->getCurrentDetailTable())) && $medicine_dispensation->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
<h4 class="ew-detail-caption"><?= $Language->tablePhrase("medicine_dispensation", "TblCaption") ?></h4>
<?php } ?>
<?php include_once "MedicineDispensationGrid.php" ?>
<?php } ?>
<?php
    if (in_array("patients_radiology_reports", explode(",", $Page->getCurrentDetailTable())) && $patients_radiology_reports->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
<h4 class="ew-detail-caption"><?= $Language->tablePhrase("patients_radiology_reports", "TblCaption") ?></h4>
<?php } ?>

...
loadjs.ready(["fpatient_visitsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpatient_visitsedit", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpatient_visitsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpatient_visitsedit", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

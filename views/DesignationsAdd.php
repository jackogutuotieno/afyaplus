...
<script>
loadjs.ready(["fdesignationsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdesignationsadd", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdesignationsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdesignationsadd", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

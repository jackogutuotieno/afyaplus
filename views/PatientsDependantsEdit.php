...
<span id="el_patients_dependants_patient_id">
    <select
        ...
        data-select2-id="fpatients_dependantsedit_x_patient_id"
        <?php } ?>
...
loadjs.ready("fpatients_dependantsedit", function() {
    var options = { name: "x_patient_id", selectId: "fpatients_dependantsedit_x_patient_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fpatients_dependantsedit.lists.patient_id?.lookupOptions.length) {
        options.data = { id: "x_patient_id", form: "fpatients_dependantsedit" };
    } else {
        options.ajax = { id: "x_patient_id", form: "fpatients_dependantsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }

...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_patient_vaccinations_id" class="patient_vaccinations_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->visit_id->Visible) { // visit_id ?>
        <th class="<?= $Page->visit_id->headerCellClass() ?>"><span id="elh_patient_vaccinations_visit_id" class="patient_vaccinations_visit_id"><?= $Page->visit_id->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->date_updated->Visible) { // date_updated ?>
        <th class="<?= $Page->date_updated->headerCellClass() ?>"><span id="elh_patient_vaccinations_date_updated" class="patient_vaccinations_date_updated"><?= $Page->date_updated->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>

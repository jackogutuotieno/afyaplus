...
// Page object
$RadiologyRequestsDetailsDelete = &$Page;
?>
<script>
...
var currentForm;
var fradiology_requests_detailsdelete;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fradiology_requests_detailsdelete")
        .setPageId("delete")
        .build();
    window[form.id] = form;
    currentForm = form;
...
$Page->showMessage();
?>
<form name="fradiology_requests_detailsdelete" id="fradiology_requests_detailsdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->created_by_user_id->Visible) { // created_by_user_id ?>
        <th class="<?= $Page->created_by_user_id->headerCellClass() ?>"><span id="elh_radiology_requests_details_created_by_user_id" class="radiology_requests_details_created_by_user_id"><?= $Page->created_by_user_id->caption() ?></span></th>
<?php } ?>

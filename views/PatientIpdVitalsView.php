...
?>
<main class="view">
<form name="fpatient_ipd_vitalsview" id="fpatient_ipd_vitalsview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_ipd_vitals_id"><?= $Page->id->caption() ?></span></td>
        <td data-name="id"<?= $Page->id->cellAttributes() ?>>
<span id="el_patient_ipd_vitals_id">
...
<?php if ($Page->admission_id->Visible) { // admission_id ?>
    <tr id="r_admission_id"<?= $Page->admission_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_ipd_vitals_admission_id"><?= $Page->admission_id->caption() ?></span></td>
...
<?php if ($Page->patient_id->Visible) { // patient_id ?>
    <tr id="r_patient_id"<?= $Page->patient_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_ipd_vitals_patient_id"><?= $Page->patient_id->caption() ?></span></td>
...
<?php if ($Page->height->Visible) { // height ?>
    <tr id="r_height"<?= $Page->height->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_ipd_vitals_height"><?= $Page->height->caption() ?></span></td>
...
<?php if ($Page->weight->Visible) { // weight ?>
    <tr id="r_weight"<?= $Page->weight->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_ipd_vitals_weight"><?= $Page->weight->caption() ?></span></td>
...
<?php if ($Page->temperature->Visible) { // temperature ?>
    <tr id="r_temperature"<?= $Page->temperature->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_ipd_vitals_temperature"><?= $Page->temperature->caption() ?></span></td>
...
<?php if ($Page->pulse->Visible) { // pulse ?>
    <tr id="r_pulse"<?= $Page->pulse->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_ipd_vitals_pulse"><?= $Page->pulse->caption() ?></span></td>
...
<?php if ($Page->blood_pressure->Visible) { // blood_pressure ?>
    <tr id="r_blood_pressure"<?= $Page->blood_pressure->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_ipd_vitals_blood_pressure"><?= $Page->blood_pressure->caption() ?></span></td>
...
<?php if ($Page->created_by_user_id->Visible) { // created_by_user_id ?>
    <tr id="r_created_by_user_id"<?= $Page->created_by_user_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_ipd_vitals_created_by_user_id"><?= $Page->created_by_user_id->caption() ?></span></td>
        <td data-name="created_by_user_id"<?= $Page->created_by_user_id->cellAttributes() ?>>
<span id="el_patient_ipd_vitals_created_by_user_id">

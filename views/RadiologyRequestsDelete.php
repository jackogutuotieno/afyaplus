...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fradiology_requestsdelete")
        .setPageId("delete")
        .build();
    window[form.id] = form;
    currentForm = form;
...
$Page->showMessage();
?>
<form name="fradiology_requestsdelete" id="fradiology_requestsdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->test_title->Visible) { // test_title ?>
        <th class="<?= $Page->test_title->headerCellClass() ?>"><span id="elh_radiology_requests_test_title" class="radiology_requests_test_title"><?= $Page->test_title->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->date_updated->Visible) { // date_updated ?>
        <th class="<?= $Page->date_updated->headerCellClass() ?>"><span id="elh_radiology_requests_date_updated" class="radiology_requests_date_updated"><?= $Page->date_updated->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>

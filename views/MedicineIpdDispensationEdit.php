...
loadjs.ready("fmedicine_ipd_dispensationedit", function() {
    fmedicine_ipd_dispensationedit.createAutoSuggest(Object.assign({"id":"x_patient_id","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->patient_id->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.medicine_ipd_dispensation.fields.patient_id.autoSuggestOptions));
});
</script>

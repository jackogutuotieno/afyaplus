...
<script>
loadjs.ready(["fdepartmentsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdepartmentsadd", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdepartmentsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdepartmentsadd", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

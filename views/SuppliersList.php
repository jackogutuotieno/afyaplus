...
<?php if ($Page->physical_address->Visible) { // physical_address ?>
        <th data-name="physical_address" class="<?= $Page->physical_address->headerCellClass() ?>"><div id="elh_suppliers_physical_address" class="suppliers_physical_address"><?= $Page->renderFieldHeader($Page->physical_address) ?></div></th>
<?php } ?>
<?php if ($Page->date_created->Visible) { // date_created ?>
        <th data-name="date_created" class="<?= $Page->date_created->headerCellClass() ?>"><div id="elh_suppliers_date_created" class="suppliers_date_created"><?= $Page->renderFieldHeader($Page->date_created) ?></div></th>
<?php } ?>
<?php if ($Page->date_updated->Visible) { // date_updated ?>
        <th data-name="date_updated" class="<?= $Page->date_updated->headerCellClass() ?>"><div id="elh_suppliers_date_updated" class="suppliers_date_updated"><?= $Page->renderFieldHeader($Page->date_updated) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_suppliers_physical_address" class="el_suppliers_physical_address">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_suppliers_date_created" class="el_suppliers_date_created">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_suppliers_date_updated" class="el_suppliers_date_updated">

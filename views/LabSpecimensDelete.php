...
$Page->showMessage();
?>
<form name="flab_specimensdelete" id="flab_specimensdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_lab_specimens_id" class="lab_specimens_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->date_updated->Visible) { // date_updated ?>
        <th class="<?= $Page->date_updated->headerCellClass() ?>"><span id="elh_lab_specimens_date_updated" class="lab_specimens_date_updated"><?= $Page->date_updated->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>

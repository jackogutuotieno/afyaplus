...
// Page object
$RadiologyRequestsDetailsView = &$Page;
?>
...
?>
<main class="view">
<form name="fradiology_requests_detailsview" id="fradiology_requests_detailsview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
var currentForm;
var fradiology_requests_detailsview;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fradiology_requests_detailsview")
        .setPageId("view")
        .build();
    window[form.id] = form;
    currentForm = form;
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_radiology_requests_details_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->radiology_request_id->Visible) { // radiology_request_id ?>
    <tr id="r_radiology_request_id"<?= $Page->radiology_request_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_radiology_requests_details_radiology_request_id"><?= $Page->radiology_request_id->caption() ?></span></td>
...
<?php if ($Page->service_id->Visible) { // service_id ?>
    <tr id="r_service_id"<?= $Page->service_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_radiology_requests_details_service_id"><?= $Page->service_id->caption() ?></span></td>

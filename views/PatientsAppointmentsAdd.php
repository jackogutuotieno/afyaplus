...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fPatients_Appointmentsadd")
        .setPageId("add")
        ...
        .setFields([
            ...
            ["end_date", [fields.end_date.visible && fields.end_date.required ? ew.Validators.required(fields.end_date.caption) : null, ew.Validators.datetime(fields.end_date.clientFormatPattern), ew.Validators.minDate(() => fPatients_Appointmentsadd.getFieldElements("start_date"))], fields.end_date.isInvalid],
...
$Page->showMessage();
?>
<form name="fPatients_Appointmentsadd" id="fPatients_Appointmentsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<script>
loadjs.ready(["fPatients_Appointmentsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fPatients_Appointmentsadd", "x_start_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":true}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fPatients_Appointmentsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fPatients_Appointmentsadd", "x_end_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":true}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fPatients_Appointmentsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fPatients_Appointmentsadd", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fPatients_Appointmentsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fPatients_Appointmentsadd", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fPatients_Appointmentsadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fPatients_Appointmentsadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->

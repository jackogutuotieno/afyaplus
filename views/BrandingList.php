...
<?php } ?>
<div id="gmp_branding" class="card-body ew-grid-middle-panel <?= $Page->TableContainerClass ?>" style="<?= $Page->TableContainerStyle ?>">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit() || $Page->isMultiEdit()) { ?>
<table id="tbl_brandinglist" class="<?= $Page->TableClass ?>"><!-- .ew-table -->
<thead>

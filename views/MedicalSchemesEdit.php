...
<script>
loadjs.ready(["fmedical_schemesedit", "editor"], function() {
    ew.createEditor("fmedical_schemesedit", "x_physical_address", 0, 0, <?= $Page->physical_address->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>

...
<script>
loadjs.ready(["fpatient_vaccinationsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpatient_vaccinationsadd", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpatient_vaccinationsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpatient_vaccinationsadd", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

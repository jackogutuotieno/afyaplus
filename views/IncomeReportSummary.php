...
// Page object
$IncomeReportSummary = &$Page;
?>
<?php if (!$Page->isExport() && !$Page->DrillDown && !$DashboardReport) { ?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { Income_Report: currentTable } });
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_Income_Report" class="card-body ew-grid-middle-panel <?= $Page->TableContainerClass ?>">
<table class="<?= $Page->TableClass ?>">
<thead>
	<!-- Table header -->
    <tr class="ew-table-header">
<?php if ($Page->id->Visible) { ?>
    <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div class="Income_Report_id"><?= $Page->renderFieldHeader($Page->id) ?></div></th>
<?php } ?>
<?php if ($Page->income_title->Visible) { ?>
    <th data-name="income_title" class="<?= $Page->income_title->headerCellClass() ?>"><div class="Income_Report_income_title"><?= $Page->renderFieldHeader($Page->income_title) ?></div></th>
<?php } ?>
<?php if ($Page->description->Visible) { ?>
    <th data-name="description" class="<?= $Page->description->headerCellClass() ?>"><div class="Income_Report_description"><?= $Page->renderFieldHeader($Page->description) ?></div></th>
<?php } ?>
<?php if ($Page->cost->Visible) { ?>
    <th data-name="cost" class="<?= $Page->cost->headerCellClass() ?>"><div class="Income_Report_cost"><?= $Page->renderFieldHeader($Page->cost) ?></div></th>
<?php } ?>
<?php if ($Page->date_created->Visible) { ?>
    <th data-name="date_created" class="<?= $Page->date_created->headerCellClass() ?>"><div class="Income_Report_date_created"><?= $Page->renderFieldHeader($Page->date_created) ?></div></th>
<?php } ?>
<?php if ($Page->income_month->Visible) { ?>
    <th data-name="income_month" class="<?= $Page->income_month->headerCellClass() ?>"><div class="Income_Report_income_month"><?= $Page->renderFieldHeader($Page->income_month) ?></div></th>
<?php } ?>
    </tr>
</thead>
<tbody>
...
<?php } ?>
<?php if ($Page->income_title->Visible) { ?>
        <td data-field="income_title"<?= $Page->income_title->cellAttributes() ?>>
...
<?php } ?>
<?php if ($Page->income_month->Visible) { ?>
        <td data-field="income_month"<?= $Page->income_month->cellAttributes() ?>>
...
if (!$DashboardReport) {
    ...
    $Page->IncomebyMonth->DrillDownInPanel = $Page->DrillDownInPanel;
    echo $Page->IncomebyMonth->render("ew-chart-bottom");
}
?>
<?php if ((!$Page->isExport() || $Page->isExport("print")) && !$DashboardReport) { ?>
</div>

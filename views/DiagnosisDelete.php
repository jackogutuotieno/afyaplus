...
$Page->showMessage();
?>
<form name="fdiagnosisdelete" id="fdiagnosisdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->date_created->Visible) { // date_created ?>
        <th class="<?= $Page->date_created->headerCellClass() ?>"><span id="elh_diagnosis_date_created" class="diagnosis_date_created"><?= $Page->date_created->caption() ?></span></th>
<?php } ?>
<?php if ($Page->date_updated->Visible) { // date_updated ?>
        <th class="<?= $Page->date_updated->headerCellClass() ?>"><span id="elh_diagnosis_date_updated" class="diagnosis_date_updated"><?= $Page->date_updated->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<?php } ?>
<?php if ($Page->disease_id->Visible) { // disease_id ?>
        <td<?= $Page->disease_id->cellAttributes() ?>>
<span id="">

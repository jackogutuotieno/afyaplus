...
<script>
loadjs.ready(["fmedicine_categoriesadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmedicine_categoriesadd", "x_date_created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fmedicine_categoriesadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmedicine_categoriesadd", "x_date_updated", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>

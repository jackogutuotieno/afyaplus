...
<?php if ($Page->visit_id->Visible) { // visit_id ?>
        <th data-name="visit_id" class="<?= $Page->visit_id->headerCellClass() ?>"><div id="elh_invoices_visit_id" class="invoices_visit_id"><?= $Page->renderFieldHeader($Page->visit_id) ?></div></th>
<?php } ?>
<?php if ($Page->invoice_title->Visible) { // invoice_title ?>
        <th data-name="invoice_title" class="<?= $Page->invoice_title->headerCellClass() ?>"><div id="elh_invoices_invoice_title" class="invoices_invoice_title"><?= $Page->renderFieldHeader($Page->invoice_title) ?></div></th>
<?php } ?>
...
<?php if ($Page->date_updated->Visible) { // date_updated ?>
        <th data-name="date_updated" class="<?= $Page->date_updated->headerCellClass() ?>"><div id="elh_invoices_date_updated" class="invoices_date_updated"><?= $Page->renderFieldHeader($Page->date_updated) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_invoices_visit_id" class="el_invoices_visit_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_invoices_invoice_title" class="el_invoices_invoice_title">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_invoices_date_updated" class="el_invoices_date_updated">

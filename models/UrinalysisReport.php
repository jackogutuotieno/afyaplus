...
/**
 * Table class for urinalysis_report
 */
class UrinalysisReport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "urinalysis_report";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "urinalysis_report";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("urinalysisreportlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "urinalysisreportview" => $Language->phrase("View"),
            "urinalysisreportedit" => $Language->phrase("Edit"),
            "urinalysisreportadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "UrinalysisReportView",
            Config("API_ADD_ACTION") => "UrinalysisReportAdd",
            Config("API_EDIT_ACTION") => "UrinalysisReportEdit",
            Config("API_DELETE_ACTION") => "UrinalysisReportDelete",
            Config("API_LIST_ACTION") => "UrinalysisReportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("urinalysisreportview", $parm);
        } else {
            $url = $this->keyUrl("urinalysisreportview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "urinalysisreportadd?" . $parm;
        } else {
            $url = "urinalysisreportadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("urinalysisreportedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("urinalysisreportlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("urinalysisreportadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("urinalysisreportlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("urinalysisreportdelete", $parm);
        }
    }

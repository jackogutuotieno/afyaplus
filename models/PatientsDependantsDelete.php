 ...
 * Page class
 */
class PatientsDependantsDelete extends PatientsDependants
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientsDependantsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "patientsdependantsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientsdependantslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("patientsdependantslist"); // Return to list
                return;
            }
        }

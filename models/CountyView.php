 ...
 * Page class
 */
class CountyView extends County
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "countyview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "countylist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "countylist"; // No matching record, return to list
                    }
                break;
        }

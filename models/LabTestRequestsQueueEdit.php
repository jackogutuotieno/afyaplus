 ...
 * Page class
 */
class LabTestRequestsQueueEdit extends LabTestRequestsQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabTestRequestsQueueEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "labtestrequestsqueueedit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("lab_test_reports", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("LabTestReportsGrid");
            if (in_array("lab_test_reports", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
    ...
    protected function getEditRow($rsold)
    {
        ...
        // waiting_interval
        $this->waiting_interval->setDbValueDef($rsnew, $this->waiting_interval->CurrentValue, $this->waiting_interval->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['waiting_interval'])) { // waiting_interval
            $this->waiting_interval->CurrentValue = $row['waiting_interval'];
        }

 ...
 * Page class
 */
class CashPaymentsDelete extends CashPayments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CashPaymentsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("cashpaymentslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("cashpaymentslist"); // Return to list
                return;
            }
        }

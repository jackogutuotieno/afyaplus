...
/**
 * Table class for lab_test_requests_queue
 */
class LabTestRequestsQueue extends DbTable
{
    protected $SqlFrom = "";
    ...
    // Fields
    public $id;
    public $lab_test_requests_details_id;
    public $time;
    public $waiting_time;
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "lab_test_requests_queue";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->lab_test_requests_details_id = new DbField(
            $this, // Table
            'x_lab_test_requests_details_id', // Variable name
            'lab_test_requests_details_id', // Name
            '`lab_test_requests_details_id`', // Expression
            '`lab_test_requests_details_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`lab_test_requests_details_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->lab_test_requests_details_id->InputTextType = "text";
        $this->lab_test_requests_details_id->Raw = true;
        $this->lab_test_requests_details_id->IsForeignKey = true; // Foreign key field
        $this->lab_test_requests_details_id->Nullable = false; // NOT NULL field
        $this->lab_test_requests_details_id->Required = true; // Required field
        $this->lab_test_requests_details_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->lab_test_requests_details_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['lab_test_requests_details_id'] = &$this->lab_test_requests_details_id;
        ...
        $this->waiting_time = new DbField(
            $this, // Table
            'x_waiting_time', // Variable name
            'waiting_time', // Name
            '`waiting_time`', // Expression
            '`waiting_time`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`waiting_time`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->waiting_time->InputTextType = "text";
        ...
        $this->waiting_time->CustomMsg = $Language->fieldPhrase($this->TableVar, $this->waiting_time->Param, "CustomMsg");
        $this->Fields['waiting_time'] = &$this->waiting_time;

        // waiting_interval
        $this->waiting_interval = new DbField(
            $this, // Table
            'x_waiting_interval', // Variable name
            'waiting_interval', // Name
            '`waiting_interval`', // Expression
            '`waiting_interval`', // Basic search expression
            200, // Type
            20, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`waiting_interval`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->waiting_interval->setSelectMultiple(false); // Select one
        $this->waiting_interval->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->waiting_interval->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->waiting_interval->Lookup = new Lookup($this->waiting_interval, 'lab_test_requests_queue', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->waiting_interval->OptionCount = 3;
        $this->waiting_interval->SearchOperators = ["=", "<>"];
    ...
    public function getMasterFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "lab_test_requests_details") {
            ...
            if ($this->lab_test_requests_details_id->getSessionValue() != "") {
                $masterFilter .= "" . GetKeyFilter($masterTable->id, $this->lab_test_requests_details_id->getSessionValue(), $masterTable->id->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "lab_test_requests_details") {
            $masterTable = Container("lab_test_requests_details");
            if ($this->lab_test_requests_details_id->getSessionValue() != "") {
                $detailFilter .= "" . GetKeyFilter($this->lab_test_requests_details_id, $this->lab_test_requests_details_id->getSessionValue(), $masterTable->id->DataType, $this->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "lab_test_requests_details":
                $key = $keys["lab_test_requests_details_id"] ?? "";
                if (EmptyValue($key)) {
                ...
                if ($validKeys) {
                    return GetKeyFilter($masterTable->id, $keys["lab_test_requests_details_id"], $this->lab_test_requests_details_id->DataType, $this->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "lab_test_requests_details":
                return GetKeyFilter($this->lab_test_requests_details_id, $masterTable->id->DbValue, $masterTable->id->DataType, $masterTable->Dbid);
        }
        return "";
    }
    ...
    public function getDetailUrl()
    {
        ...
        if ($detailUrl == "") {
            $detailUrl = "labtestrequestsqueuelist";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "lab_test_requests_queue";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->lab_test_requests_details_id->DbValue = $row['lab_test_requests_details_id'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("labtestrequestsqueuelist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "labtestrequestsqueueview" => $Language->phrase("View"),
            "labtestrequestsqueueedit" => $Language->phrase("Edit"),
            "labtestrequestsqueueadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "labtestrequestsqueuelist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "LabTestRequestsQueueView",
            Config("API_ADD_ACTION") => "LabTestRequestsQueueAdd",
            Config("API_EDIT_ACTION") => "LabTestRequestsQueueEdit",
            Config("API_DELETE_ACTION") => "LabTestRequestsQueueDelete",
            Config("API_LIST_ACTION") => "LabTestRequestsQueueList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("labtestrequestsqueueview", $parm);
        } else {
            $url = $this->keyUrl("labtestrequestsqueueview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "labtestrequestsqueueadd?" . $parm;
        } else {
            $url = "labtestrequestsqueueadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("labtestrequestsqueueedit", $parm);
        } else {
            $url = $this->keyUrl("labtestrequestsqueueedit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labtestrequestsqueuelist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("labtestrequestsqueueadd", $parm);
        } else {
            $url = $this->keyUrl("labtestrequestsqueueadd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labtestrequestsqueuelist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("labtestrequestsqueuedelete", $parm);
        }
    }
    ...
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "lab_test_requests_details" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            ...
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->lab_test_requests_details_id->getSessionValue()); // Use Session Value
        }
        return $url;
    }
    ...
    {
        global $Response;
        $listPage = "LabTestRequestsQueueList";
    ...
    public function renderEditRow()
    {
        ...
        $this->waiting_time->EditValue = $this->waiting_time->CurrentValue;
        $this->waiting_time->PlaceHolder = RemoveHtml($this->waiting_time->caption());
        if (strval($this->waiting_time->EditValue) != "" && is_numeric($this->waiting_time->EditValue)) {
            $this->waiting_time->EditValue = FormatNumber($this->waiting_time->EditValue, null);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->lab_test_requests_details_id);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->lab_test_requests_details_id);
    ...
    {
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM lab_test_requests_queue";

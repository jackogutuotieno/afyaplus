...
/**
 * Table class for moh704a_report
 */
class Moh704aReport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "moh704a_report";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->gender->Lookup = new Lookup($this->gender, 'moh704a_report', true, 'gender', ["gender","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->countyName->Lookup = new Lookup($this->countyName, 'moh704a_report', true, 'countyName', ["countyName","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->subCounty->Lookup = new Lookup($this->subCounty, 'moh704a_report', true, 'subCounty', ["subCounty","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->marital_status->UseFilter = true; // Table header filter
        $this->marital_status->Lookup = new Lookup($this->marital_status, 'moh704a_report', true, 'marital_status', ["marital_status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->registration_date = new DbField(
            ...
            CastDateFieldForLike("`registration_date`", 7, "DB"), // Basic search expression
            135, // Type
            76, // Size
            7, // Date/Time format
            false, // Is upload field
        ...
        $this->registration_date->DefaultErrorMessage = str_replace("%s", DateFormat(7), $Language->phrase("IncorrectDate"));
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "moh704a_report";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("moh704areportlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "moh704areportview" => $Language->phrase("View"),
            "moh704areportedit" => $Language->phrase("Edit"),
            "moh704areportadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "Moh704aReportView",
            Config("API_ADD_ACTION") => "Moh704aReportAdd",
            Config("API_EDIT_ACTION") => "Moh704aReportEdit",
            Config("API_DELETE_ACTION") => "Moh704aReportDelete",
            Config("API_LIST_ACTION") => "Moh704aReportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("moh704areportview", $parm);
        } else {
            $url = $this->keyUrl("moh704areportview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "moh704areportadd?" . $parm;
        } else {
            $url = "moh704areportadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("moh704areportedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("moh704areportlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("moh704areportadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("moh704areportlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("moh704areportdelete", $parm);
        }
    }

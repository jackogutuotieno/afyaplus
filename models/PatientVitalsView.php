 ...
 * Page class
 */
class PatientVitalsView extends PatientVitals
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientVitalsView";
    ...
    // CSS class/style
    public $CurrentPageName = "patientvitalsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "patientvitalslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "patientvitalslist"; // No matching record, return to list
                    }
                break;
        }

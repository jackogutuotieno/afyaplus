 ...
 * Page class
 */
class DesignationsAdd extends Designations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DesignationsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "designationsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "designationsview") {

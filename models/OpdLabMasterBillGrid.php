 ...
 * Page class
 */
class OpdLabMasterBillGrid extends OpdLabMasterBill
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OpdLabMasterBillGrid";
    ...
    public $FormName = "fopd_lab_master_billgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "opdlabmasterbillgrid";

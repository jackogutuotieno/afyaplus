...
/**
 * Table class for lab_specimens
 */
class LabSpecimens extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "lab_specimens";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "lab_specimens";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("labspecimenslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "labspecimensview" => $Language->phrase("View"),
            "labspecimensedit" => $Language->phrase("Edit"),
            "labspecimensadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "LabSpecimensView",
            Config("API_ADD_ACTION") => "LabSpecimensAdd",
            Config("API_EDIT_ACTION") => "LabSpecimensEdit",
            Config("API_DELETE_ACTION") => "LabSpecimensDelete",
            Config("API_LIST_ACTION") => "LabSpecimensList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("labspecimensview", $parm);
        } else {
            $url = $this->keyUrl("labspecimensview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labspecimensedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labspecimenslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labspecimensadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labspecimenslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("labspecimensdelete", $parm);
        }
    }
    ...
    {
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM lab_specimens";

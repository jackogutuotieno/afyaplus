 ...
 * Page class
 */
class OpdRadiologyMasterBillGrid extends OpdRadiologyMasterBill
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OpdRadiologyMasterBillGrid";
    ...
    public $FormName = "fopd_radiology_master_billgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "opdradiologymasterbillgrid";

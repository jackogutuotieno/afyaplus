 ...
 * Page class
 */
class PatientVaccinationsDelete extends PatientVaccinations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientVaccinationsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "patientvaccinationsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientvaccinationslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("patientvaccinationslist"); // Return to list
            return;
        }

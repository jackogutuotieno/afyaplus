 ...
 * Page class
 */
class CashPaymentsGrid extends CashPayments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CashPaymentsGrid";
    ...
    public $FormName = "fcash_paymentsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "cashpaymentsgrid";

 ...
 * Page class
 */
class FullHaemogramReportAdd extends FullHaemogramReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FullHaemogramReportAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "fullhaemogramreportadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "fullhaemogramreportview") {

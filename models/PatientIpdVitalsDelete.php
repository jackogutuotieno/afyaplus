 ...
 * Page class
 */
class PatientIpdVitalsDelete extends PatientIpdVitals
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdVitalsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "patientipdvitalsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientipdvitalslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("patientipdvitalslist"); // Return to list
                return;
            }
        }

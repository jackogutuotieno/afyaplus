 ...
 * Page class
 */
class TriageOverview extends ReportTable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TriageOverview";
    ...
    public $CurrentPageName = "triageoverview";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'Triage_Overview';
        $this->TableName = 'Triage Overview';
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Triage Overview');
        }
    ...
    public function renderItem($view, $id)
    {
        ...
        try {
            if ($id == 1) {
                $Page = Container("VaccinationsReportSummary");
                $Page->run();
                $Page->VaccinationsbyMonth->DrillDownUrl = ""; // No drill down for dashboard
                $content = IsApi() && !EmptyValue($this->Export) ? "" : // Disable chart content for API export
                    $Page->VaccinationsbyMonth->render("ew-dashboard-chart", null, null) .

 ...
 * Page class
 */
class ServiceChargesView extends ServiceCharges
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceChargesView";
    ...
    // CSS class/style
    public $CurrentPageName = "servicechargesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "servicechargeslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "servicechargeslist"; // No matching record, return to list
                    }
                break;
        }

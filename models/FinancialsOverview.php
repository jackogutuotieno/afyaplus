 ...
 * Page class
 */
class FinancialsOverview extends ReportTable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinancialsOverview";
    ...
    public $CurrentPageName = "financialsoverview";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'Financials_Overview';
        $this->TableName = 'Financials Overview';
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Financials Overview');
        }

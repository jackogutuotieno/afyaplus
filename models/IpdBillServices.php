...
/**
 * Table class for ipd_bill_services
 */
class IpdBillServices extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "ipd_bill_services";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "ipd_bill_services";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ipdbillserviceslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ipdbillservicesview" => $Language->phrase("View"),
            "ipdbillservicesedit" => $Language->phrase("Edit"),
            "ipdbillservicesadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "IpdBillServicesView",
            Config("API_ADD_ACTION") => "IpdBillServicesAdd",
            Config("API_EDIT_ACTION") => "IpdBillServicesEdit",
            Config("API_DELETE_ACTION") => "IpdBillServicesDelete",
            Config("API_LIST_ACTION") => "IpdBillServicesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ipdbillservicesview", $parm);
        } else {
            $url = $this->keyUrl("ipdbillservicesview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ipdbillservicesadd?" . $parm;
        } else {
            $url = "ipdbillservicesadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ipdbillservicesedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ipdbillserviceslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ipdbillservicesadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ipdbillserviceslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ipdbillservicesdelete", $parm);
        }
    }

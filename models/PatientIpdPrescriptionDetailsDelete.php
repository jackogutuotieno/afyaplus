 ...
 * Page class
 */
class PatientIpdPrescriptionDetailsDelete extends PatientIpdPrescriptionDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdPrescriptionDetailsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "patientipdprescriptiondetailsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientipdprescriptiondetailslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("patientipdprescriptiondetailslist"); // Return to list
                return;
            }
        }

 ...
 * Page class
 */
class ItemPurchasesView extends ItemPurchases
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemPurchasesView";
    ...
    // CSS class/style
    public $CurrentPageName = "itempurchasesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "itempurchaseslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "itempurchaseslist"; // No matching record, return to list
                    }
                break;
        }

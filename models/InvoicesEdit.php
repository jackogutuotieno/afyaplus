 ...
 * Page class
 */
class InvoicesEdit extends Invoices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvoicesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "invoicesedit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("invoice_details", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("InvoiceDetailsGrid");
            if (in_array("invoice_details", $detailTblVar) && $detailPage->DetailEdit && $editRow) {

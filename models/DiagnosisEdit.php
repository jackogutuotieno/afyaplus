 ...
 * Page class
 */
class DiagnosisEdit extends Diagnosis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DiagnosisEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "diagnosisedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("diagnosislist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "diagnosislist") {
                            ...
                            $returnUrl = "diagnosislist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    public function renderRow()
    {
        ...
        // disease_id
        $this->disease_id->RowCssClass = "row";

        // additional_findings
        $this->additional_findings->RowCssClass = "row";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("diagnosislist"), "", $this->TableVar, true);
        $pageId = "edit";

 ...
 * Page class
 */
class PatientsAppointmentsCalendar extends PatientsAppointments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientsAppointmentsCalendar";
    ...
    public $CurrentPageName = "patientsappointments";
    ...
    public function run()
    {
        ...
        $this->ViewUrl = $Security->canView() ? "patientsappointmentsview" : "";
        $this->AddUrl = $Security->canAdd() ? "patientsappointmentsadd" : "";
        $this->EditUrl = $Security->canEdit() ? "patientsappointmentsedit" : "";
        $this->CopyUrl = $Security->canAdd() ? "patientsappointmentsadd" : "";
        $this->DeleteUrl = $Security->canDelete() ? "patientsappointmentsdelete" : "";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fPatients_Appointmentssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fPatients_Appointmentssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;

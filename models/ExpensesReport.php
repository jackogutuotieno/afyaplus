...
/**
 * Table class for Expenses Report
 */
class ExpensesReport extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "Expenses_Report";
        $this->TableName = 'Expenses Report';
        $this->TableType = "REPORT";
        $this->TableReportType = "summary"; // Report Type
        $this->ReportSourceTable = 'expenses_report2'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->id->SourceTableVar = 'expenses_report2';
        $this->Fields['id'] = &$this->id;

        // expense_title
        $this->expense_title = new ReportField(
            $this, // Table
        ...
        $this->expense_title->SourceTableVar = 'expenses_report2';
        ...
        $this->description->SourceTableVar = 'expenses_report2';
        ...
        $this->cost->SourceTableVar = 'expenses_report2';
        ...
        $this->date_created->SourceTableVar = 'expenses_report2';
        ...
        $this->date_updated->SourceTableVar = 'expenses_report2';
        $this->Fields['date_updated'] = &$this->date_updated;

        // expenses_month
        $this->expenses_month = new ReportField(
            $this, // Table
        ...
        $this->expenses_month->SourceTableVar = 'expenses_report2';
        $this->Fields['expenses_month'] = &$this->expenses_month;

        // Expenses by Month
        $this->ExpensesbyMonth = new DbChart($this, 'ExpensesbyMonth', 'Expenses by Month', 'expenses_month', 'cost', 1004, '', 0, 'SUM', 600, 500);
        $this->ExpensesbyMonth->Position = 4;
        $this->ExpensesbyMonth->PageBreakType = "before";
        $this->ExpensesbyMonth->YAxisFormat = ["Number"];
        $this->ExpensesbyMonth->YFieldFormat = ["Number"];
        $this->ExpensesbyMonth->SortType = 0;
        $this->ExpensesbyMonth->SortSequence = "";
        $this->ExpensesbyMonth->SqlSelect = $this->getQueryBuilder()->select("`expenses_month`", "''", "SUM(`cost`)");
        $this->ExpensesbyMonth->SqlGroupBy = "`expenses_month`";
        $this->ExpensesbyMonth->SqlOrderBy = "";
        ...
        $this->ExpensesbyMonth->setParameters([
            ["caption", $this->ExpensesbyMonth->caption()],
            ["xaxisname", $this->ExpensesbyMonth->xAxisName()]
        ]); // Chart caption / X axis name
        $this->ExpensesbyMonth->setParameter("yaxisname", $this->ExpensesbyMonth->yAxisName()); // Y axis name
        $this->ExpensesbyMonth->setParameters([
            ["shownames", "1"],
            ["showvalues", "1"],
            ["showhovercap", "1"]
        ]); // Show names / Show values / Show hover
        $this->ExpensesbyMonth->setParameter("alpha", DbChart::getDefaultAlpha()); // Chart alpha (datasets background color)
        ...
        $this->Charts[$this->ExpensesbyMonth->ID] = &$this->ExpensesbyMonth;

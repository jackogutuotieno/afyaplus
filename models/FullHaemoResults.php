...
/**
 * Table class for full_haemo_results
 */
class FullHaemoResults extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->test->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "full_haemo_results";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("fullhaemoresultslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "fullhaemoresultsview" => $Language->phrase("View"),
            "fullhaemoresultsedit" => $Language->phrase("Edit"),
            "fullhaemoresultsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "FullHaemoResultsView",
            Config("API_ADD_ACTION") => "FullHaemoResultsAdd",
            Config("API_EDIT_ACTION") => "FullHaemoResultsEdit",
            Config("API_DELETE_ACTION") => "FullHaemoResultsDelete",
            Config("API_LIST_ACTION") => "FullHaemoResultsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("fullhaemoresultsview", $parm);
        } else {
            $url = $this->keyUrl("fullhaemoresultsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "fullhaemoresultsadd?" . $parm;
        } else {
            $url = "fullhaemoresultsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemoresultsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemoresultslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemoresultsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemoresultslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("fullhaemoresultsdelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->test->EditValue = $this->test->CurrentValue;

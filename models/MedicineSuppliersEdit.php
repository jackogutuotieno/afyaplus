 ...
 * Page class
 */
class MedicineSuppliersEdit extends MedicineSuppliers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineSuppliersEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinesuppliersedit";
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['supplier_name'])) { // supplier_name
            $this->supplier_name->CurrentValue = $row['supplier_name'];
        }

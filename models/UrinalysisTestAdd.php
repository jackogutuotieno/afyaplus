 ...
 * Page class
 */
class UrinalysisTestAdd extends UrinalysisTest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UrinalysisTestAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "urinalysistestadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("urinalysistestlist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "urinalysistestlist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "urinalysistestview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "urinalysistestlist") {
                            ...
                            $returnUrl = "urinalysistestlist"; // Return list page content
                        }
                    }

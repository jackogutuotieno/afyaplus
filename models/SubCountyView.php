 ...
 * Page class
 */
class SubCountyView extends SubCounty
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubCountyView";
    ...
    // CSS class/style
    public $CurrentPageName = "subcountyview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "subcountylist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "subcountylist"; // No matching record, return to list
                    }
                break;
        }

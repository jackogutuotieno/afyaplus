 ...
 * Page class
 */
class LabTestRequestsAdd extends LabTestRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabTestRequestsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "labtestrequestsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "labtestrequestsview") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("lab_test_requests_details", $detailTblVar) && $detailPage->DetailAdd) {
            $detailPage->run();

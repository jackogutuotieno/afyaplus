...
/**
 * Table class for opd_radiology_master_bill
 */
class OpdRadiologyMasterBill extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "opd_radiology_master_bill";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "opd_radiology_master_bill";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("opdradiologymasterbilllist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "opdradiologymasterbillview" => $Language->phrase("View"),
            "opdradiologymasterbilledit" => $Language->phrase("Edit"),
            "opdradiologymasterbilladd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "opdradiologymasterbilllist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "OpdRadiologyMasterBillView",
            Config("API_ADD_ACTION") => "OpdRadiologyMasterBillAdd",
            Config("API_EDIT_ACTION") => "OpdRadiologyMasterBillEdit",
            Config("API_DELETE_ACTION") => "OpdRadiologyMasterBillDelete",
            Config("API_LIST_ACTION") => "OpdRadiologyMasterBillList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("opdradiologymasterbillview", $parm);
        } else {
            $url = $this->keyUrl("opdradiologymasterbillview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "opdradiologymasterbilladd?" . $parm;
        } else {
            $url = "opdradiologymasterbilladd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdradiologymasterbilledit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdradiologymasterbilllist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdradiologymasterbilladd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdradiologymasterbilllist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("opdradiologymasterbilldelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "OpdRadiologyMasterBillList";

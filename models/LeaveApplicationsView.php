 ...
 * Page class
 */
class LeaveApplicationsView extends LeaveApplications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LeaveApplicationsView";
    ...
    // CSS class/style
    public $CurrentPageName = "leaveapplicationsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "leaveapplicationslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "leaveapplicationslist"; // No matching record, return to list
                    }
                break;
        }

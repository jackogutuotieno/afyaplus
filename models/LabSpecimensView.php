 ...
 * Page class
 */
class LabSpecimensView extends LabSpecimens
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabSpecimensView";
    ...
    // CSS class/style
    public $CurrentPageName = "labspecimensview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "labspecimenslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "labspecimenslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("labspecimenslist"), "", $this->TableVar, true);
        $pageId = "view";

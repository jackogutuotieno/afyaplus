 ...
 * Page class
 */
class MedicineDispensationDetailsView extends MedicineDispensationDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineDispensationDetailsView";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinedispensationdetailsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "medicinedispensationdetailslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "medicinedispensationdetailslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("medicinedispensationdetailslist"), "", $this->TableVar, true);
        $pageId = "view";

 ...
 * Page class
 */
class PrescriptionDetailsEdit extends PrescriptionDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrescriptionDetailsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "prescriptiondetailsedit";
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->dose_type->EditValue = HtmlEncode($this->dose_type->CurrentValue);
            ...
            $this->dose_interval->EditValue = HtmlEncode($this->dose_interval->CurrentValue);

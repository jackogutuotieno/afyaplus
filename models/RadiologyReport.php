...
/**
 * Table class for Radiology Report
 */
class RadiologyReport extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "Radiology_Report";
        $this->TableName = 'Radiology Report';
        $this->TableType = "REPORT";
        $this->TableReportType = "summary"; // Report Type
        $this->ReportSourceTable = 'radiology_report2'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->id->SourceTableVar = 'radiology_report2';
        $this->Fields['id'] = &$this->id;

        // patient_name_radiology
        $this->patient_name_radiology = new ReportField(
            $this, // Table
            'x_patient_name_radiology', // Variable name
            'patient_name_radiology', // Name
            '`patient_name_radiology`', // Expression
            '`patient_name_radiology`', // Basic search expression
            200, // Type
            101, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`patient_name_radiology`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->patient_name_radiology->SourceTableVar = 'radiology_report2';
        ...
        $this->first_name->SourceTableVar = 'radiology_report2';
        ...
        $this->last_name->SourceTableVar = 'radiology_report2';
        ...
        $this->date_of_birth->SourceTableVar = 'radiology_report2';
        ...
        $this->gender->Lookup = new Lookup($this->gender, 'Radiology_Report', true, 'gender', ["gender","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->gender->SourceTableVar = 'radiology_report2';
        $this->gender->SearchType = "dropdown";
        $this->Fields['gender'] = &$this->gender;

        // subcategory
        $this->subcategory = new ReportField(
            $this, // Table
        ...
        $this->subcategory->SourceTableVar = 'radiology_report2';
        ...
        $this->service_name->SourceTableVar = 'radiology_report2';
        ...
        $this->date_created->SourceTableVar = 'radiology_report2';
        ...
        $this->date_updated->SourceTableVar = 'radiology_report2';
        $this->Fields['date_updated'] = &$this->date_updated;

        // radiology_month
        $this->radiology_month = new ReportField(
            $this, // Table
        ...
        $this->radiology_month->SourceTableVar = 'radiology_report2';
        $this->Fields['radiology_month'] = &$this->radiology_month;

        // Submissions by Month
        $this->SubmissionsbyMonth = new DbChart($this, 'SubmissionsbyMonth', 'Submissions by Month', 'radiology_month', 'radiology_month', 1001, '', 0, 'COUNT', 600, 500);
        $this->SubmissionsbyMonth->Position = 4;
        $this->SubmissionsbyMonth->PageBreakType = "before";
        $this->SubmissionsbyMonth->YAxisFormat = [""];
        $this->SubmissionsbyMonth->YFieldFormat = [""];
        $this->SubmissionsbyMonth->SortType = 0;
        $this->SubmissionsbyMonth->SortSequence = "";
        $this->SubmissionsbyMonth->SqlSelect = $this->getQueryBuilder()->select("`radiology_month`", "''", "COUNT(`radiology_month`)");
        $this->SubmissionsbyMonth->SqlGroupBy = "`radiology_month`";
        $this->SubmissionsbyMonth->SqlOrderBy = "";
        $this->SubmissionsbyMonth->SeriesDateType = "";
        $this->SubmissionsbyMonth->ID = "Radiology_Report_SubmissionsbyMonth"; // Chart ID
        $this->SubmissionsbyMonth->setParameters([
            ["type", "1001"],
            ["seriestype", "0"]
        ]); // Chart type / Chart series type
        $this->SubmissionsbyMonth->setParameters([
            ["caption", $this->SubmissionsbyMonth->caption()],
            ["xaxisname", $this->SubmissionsbyMonth->xAxisName()]
        ]); // Chart caption / X axis name
        $this->SubmissionsbyMonth->setParameter("yaxisname", $this->SubmissionsbyMonth->yAxisName()); // Y axis name
        $this->SubmissionsbyMonth->setParameters([
            ["shownames", "1"],
            ["showvalues", "1"],
            ["showhovercap", "1"]
        ]); // Show names / Show values / Show hover
        $this->SubmissionsbyMonth->setParameter("alpha", DbChart::getDefaultAlpha()); // Chart alpha (datasets background color)
        $this->SubmissionsbyMonth->setParameters([["options.plugins.legend.display",false],["options.plugins.legend.fullWidth",false],["options.plugins.legend.reverse",false],["options.plugins.legend.rtl",false],["options.plugins.legend.labels.usePointStyle",false],["options.plugins.title.display",false],["options.plugins.tooltip.enabled",false],["options.plugins.tooltip.intersect",false],["options.plugins.tooltip.displayColors",false],["options.plugins.tooltip.rtl",false],["options.plugins.filler.propagate",false],["options.animation.animateRotate",false],["options.animation.animateScale",false],["options.scales.r.angleLines.display",false],["options.plugins.stacked100.enable",false],["dataset.showLine",false],["dataset.spanGaps",false],["dataset.steppedLine",false],["dataset.circular",false],["scale.offset",false],["scale.gridLines.offsetGridLines",false],["options.plugins.datalabels.clamp",false],["options.plugins.datalabels.clip",false],["options.plugins.datalabels.display",false],["annotation1.show",false],["annotation1.secondaryYAxis",false],["annotation2.show",false],["annotation2.secondaryYAxis",false],["annotation3.show",false],["annotation3.secondaryYAxis",false],["annotation4.show",false],["annotation4.secondaryYAxis",false]]);
        $this->Charts[$this->SubmissionsbyMonth->ID] = &$this->SubmissionsbyMonth;

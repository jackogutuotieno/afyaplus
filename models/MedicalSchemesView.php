 ...
 * Page class
 */
class MedicalSchemesView extends MedicalSchemes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicalSchemesView";
    ...
    // CSS class/style
    public $CurrentPageName = "medicalschemesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "medicalschemeslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "medicalschemeslist"; // No matching record, return to list
                    }
                break;
        }

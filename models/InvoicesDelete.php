 ...
 * Page class
 */
class InvoicesDelete extends Invoices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvoicesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "invoicesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("invoiceslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("invoiceslist"); // Return to list
            return;
        }

 ...
 * Page class
 */
class LeaveApplicationsAdd extends LeaveApplications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LeaveApplicationsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "leaveapplicationsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("leaveapplicationslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "leaveapplicationslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "leaveapplicationsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "leaveapplicationslist") {
                            ...
                            $returnUrl = "leaveapplicationslist"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("leaveapplicationslist"), "", $this->TableVar, true);

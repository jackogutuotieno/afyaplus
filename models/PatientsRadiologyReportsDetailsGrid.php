 ...
 * Page class
 */
class PatientsRadiologyReportsDetailsGrid extends PatientsRadiologyReportsDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientsRadiologyReportsDetailsGrid";
    ...
    public $FormName = "fpatients_radiology_reports_detailsgrid";
    ...
    public function emptyRow()
    {
        global $CurrentForm;
        if (
            $CurrentForm->hasValue("x_findings") &&
            $CurrentForm->hasValue("o_findings") &&
            $this->findings->CurrentValue != $this->findings->DefaultValue &&
            !($this->findings->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->findings->CurrentValue == $this->findings->getSessionValue())
        ) {
            return false;
        }
        return true;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_findings")) {
            $this->findings->setOldValue($CurrentForm->getValue("o_findings"));
        }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // findings
        $this->findings->setDbValueDef($rsnew, $this->findings->CurrentValue, $this->findings->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['findings'])) { // findings
            $this->findings->CurrentValue = $row['findings'];
        }
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "patients_radiology_reports") {
            $this->radiology_requests_id->Visible = true; // Need to insert foreign key
            $this->radiology_requests_id->CurrentValue = $this->radiology_requests_id->getSessionValue();
        }
    ...
    protected function getAddRow()
    {
        ...
        if ($this->radiology_requests_id->getSessionValue() != "") {
            $rsnew['radiology_requests_id'] = $this->radiology_requests_id->getSessionValue();
        }
        return $rsnew;
    }

 ...
 * Page class
 */
class IpdBillingReportView extends IpdBillingReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IpdBillingReportView";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ipdbillingreportlist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ipdbillingreportlist"), "", $this->TableVar, true);
        $pageId = "view";

 ...
 * Page class
 */
class MedicineDispensationDetailsDelete extends MedicineDispensationDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineDispensationDetailsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinedispensationdetailsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("medicinedispensationdetailslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("medicinedispensationdetailslist"); // Return to list
                return;
            }
        }

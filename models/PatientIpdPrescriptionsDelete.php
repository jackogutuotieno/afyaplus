 ...
 * Page class
 */
class PatientIpdPrescriptionsDelete extends PatientIpdPrescriptions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdPrescriptionsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "patientipdprescriptionsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientipdprescriptionslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("patientipdprescriptionslist"); // Return to list
                return;
            }
        }

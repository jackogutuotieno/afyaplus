 ...
 * Page class
 */
class DiagnosisView extends Diagnosis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DiagnosisView";
    ...
    // CSS class/style
    public $CurrentPageName = "diagnosisview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "diagnosislist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "diagnosislist"; // No matching record, return to list
                    }
                break;
        }

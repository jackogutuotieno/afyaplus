 ...
 */
class Vitalsreport2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vitalsreport2list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "vitalsreport2view" => $Language->phrase("View"),
            "vitalsreport2edit" => $Language->phrase("Edit"),
            "vitalsreport2add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "Vitalsreport2View",
            Config("API_ADD_ACTION") => "Vitalsreport2Add",
            Config("API_EDIT_ACTION") => "Vitalsreport2Edit",
            Config("API_DELETE_ACTION") => "Vitalsreport2Delete",
            Config("API_LIST_ACTION") => "Vitalsreport2List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vitalsreport2view", $parm);
        } else {
            $url = $this->keyUrl("vitalsreport2view", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "vitalsreport2add?" . $parm;
        } else {
            $url = "vitalsreport2add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vitalsreport2edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vitalsreport2list", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vitalsreport2add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vitalsreport2list", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("vitalsreport2delete", $parm);
        }
    }

...
/**
 * Table class for medicine_stock_data
 */
class MedicineStockData extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "medicine_stock_data";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->expiry_date = new DbField(
            ...
            CastDateFieldForLike("`expiry_date`", 0, "DB"), // Basic search expression
            133, // Type
            40, // Size
            0, // Date/Time format
            false, // Is upload field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "medicine_stock_data";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("medicinestockdatalist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "medicinestockdataview" => $Language->phrase("View"),
            "medicinestockdataedit" => $Language->phrase("Edit"),
            "medicinestockdataadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MedicineStockDataView",
            Config("API_ADD_ACTION") => "MedicineStockDataAdd",
            Config("API_EDIT_ACTION") => "MedicineStockDataEdit",
            Config("API_DELETE_ACTION") => "MedicineStockDataDelete",
            Config("API_LIST_ACTION") => "MedicineStockDataList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("medicinestockdataview", $parm);
        } else {
            $url = $this->keyUrl("medicinestockdataview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "medicinestockdataadd?" . $parm;
        } else {
            $url = "medicinestockdataadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicinestockdataedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicinestockdatalist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicinestockdataadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicinestockdatalist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("medicinestockdatadelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "MedicineStockDataList";

 ...
 * Page class
 */
class MedicineBrandsView extends MedicineBrands
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineBrandsView";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinebrandsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "medicinebrandslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "medicinebrandslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("medicinebrandslist"), "", $this->TableVar, true);
        $pageId = "view";

 ...
 * Page class
 */
class ModulesView extends Modules
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ModulesView";
    ...
    // CSS class/style
    public $CurrentPageName = "modulesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "moduleslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "moduleslist"; // No matching record, return to list
                    }
                break;
        }

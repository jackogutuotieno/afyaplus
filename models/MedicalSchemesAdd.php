 ...
 * Page class
 */
class MedicalSchemesAdd extends MedicalSchemes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicalSchemesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "medicalschemesadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "medicalschemesview") {
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['company'])) { // company
            $this->company->setFormValue($row['company']);
        }

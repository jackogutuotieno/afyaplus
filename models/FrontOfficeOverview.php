 ...
 * Page class
 */
class FrontOfficeOverview extends ReportTable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FrontOfficeOverview";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'Front_Office_Overview';
        $this->TableName = 'Front Office Overview';
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Front Office Overview');
        }
    ...
    public function renderItem($view, $id)
    {
        ...
        try {
            if ($id == 1) {
                $Page = Container("RegisteredPatientsSummary");
                $Page->run();
                $Page->RegisteredPatientsbyMonth->DrillDownUrl = ""; // No drill down for dashboard
                $content = IsApi() && !EmptyValue($this->Export) ? "" : // Disable chart content for API export
                    $Page->RegisteredPatientsbyMonth->render("ew-dashboard-chart", null, null) .

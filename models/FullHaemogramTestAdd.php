 ...
 * Page class
 */
class FullHaemogramTestAdd extends FullHaemogramTest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FullHaemogramTestAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "fullhaemogramtestadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "fullhaemogramtestview") {

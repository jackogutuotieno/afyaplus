 ...
 */
class AppointmentsReport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("appointmentsreportlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "appointmentsreportview" => $Language->phrase("View"),
            "appointmentsreportedit" => $Language->phrase("Edit"),
            "appointmentsreportadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "AppointmentsReportView",
            Config("API_ADD_ACTION") => "AppointmentsReportAdd",
            Config("API_EDIT_ACTION") => "AppointmentsReportEdit",
            Config("API_DELETE_ACTION") => "AppointmentsReportDelete",
            Config("API_LIST_ACTION") => "AppointmentsReportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("appointmentsreportview", $parm);
        } else {
            $url = $this->keyUrl("appointmentsreportview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "appointmentsreportadd?" . $parm;
        } else {
            $url = "appointmentsreportadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("appointmentsreportedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("appointmentsreportlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("appointmentsreportadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("appointmentsreportlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("appointmentsreportdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "AppointmentsReportList";

 ...
 * Page class
 */
class UrinalysisReportView extends UrinalysisReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UrinalysisReportView";
    ...
    // CSS class/style
    public $CurrentPageName = "urinalysisreportview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "urinalysisreportlist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "urinalysisreportlist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("urinalysisreportlist"), "", $this->TableVar, true);
        $pageId = "view";

 ...
 * Page class
 */
class LabSpecimensAdd extends LabSpecimens
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabSpecimensAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "labspecimensadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "labspecimensview") {
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['specimen'])) { // specimen
            $this->specimen->setFormValue($row['specimen']);
        }

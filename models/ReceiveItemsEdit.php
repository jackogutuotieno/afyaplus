 ...
 * Page class
 */
class ReceiveItemsEdit extends ReceiveItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReceiveItemsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "receiveitemsedit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // total_items_received
        $this->total_items_received->setDbValueDef($rsnew, $this->total_items_received->CurrentValue, $this->total_items_received->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['total_items_received'])) { // total_items_received
            $this->total_items_received->CurrentValue = $row['total_items_received'];
        }

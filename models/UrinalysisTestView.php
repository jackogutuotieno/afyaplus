 ...
 * Page class
 */
class UrinalysisTestView extends UrinalysisTest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UrinalysisTestView";
    ...
    // CSS class/style
    public $CurrentPageName = "urinalysistestview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "urinalysistestlist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "urinalysistestlist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("urinalysistestlist"), "", $this->TableVar, true);
        $pageId = "view";

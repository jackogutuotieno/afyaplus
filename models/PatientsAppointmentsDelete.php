 ...
 * Page class
 */
class PatientsAppointmentsDelete extends PatientsAppointments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientsAppointmentsDelete";
    ...
    public $CurrentPageName = "patientsappointmentsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientsappointmentslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("patientsappointmentslist"); // Return to list
                return;
            }
        }

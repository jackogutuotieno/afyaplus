 ...
 * Page class
 */
class OpdBillTotalGrid extends OpdBillTotal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OpdBillTotalGrid";
    ...
    public $FormName = "fopd_bill_totalgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "opdbilltotalgrid";

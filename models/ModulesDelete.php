 ...
 * Page class
 */
class ModulesDelete extends Modules
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ModulesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "modulesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("moduleslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("moduleslist"); // Return to list
                return;
            }
        }

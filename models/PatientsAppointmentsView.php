 ...
 * Page class
 */
class PatientsAppointmentsView extends PatientsAppointments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientsAppointmentsView";
    ...
    public $CurrentPageName = "patientsappointmentsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "patientsappointmentslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "patientsappointmentslist"; // No matching record, return to list
                    }
                break;
        }

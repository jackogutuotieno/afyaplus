 ...
 * Page class
 */
class MedicineSuppliersView extends MedicineSuppliers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineSuppliersView";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinesuppliersview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "medicinesupplierslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "medicinesupplierslist"; // No matching record, return to list
                    }
                break;
        }

 ...
 * Page class
 */
class MedicineSuppliersDelete extends MedicineSuppliers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineSuppliersDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinesuppliersdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("medicinesupplierslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("medicinesupplierslist"); // Return to list
                return;
            }
        }

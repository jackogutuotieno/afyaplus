 ...
 * Page class
 */
class BrandingView extends Branding
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BrandingView";
    ...
    // CSS class/style
    public $CurrentPageName = "brandingview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "brandinglist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "brandinglist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("brandinglist"), "", $this->TableVar, true);
        $pageId = "view";

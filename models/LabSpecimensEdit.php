 ...
 * Page class
 */
class LabSpecimensEdit extends LabSpecimens
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabSpecimensEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "labspecimensedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("labspecimenslist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "labspecimenslist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "labspecimenslist") {
                            ...
                            $returnUrl = "labspecimenslist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->specimen->Visible && $this->specimen->Required) {
    ...
    protected function getEditRow($rsold)
    {
        ...
        // specimen
        $this->specimen->setDbValueDef($rsnew, $this->specimen->CurrentValue, $this->specimen->ReadOnly);
    ...
    {
        if (isset($row['specimen'])) { // specimen
            $this->specimen->CurrentValue = $row['specimen'];
        }

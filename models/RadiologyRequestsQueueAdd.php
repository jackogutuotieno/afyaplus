 ...
 * Page class
 */
class RadiologyRequestsQueueAdd extends RadiologyRequestsQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyRequestsQueueAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "radiologyrequestsqueueadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("radiologyrequestsqueuelist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "radiologyrequestsqueueview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "radiologyrequestsqueuelist") {
                            ...
                            $returnUrl = "radiologyrequestsqueuelist"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("radiologyrequestsqueuelist"), "", $this->TableVar, true);

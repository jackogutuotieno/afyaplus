 ...
 * Page class
 */
class RadiologyReportsDelete extends RadiologyReports
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyReportsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "radiologyreportsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("radiologyreportslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("radiologyreportslist"); // Return to list
                return;
            }
        }

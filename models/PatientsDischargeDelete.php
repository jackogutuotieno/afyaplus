 ...
 * Page class
 */
class PatientsDischargeDelete extends PatientsDischarge
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientsDischargeDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "patientsdischargedelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientsdischargelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("patientsdischargelist"); // Return to list
                return;
            }
        }

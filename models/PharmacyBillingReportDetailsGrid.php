 ...
 * Page class
 */
class PharmacyBillingReportDetailsGrid extends PharmacyBillingReportDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyBillingReportDetailsGrid";
    ...
    public $FormName = "fpharmacy_billing_report_detailsgrid";

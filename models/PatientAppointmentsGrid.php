 ...
 * Page class
 */
class PatientAppointmentsGrid extends PatientAppointments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientAppointmentsGrid";
    ...
    public $FormName = "fpatient_appointmentsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "patientappointmentsgrid";
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_description") &&
            $CurrentForm->hasValue("o_description") &&
        ...
        if (
            $CurrentForm->hasValue("x_start_date") &&
            $CurrentForm->hasValue("o_start_date") &&
            $this->start_date->CurrentValue != $this->start_date->DefaultValue &&
            !($this->start_date->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->start_date->CurrentValue == $this->start_date->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_end_date") &&
            $CurrentForm->hasValue("o_end_date") &&
            $this->end_date->CurrentValue != $this->end_date->DefaultValue &&
            !($this->end_date->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->end_date->CurrentValue == $this->end_date->getSessionValue())
        ) {
            return false;
        }
        if ($CurrentForm->hasValue("x_is_all_day") && $CurrentForm->hasValue("o_is_all_day") && ConvertToBool($this->is_all_day->CurrentValue) != ConvertToBool($this->is_all_day->DefaultValue)) {
            return false;
        }
        if (
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_is_all_day")) {
            $this->is_all_day->setOldValue($CurrentForm->getValue("o_is_all_day"));
        }

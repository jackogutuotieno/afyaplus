 ...
 * Page class
 */
class RadiologyRequestsQueueEdit extends RadiologyRequestsQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyRequestsQueueEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "radiologyrequestsqueueedit";

 ...
 * Page class
 */
class ItemCategoriesAdd extends ItemCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemCategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "itemcategoriesadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("itemcategorieslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "itemcategorieslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "itemcategoriesview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "itemcategorieslist") {
                            ...
                            $returnUrl = "itemcategorieslist"; // Return list page content
                        }
                    }

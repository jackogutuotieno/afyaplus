...
/**
 * Table class for radiology_billing_report_details
 */
class RadiologyBillingReportDetails extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "radiology_billing_report_details";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    public function getMasterFilterFromSession()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "radiology_billing_report") {
            $masterTable = Container("radiology_billing_report");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "radiology_billing_report_details";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("radiologybillingreportdetailslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "radiologybillingreportdetailsview" => $Language->phrase("View"),
            "radiologybillingreportdetailsedit" => $Language->phrase("Edit"),
            "radiologybillingreportdetailsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "radiologybillingreportdetailslist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "RadiologyBillingReportDetailsView",
            Config("API_ADD_ACTION") => "RadiologyBillingReportDetailsAdd",
            Config("API_EDIT_ACTION") => "RadiologyBillingReportDetailsEdit",
            Config("API_DELETE_ACTION") => "RadiologyBillingReportDetailsDelete",
            Config("API_LIST_ACTION") => "RadiologyBillingReportDetailsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("radiologybillingreportdetailsview", $parm);
        } else {
            $url = $this->keyUrl("radiologybillingreportdetailsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "radiologybillingreportdetailsadd?" . $parm;
        } else {
            $url = "radiologybillingreportdetailsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologybillingreportdetailsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologybillingreportdetailslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologybillingreportdetailsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologybillingreportdetailslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("radiologybillingreportdetailsdelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "radiology_billing_report" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
    ...
    {
        global $Response;
        $listPage = "RadiologyBillingReportDetailsList";
    ...
    public function exportDocument($doc, $result, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->radiology_request_id, '');

 ...
 * Page class
 */
class VisitsReport1Summary extends VisitsReport1
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VisitsReport1Summary";
    ...
    public $CurrentPageName = "visitsreport1";
    ...
    public function __construct()
    {
        ...
        // Table object (Visits_Report1)
        if (!isset($GLOBALS["Visits_Report1"]) || $GLOBALS["Visits_Report1"]::class == PROJECT_NAMESPACE . "Visits_Report1") {
            $GLOBALS["Visits_Report1"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Visits Report1');
        }

 ...
 * Page class
 */
class DiagnosisDelete extends Diagnosis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DiagnosisDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "diagnosisdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("diagnosislist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("diagnosislist"); // Return to list
            return;
        }

 ...
 * Page class
 */
class MedicineIpdDispensationDelete extends MedicineIpdDispensation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineIpdDispensationDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "medicineipddispensationdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("medicineipddispensationlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("medicineipddispensationlist"); // Return to list
                return;
            }
        }

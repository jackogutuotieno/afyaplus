 ...
 * Page class
 */
class RadiologyReportsView extends RadiologyReports
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyReportsView";
    ...
    // CSS class/style
    public $CurrentPageName = "radiologyreportsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "radiologyreportslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "radiologyreportslist"; // No matching record, return to list
                    }
                break;
        }

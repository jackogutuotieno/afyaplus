...
/**
 * Table class for patient_vaccinations
 */
class PatientVaccinations extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "patient_vaccinations";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->service_id->addMethod("getSelectFilter", fn() => "`service_category_id`=5");
        ...
        $this->status->Lookup = new Lookup($this->status, 'patient_vaccinations', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "patient_vaccinations";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("patientvaccinationslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "patientvaccinationsview" => $Language->phrase("View"),
            "patientvaccinationsedit" => $Language->phrase("Edit"),
            "patientvaccinationsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PatientVaccinationsView",
            Config("API_ADD_ACTION") => "PatientVaccinationsAdd",
            Config("API_EDIT_ACTION") => "PatientVaccinationsEdit",
            Config("API_DELETE_ACTION") => "PatientVaccinationsDelete",
            Config("API_LIST_ACTION") => "PatientVaccinationsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("patientvaccinationsview", $parm);
        } else {
            $url = $this->keyUrl("patientvaccinationsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "patientvaccinationsadd?" . $parm;
        } else {
            $url = "patientvaccinationsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientvaccinationsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientvaccinationslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientvaccinationsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientvaccinationslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("patientvaccinationsdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "PatientVaccinationsList";
    ...
    {
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM patient_vaccinations";
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'patient_vaccinations');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'patient_vaccinations', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'patient_vaccinations', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'patient_vaccinations', $fldname, $key, $oldvalue);
            }
        }
    }

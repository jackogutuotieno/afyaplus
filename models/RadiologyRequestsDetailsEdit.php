 ...
 * Page class
 */
class RadiologyRequestsDetailsEdit extends RadiologyRequestsDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyRequestsDetailsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "radiologyrequestsdetailsedit";
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "radiologyrequestsdetailslist") {
                            ...
                            $returnUrl = "radiologyrequestsdetailslist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function validateForm()
    {
        ...
        if (in_array("radiology_requests_queue", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("RadiologyRequestsQueueGrid");
            if (in_array("radiology_requests_queue", $detailTblVar) && $detailPage->DetailEdit && $editRow) {

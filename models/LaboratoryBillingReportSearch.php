 ...
 * Page class
 */
class LaboratoryBillingReportSearch extends LaboratoryBillingReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LaboratoryBillingReportSearch";
    ...
    // CSS class/style
    public $CurrentPageName = "laboratorybillingreportsearch";
    ...
    public function run()
    {
        ...
        if ($this->isSearch()) {
            ...
            if ($srchStr != "") {
                $srchStr = "laboratorybillingreportlist" . "?" . $srchStr;
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->visit_id->AdvancedSearch->SearchValue)) {

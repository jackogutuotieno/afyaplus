 ...
 * Page class
 */
class IpdBedChargesGrid extends IpdBedCharges
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IpdBedChargesGrid";
    ...
    public $FormName = "fipd_bed_chargesgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ipdbedchargesgrid";

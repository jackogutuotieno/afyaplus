...
/**
 * Table class for Visits Month
 */
class VisitsMonth extends ReportTable
{
    protected $SqlFrom = "";
    ...
    {
        return "*, CONCAT(first_name,' ',last_name) AS patient_name_visits, CONCAT(first_name,' ',last_name) AS `patient_name_visits`";
    }

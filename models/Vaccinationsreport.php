 ...
 */
class Vaccinationsreport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vaccinationsreportlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "vaccinationsreportview" => $Language->phrase("View"),
            "vaccinationsreportedit" => $Language->phrase("Edit"),
            "vaccinationsreportadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "VaccinationsreportView",
            Config("API_ADD_ACTION") => "VaccinationsreportAdd",
            Config("API_EDIT_ACTION") => "VaccinationsreportEdit",
            Config("API_DELETE_ACTION") => "VaccinationsreportDelete",
            Config("API_LIST_ACTION") => "VaccinationsreportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vaccinationsreportview", $parm);
        } else {
            $url = $this->keyUrl("vaccinationsreportview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "vaccinationsreportadd?" . $parm;
        } else {
            $url = "vaccinationsreportadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vaccinationsreportedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vaccinationsreportlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vaccinationsreportadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vaccinationsreportlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("vaccinationsreportdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "VaccinationsreportList";

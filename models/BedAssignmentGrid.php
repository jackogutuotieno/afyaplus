 ...
 * Page class
 */
class BedAssignmentGrid extends BedAssignment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BedAssignmentGrid";
    ...
    public $FormName = "fbed_assignmentgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "bedassignmentgrid";
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_bed_id") &&
            $CurrentForm->hasValue("o_bed_id") &&
            $this->bed_id->CurrentValue != $this->bed_id->DefaultValue &&
            !($this->bed_id->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->bed_id->CurrentValue == $this->bed_id->getSessionValue())
        ) {
            return false;
        }
        if (
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"bed_assignment\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {

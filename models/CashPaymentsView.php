 ...
 * Page class
 */
class CashPaymentsView extends CashPayments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CashPaymentsView";
    ...
    // CSS class/style
    public $CurrentPageName = "cashpaymentsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "cashpaymentslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "cashpaymentslist"; // No matching record, return to list
                    }
                break;
        }

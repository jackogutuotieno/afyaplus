 ...
 * Page class
 */
class MedicineIpdDispensationDetailsDelete extends MedicineIpdDispensationDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineIpdDispensationDetailsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "medicineipddispensationdetailsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("medicineipddispensationdetailslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("medicineipddispensationdetailslist"); // Return to list
                return;
            }
        }

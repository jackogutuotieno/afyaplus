 ...
 * Page class
 */
class MedicineIpdDispensationEdit extends MedicineIpdDispensation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineIpdDispensationEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "medicineipddispensationedit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("medicine_ipd_dispensation_details", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("MedicineIpdDispensationDetailsGrid");
            if (in_array("medicine_ipd_dispensation_details", $detailTblVar) && $detailPage->DetailEdit && $editRow) {

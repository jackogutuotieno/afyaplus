 ...
 * Page class
 */
class PatientIpdPrescriptionsGrid extends PatientIpdPrescriptions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdPrescriptionsGrid";
    ...
    public $FormName = "fpatient_ipd_prescriptionsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "patientipdprescriptionsgrid";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "patientipdprescriptionsadd";

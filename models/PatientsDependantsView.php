 ...
 * Page class
 */
class PatientsDependantsView extends PatientsDependants
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientsDependantsView";
    ...
    // CSS class/style
    public $CurrentPageName = "patientsdependantsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "patientsdependantslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "patientsdependantslist"; // No matching record, return to list
                    }
                break;
        }

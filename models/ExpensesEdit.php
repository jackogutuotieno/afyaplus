 ...
 * Page class
 */
class ExpensesEdit extends Expenses
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ExpensesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "expensesedit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // expense_title
        $this->expense_title->setDbValueDef($rsnew, $this->expense_title->CurrentValue, $this->expense_title->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['expense_title'])) { // expense_title
            $this->expense_title->CurrentValue = $row['expense_title'];
        }

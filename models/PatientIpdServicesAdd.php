 ...
 * Page class
 */
class PatientIpdServicesAdd extends PatientIpdServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdServicesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "patientipdservicesadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("patientipdserviceslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "patientipdserviceslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "patientipdservicesview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "patientipdserviceslist") {
                            ...
                            $returnUrl = "patientipdserviceslist"; // Return list page content
                        }
                    }

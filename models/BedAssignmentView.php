 ...
 * Page class
 */
class BedAssignmentView extends BedAssignment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BedAssignmentView";
    ...
    // CSS class/style
    public $CurrentPageName = "bedassignmentview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "bedassignmentlist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "bedassignmentlist"; // No matching record, return to list
                    }
                break;
        }

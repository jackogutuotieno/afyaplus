 ...
 * Page class
 */
class DoctorChargesView extends DoctorCharges
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DoctorChargesView";
    ...
    // CSS class/style
    public $CurrentPageName = "doctorchargesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "doctorchargeslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "doctorchargeslist"; // No matching record, return to list
                    }
                break;
        }

 ...
 * Page class
 */
class DoctorChargesDelete extends DoctorCharges
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DoctorChargesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "doctorchargesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("doctorchargeslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("doctorchargeslist"); // Return to list
            return;
        }

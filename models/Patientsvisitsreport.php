...
/**
 * Table class for patientsvisitsreport
 */
class Patientsvisitsreport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "patientsvisitsreport";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "patientsvisitsreport";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("patientsvisitsreportlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "patientsvisitsreportview" => $Language->phrase("View"),
            "patientsvisitsreportedit" => $Language->phrase("Edit"),
            "patientsvisitsreportadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "patientsvisitsreportlist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PatientsvisitsreportView",
            Config("API_ADD_ACTION") => "PatientsvisitsreportAdd",
            Config("API_EDIT_ACTION") => "PatientsvisitsreportEdit",
            Config("API_DELETE_ACTION") => "PatientsvisitsreportDelete",
            Config("API_LIST_ACTION") => "PatientsvisitsreportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("patientsvisitsreportview", $parm);
        } else {
            $url = $this->keyUrl("patientsvisitsreportview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "patientsvisitsreportadd?" . $parm;
        } else {
            $url = "patientsvisitsreportadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientsvisitsreportedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientsvisitsreportlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientsvisitsreportadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientsvisitsreportlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("patientsvisitsreportdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "PatientsvisitsreportList";

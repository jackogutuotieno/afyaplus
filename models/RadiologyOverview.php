 ...
 * Page class
 */
class RadiologyOverview extends ReportTable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyOverview";
    ...
    public $CurrentPageName = "radiologyoverview";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'Radiology_Overview';
        $this->TableName = 'Radiology Overview';
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Radiology Overview');
        }
    ...
    public function renderItem($view, $id)
    {
        ...
        try {
            if ($id == 1) {
                $Page = Container("RadiologyReportSummary");
                $Page->run();
                $Page->SubmissionsbyMonth->DrillDownUrl = ""; // No drill down for dashboard
                $content = IsApi() && !EmptyValue($this->Export) ? "" : // Disable chart content for API export
                    $Page->SubmissionsbyMonth->render("ew-dashboard-chart", null, null) .

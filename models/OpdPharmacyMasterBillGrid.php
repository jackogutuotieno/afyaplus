 ...
 * Page class
 */
class OpdPharmacyMasterBillGrid extends OpdPharmacyMasterBill
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OpdPharmacyMasterBillGrid";
    ...
    public $FormName = "fopd_pharmacy_master_billgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "opdpharmacymasterbillgrid";
    ...
    {
        $this->selling_price_per_unit->FormValue = ""; // Clear form value
    ...
    public function emptyRow()
    {
        ...
        if (
            ...
            !($this->brand_name->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->brand_name->CurrentValue == $this->brand_name->getSessionValue())
        ) {
            return false;
        }
        if (
        ...
        if (
            $CurrentForm->hasValue("x_selling_price_per_unit") &&
            $CurrentForm->hasValue("o_selling_price_per_unit") &&
            $this->selling_price_per_unit->CurrentValue != $this->selling_price_per_unit->DefaultValue &&
            !($this->selling_price_per_unit->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->selling_price_per_unit->CurrentValue == $this->selling_price_per_unit->getSessionValue())
        ) {
            return false;
        }
        if (
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_selling_price_per_unit")) {
            $this->selling_price_per_unit->setOldValue($CurrentForm->getValue("o_selling_price_per_unit"));
        }

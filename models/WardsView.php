...
class WardsView extends Wards
{
    ...
    // CSS class/style
    public $CurrentPageName = "wardsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "wardslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "wardslist"; // No matching record, return to list
                    }
                break;
        }

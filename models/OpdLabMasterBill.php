...
/**
 * Table class for opd_lab_master_bill
 */
class OpdLabMasterBill extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "opd_lab_master_bill";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "opd_lab_master_bill";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("opdlabmasterbilllist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "opdlabmasterbillview" => $Language->phrase("View"),
            "opdlabmasterbilledit" => $Language->phrase("Edit"),
            "opdlabmasterbilladd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "OpdLabMasterBillView",
            Config("API_ADD_ACTION") => "OpdLabMasterBillAdd",
            Config("API_EDIT_ACTION") => "OpdLabMasterBillEdit",
            Config("API_DELETE_ACTION") => "OpdLabMasterBillDelete",
            Config("API_LIST_ACTION") => "OpdLabMasterBillList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("opdlabmasterbillview", $parm);
        } else {
            $url = $this->keyUrl("opdlabmasterbillview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "opdlabmasterbilladd?" . $parm;
        } else {
            $url = "opdlabmasterbilladd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdlabmasterbilledit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdlabmasterbilllist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdlabmasterbilladd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdlabmasterbilllist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("opdlabmasterbilldelete", $parm);
        }
    }

 ...
 * Page class
 */
class HolidaysView extends Holidays
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HolidaysView";
    ...
    // CSS class/style
    public $CurrentPageName = "holidaysview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "holidayslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "holidayslist"; // No matching record, return to list
                    }
                break;
        }

 ...
 * Page class
 */
class PaymentMethodsView extends PaymentMethods
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PaymentMethodsView";
    ...
    // CSS class/style
    public $CurrentPageName = "paymentmethodsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "paymentmethodslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "paymentmethodslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("paymentmethodslist"), "", $this->TableVar, true);
        $pageId = "view";

 ...
 * Page class
 */
class PatientVaccinationsView extends PatientVaccinations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientVaccinationsView";
    ...
    // CSS class/style
    public $CurrentPageName = "patientvaccinationsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "patientvaccinationslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "patientvaccinationslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("patientvaccinationslist"), "", $this->TableVar, true);
        $pageId = "view";

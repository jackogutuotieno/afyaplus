 ...
 * Page class
 */
class LeaveCategoriesView extends LeaveCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LeaveCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "leavecategoriesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "leavecategorieslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "leavecategorieslist"; // No matching record, return to list
                    }
                break;
        }

 ...
 * Page class
 */
class VisitTypesView extends VisitTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VisitTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "visittypesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "visittypeslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "visittypeslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("visittypeslist"), "", $this->TableVar, true);
        $pageId = "view";

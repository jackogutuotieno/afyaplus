    ...
    public function run()
    {
        ...
        if ($Security->currentUserID() != "" && !$Security->isAdmin()) { // Non system admin
            if ($this->getCurrentMasterTable() == "medicine_dispensation") {
                $this->DbMasterFilter = $this->addMasterUserIDFilter($this->DbMasterFilter, "medicine_dispensation"); // Add master User ID filter
            }
        }
        ...
        // Load master record
        if ($this->CurrentMode != "add" && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "medicine_dispensation") {
            $masterTbl = Container("medicine_dispensation");
            $rsmaster = $masterTbl->loadRs($this->DbMasterFilter)->fetchAssociative();
            $this->MasterRecordExists = $rsmaster !== false;
            if (!$this->MasterRecordExists) {
                $this->setFailureMessage($Language->phrase("NoRecord")); // Set no record found
                $this->terminate("medicinedispensationlist"); // Return to master page
                return;
            } else {

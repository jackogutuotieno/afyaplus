 ...
 * Page class
 */
class PharmacyBillingReportGrid extends PharmacyBillingReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyBillingReportGrid";
    ...
    public $FormName = "fpharmacy_billing_reportgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "pharmacybillingreportgrid";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "pharmacybillingreportadd";

...
/**
 * Table class for full_haemogram_report
 */
class FullHaemogramReport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "full_haemogram_report";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "full_haemogram_report";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("fullhaemogramreportlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "fullhaemogramreportview" => $Language->phrase("View"),
            "fullhaemogramreportedit" => $Language->phrase("Edit"),
            "fullhaemogramreportadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "fullhaemogramreportlist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "FullHaemogramReportView",
            Config("API_ADD_ACTION") => "FullHaemogramReportAdd",
            Config("API_EDIT_ACTION") => "FullHaemogramReportEdit",
            Config("API_DELETE_ACTION") => "FullHaemogramReportDelete",
            Config("API_LIST_ACTION") => "FullHaemogramReportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("fullhaemogramreportview", $parm);
        } else {
            $url = $this->keyUrl("fullhaemogramreportview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "fullhaemogramreportadd?" . $parm;
        } else {
            $url = "fullhaemogramreportadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemogramreportedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemogramreportlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemogramreportadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemogramreportlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("fullhaemogramreportdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "FullHaemogramReportList";

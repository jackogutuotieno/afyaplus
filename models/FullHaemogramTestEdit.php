 ...
 * Page class
 */
class FullHaemogramTestEdit extends FullHaemogramTest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FullHaemogramTestEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "fullhaemogramtestedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("fullhaemogramtestlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "fullhaemogramtestlist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "fullhaemogramtestlist") {
                            ...
                            $returnUrl = "fullhaemogramtestlist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);

...
class PrescriptionsAdd extends Prescriptions
{
    ...
    protected function validateForm()
    {
        ...
        if (in_array("prescription_details", $detailTblVar) && $detailPage->DetailAdd) {
            $detailPage->run();
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("PrescriptionDetailsGrid");
            if (in_array("prescription_details", $detailTblVar) && $detailPage->DetailAdd && $addRow) {
                $detailPage->prescription_id->setSessionValue($this->id->CurrentValue); // Set master key
                $Security->loadCurrentUserLevel($this->ProjectID . "prescription_details"); // Load user level of detail table

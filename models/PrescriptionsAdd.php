 ...
 * Page class
 */
class PrescriptionsAdd extends Prescriptions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrescriptionsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "prescriptionsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("prescriptionslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "prescriptionslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "prescriptionsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "prescriptionslist") {
                            ...
                            $returnUrl = "prescriptionslist"; // Return list page content
                        }
                    }
    ...
    public function renderRow()
    {
        ...
        // lab_report_id
        $this->lab_report_id->RowCssClass = "row";

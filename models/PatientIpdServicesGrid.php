 ...
 * Page class
 */
class PatientIpdServicesGrid extends PatientIpdServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdServicesGrid";
    ...
    public $FormName = "fpatient_ipd_servicesgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "patientipdservicesgrid";

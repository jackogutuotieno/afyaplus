 ...
 * Page class
 */
class ItemCategoriesView extends ItemCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "itemcategoriesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "itemcategorieslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "itemcategorieslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("itemcategorieslist"), "", $this->TableVar, true);
        $pageId = "view";

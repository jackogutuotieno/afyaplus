 ...
 * Page class
 */
class BrandingAdd extends Branding
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BrandingAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "brandingadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("brandinglist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "brandinglist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "brandingview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "brandinglist") {
                            ...
                            $returnUrl = "brandinglist"; // Return list page content
                        }
                    }

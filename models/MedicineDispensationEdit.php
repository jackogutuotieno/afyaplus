 ...
 * Page class
 */
class MedicineDispensationEdit extends MedicineDispensation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineDispensationEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinedispensationedit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("medicine_dispensation_details", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("MedicineDispensationDetailsGrid");
            if (in_array("medicine_dispensation_details", $detailTblVar) && $detailPage->DetailEdit && $editRow) {

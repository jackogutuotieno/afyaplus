...
/**
 * Table class for radiology_report
 */
class RadiologyReport2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "radiology_report";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->patient_name_radiology = new DbField(
            $this, // Table
            'x_patient_name_radiology', // Variable name
            'patient_name_radiology', // Name
        ...
        $this->patient_name_radiology->InputTextType = "text";
        $this->patient_name_radiology->IsCustom = true; // Custom field
        $this->patient_name_radiology->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['patient_name_radiology'] = &$this->patient_name_radiology;
        ...
        // radiology_month
        $this->radiology_month = new DbField(
            $this, // Table
            'x_radiology_month', // Variable name
            'radiology_month', // Name
            '`radiology_month`', // Expression
            '`radiology_month`', // Basic search expression
            200, // Type
            9, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`radiology_month`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->radiology_month->InputTextType = "text";
        $this->radiology_month->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['radiology_month'] = &$this->radiology_month;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "radiology_report";
    }
    ...
    {
        return "*, CONCAT(first_name,' ',last_name) AS `patient_name_radiology`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->patient_name_radiology->DbValue = $row['patient_name_radiology'];
        ...
        $this->radiology_month->DbValue = $row['radiology_month'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("radiologyreport2list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "radiologyreport2view" => $Language->phrase("View"),
            "radiologyreport2edit" => $Language->phrase("Edit"),
            "radiologyreport2add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "RadiologyReport2View",
            Config("API_ADD_ACTION") => "RadiologyReport2Add",
            Config("API_EDIT_ACTION") => "RadiologyReport2Edit",
            Config("API_DELETE_ACTION") => "RadiologyReport2Delete",
            Config("API_LIST_ACTION") => "RadiologyReport2List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("radiologyreport2view", $parm);
        } else {
            $url = $this->keyUrl("radiologyreport2view", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "radiologyreport2add?" . $parm;
        } else {
            $url = "radiologyreport2add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologyreport2edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologyreport2list", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologyreport2add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologyreport2list", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("radiologyreport2delete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        // patient_name_radiology
        $this->patient_name_radiology->setupEditAttributes();
        if (!$this->patient_name_radiology->Raw) {
            $this->patient_name_radiology->CurrentValue = HtmlDecode($this->patient_name_radiology->CurrentValue);
        }
        $this->patient_name_radiology->EditValue = $this->patient_name_radiology->CurrentValue;
        $this->patient_name_radiology->PlaceHolder = RemoveHtml($this->patient_name_radiology->caption());
        ...
        // radiology_month
        $this->radiology_month->setupEditAttributes();
        if (!$this->radiology_month->Raw) {
            $this->radiology_month->CurrentValue = HtmlDecode($this->radiology_month->CurrentValue);
        }
        $this->radiology_month->EditValue = $this->radiology_month->CurrentValue;
        $this->radiology_month->PlaceHolder = RemoveHtml($this->radiology_month->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->patient_name_radiology);
                    ...
                    $doc->exportCaption($this->radiology_month);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->patient_name_radiology);
                    $doc->exportCaption($this->first_name);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->patient_name_radiology);
                        ...
                        $doc->exportField($this->radiology_month);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->patient_name_radiology);
                        $doc->exportField($this->first_name);

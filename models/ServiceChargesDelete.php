 ...
 * Page class
 */
class ServiceChargesDelete extends ServiceCharges
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceChargesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "servicechargesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("servicechargeslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("servicechargeslist"); // Return to list
                return;
            }
        }

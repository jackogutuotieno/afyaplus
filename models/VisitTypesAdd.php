 ...
 * Page class
 */
class VisitTypesAdd extends VisitTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VisitTypesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "visittypesadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("visittypeslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "visittypeslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "visittypesview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "visittypeslist") {
                            ...
                            $returnUrl = "visittypeslist"; // Return list page content
                        }
                    }

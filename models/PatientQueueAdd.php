 ...
 * Page class
 */
class PatientQueueAdd extends PatientQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientQueueAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "patientqueueadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("patientqueuelist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "patientqueuelist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "patientqueueview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "patientqueuelist") {
                            ...
                            $returnUrl = "patientqueuelist"; // Return list page content
                        }
                    }

...
/**
 * Table class for patient_admissions
 */
class PatientAdmissions extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getMasterFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "ipd_patients") {
            $masterTable = Container("ipd_patients");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "patient_admissions";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("patientadmissionslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "patientadmissionsview" => $Language->phrase("View"),
            "patientadmissionsedit" => $Language->phrase("Edit"),
            "patientadmissionsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PatientAdmissionsView",
            Config("API_ADD_ACTION") => "PatientAdmissionsAdd",
            Config("API_EDIT_ACTION") => "PatientAdmissionsEdit",
            Config("API_DELETE_ACTION") => "PatientAdmissionsDelete",
            Config("API_LIST_ACTION") => "PatientAdmissionsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("patientadmissionsview", $parm);
        } else {
            $url = $this->keyUrl("patientadmissionsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "patientadmissionsadd?" . $parm;
        } else {
            $url = "patientadmissionsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientadmissionslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientadmissionslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("patientadmissionsdelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "ipd_patients" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
    ...
    {
        global $Response;
        $listPage = "PatientAdmissionsList";
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'patient_admissions');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'patient_admissions', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'patient_admissions', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'patient_admissions', $fldname, $key, $oldvalue);
            }
        }
    }

 ...
 * Page class
 */
class ServiceSubcategoriesAdd extends ServiceSubcategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceSubcategoriesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "servicesubcategoriesview") {
    ...
    protected function getAddRow()
    {
        ...
        // subcategory
        $this->subcategory->setDbValueDef($rsnew, $this->subcategory->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['subcategory'])) { // subcategory
            $this->subcategory->setFormValue($row['subcategory']);
        }

 ...
 * Page class
 */
class RadiologyRequestsQueueDelete extends RadiologyRequestsQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyRequestsQueueDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "radiologyrequestsqueuedelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("radiologyrequestsqueuelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("radiologyrequestsqueuelist"); // Return to list
            return;
        }

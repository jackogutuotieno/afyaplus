 ...
 * Page class
 */
class ServiceChargesAdd extends ServiceCharges
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceChargesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "servicechargesadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "servicechargesview") {
    ...
    protected function getAddRow()
    {
        ...
        // service_category_id
        $this->service_category_id->setDbValueDef($rsnew, $this->service_category_id->CurrentValue, false);

        // service_subcategory_id
        $this->service_subcategory_id->setDbValueDef($rsnew, $this->service_subcategory_id->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['service_category_id'])) { // service_category_id
            $this->service_category_id->setFormValue($row['service_category_id']);
        }
        if (isset($row['service_subcategory_id'])) { // service_subcategory_id
            $this->service_subcategory_id->setFormValue($row['service_subcategory_id']);
        }

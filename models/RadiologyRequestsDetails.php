...
/**
 * Table class for radiology_requests_details
 */
class RadiologyRequestsDetails extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "radiology_requests_details";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "radiology_requests_details";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("radiologyrequestsdetailslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "radiologyrequestsdetailsview" => $Language->phrase("View"),
            "radiologyrequestsdetailsedit" => $Language->phrase("Edit"),
            "radiologyrequestsdetailsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "radiologyrequestsdetailslist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "RadiologyRequestsDetailsView",
            Config("API_ADD_ACTION") => "RadiologyRequestsDetailsAdd",
            Config("API_EDIT_ACTION") => "RadiologyRequestsDetailsEdit",
            Config("API_DELETE_ACTION") => "RadiologyRequestsDetailsDelete",
            Config("API_LIST_ACTION") => "RadiologyRequestsDetailsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("radiologyrequestsdetailsview", $parm);
        } else {
            $url = $this->keyUrl("radiologyrequestsdetailsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "radiologyrequestsdetailsadd?" . $parm;
        } else {
            $url = "radiologyrequestsdetailsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologyrequestsdetailslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologyrequestsdetailslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("radiologyrequestsdetailsdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "RadiologyRequestsDetailsList";
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'radiology_requests_details');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'radiology_requests_details', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'radiology_requests_details', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'radiology_requests_details', $fldname, $key, $oldvalue);
            }
        }
    }

 ...
 * Page class
 */
class RadiologyRequestsDelete extends RadiologyRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyRequestsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "radiologyrequestsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("radiologyrequestslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("radiologyrequestslist"); // Return to list
            return;
        }

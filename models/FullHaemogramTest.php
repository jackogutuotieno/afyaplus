...
/**
 * Table class for full_haemogram_test
 */
class FullHaemogramTest extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "full_haemogram_test";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "full_haemogram_test";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("fullhaemogramtestlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "fullhaemogramtestview" => $Language->phrase("View"),
            "fullhaemogramtestedit" => $Language->phrase("Edit"),
            "fullhaemogramtestadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "FullHaemogramTestView",
            Config("API_ADD_ACTION") => "FullHaemogramTestAdd",
            Config("API_EDIT_ACTION") => "FullHaemogramTestEdit",
            Config("API_DELETE_ACTION") => "FullHaemogramTestDelete",
            Config("API_LIST_ACTION") => "FullHaemogramTestList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("fullhaemogramtestview", $parm);
        } else {
            $url = $this->keyUrl("fullhaemogramtestview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "fullhaemogramtestadd?" . $parm;
        } else {
            $url = "fullhaemogramtestadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemogramtestedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemogramtestlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemogramtestadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("fullhaemogramtestlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("fullhaemogramtestdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "FullHaemogramTestList";

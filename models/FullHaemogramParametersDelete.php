 ...
 * Page class
 */
class FullHaemogramParametersDelete extends FullHaemogramParameters
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FullHaemogramParametersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("fullhaemogramparameterslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("fullhaemogramparameterslist"); // Return to list
                return;
            }
        }

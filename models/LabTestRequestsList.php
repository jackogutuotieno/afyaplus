...
class LabTestRequestsList extends LabTestRequests
{
    ...
    public function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->created_by_user_id, $default, true); // created_by_user_id
    ...
    public function showFilterList()
    {
        ...
        if (!$filter) {
            $this->buildSearchSql($filter, $this->created_by_user_id, false, true);
        }
        if ($filter != "") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // created_by_user_id
            if ($this->created_by_user_id->UseFilter && !EmptyValue($this->created_by_user_id->AdvancedSearch->SearchValue)) {
                if (is_array($this->created_by_user_id->AdvancedSearch->SearchValue)) {
                    $this->created_by_user_id->AdvancedSearch->SearchValue = implode(Config("FILTER_OPTION_SEPARATOR"), $this->created_by_user_id->AdvancedSearch->SearchValue);
                }
                $this->created_by_user_id->EditValue = explode(Config("FILTER_OPTION_SEPARATOR"), $this->created_by_user_id->AdvancedSearch->SearchValue);
            }

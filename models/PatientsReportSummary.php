 ...
 * Page class
 */
class PatientsReportSummary extends PatientsReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientsReportSummary";
    ...
    public $CurrentPageName = "patientsreport";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Patients Report');
        }
    ...
    public function loadRowValues($record)
    {
        ...
        $data["employment_status"] = $record['employment_status'];
        $data["religion"] = $record['religion'];
        ...
        $this->employment_status->setDbValue($record['employment_status']);
        $this->religion->setDbValue($record['religion']);
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::SEARCH) { // Search row
            ...
            $this->physical_address->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == RowType::TOTAL) { // Summary row
            ...
            // physical_address
            $currentValue = $this->physical_address->CurrentValue;
            $viewValue = &$this->physical_address->ViewValue;
            $viewAttrs = &$this->physical_address->ViewAttrs;
            $cellAttrs = &$this->physical_address->CellAttrs;
            $hrefValue = &$this->physical_address->HrefValue;
            $linkAttrs = &$this->physical_address->LinkAttrs;
            $this->cellRendered($this->physical_address, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->physical_address->Visible) {
            $this->DetailColumnCount += 1;
        }

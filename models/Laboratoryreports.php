...
/**
 * Table class for laboratoryreports
 */
class Laboratoryreports extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "laboratoryreports";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "laboratoryreports";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("laboratoryreportslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "laboratoryreportsview" => $Language->phrase("View"),
            "laboratoryreportsedit" => $Language->phrase("Edit"),
            "laboratoryreportsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "LaboratoryreportsView",
            Config("API_ADD_ACTION") => "LaboratoryreportsAdd",
            Config("API_EDIT_ACTION") => "LaboratoryreportsEdit",
            Config("API_DELETE_ACTION") => "LaboratoryreportsDelete",
            Config("API_LIST_ACTION") => "LaboratoryreportsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("laboratoryreportsview", $parm);
        } else {
            $url = $this->keyUrl("laboratoryreportsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "laboratoryreportsadd?" . $parm;
        } else {
            $url = "laboratoryreportsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("laboratoryreportsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("laboratoryreportslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("laboratoryreportsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("laboratoryreportslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("laboratoryreportsdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "LaboratoryreportsList";

 ...
 * Page class
 */
class LabTestRequestsQueueDelete extends LabTestRequestsQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabTestRequestsQueueDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "labtestrequestsqueuedelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("labtestrequestsqueuelist"); // Prevent SQL injection, return to list
            return;
        }

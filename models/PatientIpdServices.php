...
/**
 * Table class for patient_ipd_services
 */
class PatientIpdServices extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "patient_ipd_services";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "patient_ipd_services";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("patientipdserviceslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "patientipdservicesview" => $Language->phrase("View"),
            "patientipdservicesedit" => $Language->phrase("Edit"),
            "patientipdservicesadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PatientIpdServicesView",
            Config("API_ADD_ACTION") => "PatientIpdServicesAdd",
            Config("API_EDIT_ACTION") => "PatientIpdServicesEdit",
            Config("API_DELETE_ACTION") => "PatientIpdServicesDelete",
            Config("API_LIST_ACTION") => "PatientIpdServicesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("patientipdservicesview", $parm);
        } else {
            $url = $this->keyUrl("patientipdservicesview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "patientipdservicesadd?" . $parm;
        } else {
            $url = "patientipdservicesadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientipdservicesedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientipdserviceslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientipdservicesadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientipdserviceslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("patientipdservicesdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "PatientIpdServicesList";

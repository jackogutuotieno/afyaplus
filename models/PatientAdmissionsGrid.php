 ...
 * Page class
 */
class PatientAdmissionsGrid extends PatientAdmissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientAdmissionsGrid";
    ...
    public $FormName = "fpatient_admissionsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "patientadmissionsgrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "ipd_patients") {

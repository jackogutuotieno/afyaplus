 ...
 * Page class
 */
class InvoiceDetailsView extends InvoiceDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvoiceDetailsView";
    ...
    // CSS class/style
    public $CurrentPageName = "invoicedetailsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "invoicedetailslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "invoicedetailslist"; // No matching record, return to list
                    }
                break;
        }

...
/**
 * Table class for service_charges
 */
class ServiceCharges extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // service_category_id
        $this->service_category_id = new DbField(
            $this, // Table
            'x_service_category_id', // Variable name
            'service_category_id', // Name
            '`service_category_id`', // Expression
            '`service_category_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`service_category_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->service_subcategory_id = new DbField(
            $this, // Table
            'x_service_subcategory_id', // Variable name
            'service_subcategory_id', // Name
            '`service_subcategory_id`', // Expression
            '`service_subcategory_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`service_subcategory_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "service_charges";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("servicechargeslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "servicechargesview" => $Language->phrase("View"),
            "servicechargesedit" => $Language->phrase("Edit"),
            "servicechargesadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ServiceChargesView",
            Config("API_ADD_ACTION") => "ServiceChargesAdd",
            Config("API_EDIT_ACTION") => "ServiceChargesEdit",
            Config("API_DELETE_ACTION") => "ServiceChargesDelete",
            Config("API_LIST_ACTION") => "ServiceChargesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("servicechargesview", $parm);
        } else {
            $url = $this->keyUrl("servicechargesview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "servicechargesadd?" . $parm;
        } else {
            $url = "servicechargesadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("servicechargesedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("servicechargeslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("servicechargesadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("servicechargeslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("servicechargesdelete", $parm);
        }
    }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'service_charges');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'service_charges', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'service_charges', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'service_charges', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    public function rowInserted($rsold, $rsnew)
    {
        ...
        $this->setSuccessMessage("Charge item successfully created.");
    }

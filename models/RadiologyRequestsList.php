...
class RadiologyRequestsList extends RadiologyRequests
{
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "radiologyrequestsadd";

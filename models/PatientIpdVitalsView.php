 ...
 * Page class
 */
class PatientIpdVitalsView extends PatientIpdVitals
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdVitalsView";
    ...
    // CSS class/style
    public $CurrentPageName = "patientipdvitalsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "patientipdvitalslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "patientipdvitalslist"; // No matching record, return to list
                    }
                break;
        }

...
/**
 * Table class for urinalysis_test
 */
class UrinalysisTest extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "urinalysis_test";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "urinalysis_test";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("urinalysistestlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "urinalysistestview" => $Language->phrase("View"),
            "urinalysistestedit" => $Language->phrase("Edit"),
            "urinalysistestadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "UrinalysisTestView",
            Config("API_ADD_ACTION") => "UrinalysisTestAdd",
            Config("API_EDIT_ACTION") => "UrinalysisTestEdit",
            Config("API_DELETE_ACTION") => "UrinalysisTestDelete",
            Config("API_LIST_ACTION") => "UrinalysisTestList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("urinalysistestview", $parm);
        } else {
            $url = $this->keyUrl("urinalysistestview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "urinalysistestadd?" . $parm;
        } else {
            $url = "urinalysistestadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("urinalysistestedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("urinalysistestlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("urinalysistestadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("urinalysistestlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("urinalysistestdelete", $parm);
        }
    }

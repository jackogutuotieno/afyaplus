...
/**
 * Table class for radiologyreportsdetails
 */
class Radiologyreportsdetails extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "radiologyreportsdetails";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("radiologyreportsdetailslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "radiologyreportsdetailsview" => $Language->phrase("View"),
            "radiologyreportsdetailsedit" => $Language->phrase("Edit"),
            "radiologyreportsdetailsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "radiologyreportsdetailslist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "RadiologyreportsdetailsView",
            Config("API_ADD_ACTION") => "RadiologyreportsdetailsAdd",
            Config("API_EDIT_ACTION") => "RadiologyreportsdetailsEdit",
            Config("API_DELETE_ACTION") => "RadiologyreportsdetailsDelete",
            Config("API_LIST_ACTION") => "RadiologyreportsdetailsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("radiologyreportsdetailsview", $parm);
        } else {
            $url = $this->keyUrl("radiologyreportsdetailsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "radiologyreportsdetailsadd?" . $parm;
        } else {
            $url = "radiologyreportsdetailsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologyreportsdetailsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologyreportsdetailslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologyreportsdetailsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("radiologyreportsdetailslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("radiologyreportsdetailsdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "RadiologyreportsdetailsList";

 ...
 * Page class
 */
class BrandingDelete extends Branding
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BrandingDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("brandinglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("brandinglist"); // Return to list
                return;
            }
        }

 ...
 * Page class
 */
class MedicineCategoriesAdd extends MedicineCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineCategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinecategoriesadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("medicinecategorieslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "medicinecategorieslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "medicinecategoriesview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "medicinecategorieslist") {
                            ...
                            $returnUrl = "medicinecategorieslist"; // Return list page content
                        }
                    }

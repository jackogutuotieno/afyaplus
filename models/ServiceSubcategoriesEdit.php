 ...
 * Page class
 */
class ServiceSubcategoriesEdit extends ServiceSubcategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceSubcategoriesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "servicesubcategoriesedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("servicesubcategorieslist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "servicesubcategorieslist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "servicesubcategorieslist") {
                            ...
                            $returnUrl = "servicesubcategorieslist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    public function renderRow()
    {
        ...
        // subcategory
        $this->subcategory->RowCssClass = "row";
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->subcategory->Visible && $this->subcategory->Required) {
    ...
    protected function getEditRow($rsold)
    {
        ...
        // subcategory
        $this->subcategory->setDbValueDef($rsnew, $this->subcategory->CurrentValue, $this->subcategory->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['subcategory'])) { // subcategory
            $this->subcategory->CurrentValue = $row['subcategory'];
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("servicesubcategorieslist"), "", $this->TableVar, true);
        $pageId = "edit";

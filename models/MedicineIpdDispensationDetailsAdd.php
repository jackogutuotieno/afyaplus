 ...
 * Page class
 */
class MedicineIpdDispensationDetailsAdd extends MedicineIpdDispensationDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineIpdDispensationDetailsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "medicineipddispensationdetailsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("medicineipddispensationdetailslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "medicineipddispensationdetailslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "medicineipddispensationdetailsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "medicineipddispensationdetailslist") {
                            ...
                            $returnUrl = "medicineipddispensationdetailslist"; // Return list page content
                        }
                    }
    ...
    public function renderRow()
    {
        ...
        $this->medicine_dispensation_id->RowCssClass = "row";

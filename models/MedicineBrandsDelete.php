 ...
 * Page class
 */
class MedicineBrandsDelete extends MedicineBrands
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineBrandsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinebrandsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("medicinebrandslist"); // Prevent SQL injection, return to list
            return;
        }

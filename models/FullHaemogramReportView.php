 ...
 * Page class
 */
class FullHaemogramReportView extends FullHaemogramReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FullHaemogramReportView";
    ...
    // CSS class/style
    public $CurrentPageName = "fullhaemogramreportview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "fullhaemogramreportlist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "fullhaemogramreportlist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("fullhaemogramreportlist"), "", $this->TableVar, true);
        $pageId = "view";

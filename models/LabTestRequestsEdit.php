 ...
 * Page class
 */
class LabTestRequestsEdit extends LabTestRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabTestRequestsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "labtestrequestsedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("labtestrequestslist"); // No matching record, return to list
                        return;
                    }
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "labtestrequestslist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "labtestrequestslist") {
                            ...
                            $returnUrl = "labtestrequestslist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function validateForm()
    {
        ...
        if (in_array("lab_test_requests_details", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("LabTestRequestsDetailsGrid");
            if (in_array("lab_test_requests_details", $detailTblVar) && $detailPage->DetailEdit && $editRow) {

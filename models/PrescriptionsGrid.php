...
class PrescriptionsGrid extends Prescriptions
{
    ...
    public function setVisibility()
    {
        ...
        $this->lab_report_id->setVisibility();
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_prescription_title") &&
            $CurrentForm->hasValue("o_prescription_title") &&
            $this->prescription_title->CurrentValue != $this->prescription_title->DefaultValue &&
            !($this->prescription_title->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->prescription_title->CurrentValue == $this->prescription_title->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_lab_report_id") &&
            $CurrentForm->hasValue("o_lab_report_id") &&
            $this->lab_report_id->CurrentValue != $this->lab_report_id->DefaultValue &&
            !($this->lab_report_id->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->lab_report_id->CurrentValue == $this->lab_report_id->getSessionValue())
        ) {
            return false;
        }
        if (
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'lab_report_id' first before field var 'x_lab_report_id'
        $val = $CurrentForm->hasValue("lab_report_id") ? $CurrentForm->getValue("lab_report_id") : $CurrentForm->getValue("x_lab_report_id");
        if (!$this->lab_report_id->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->lab_report_id->Visible = false; // Disable update for API request
            } else {
                $this->lab_report_id->setFormValue($val, true, $validate);
            }
        }
        if ($CurrentForm->hasValue("o_lab_report_id")) {
            $this->lab_report_id->setOldValue($CurrentForm->getValue("o_lab_report_id"));
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->lab_report_id->CurrentValue = $this->lab_report_id->FormValue;
    ...
    public function loadRowValues($row = null)
    {
        ...
        $this->lab_report_id->setDbValue($row['lab_report_id']);
    ...
    protected function newRow()
    {
        ...
        $row['lab_report_id'] = $this->lab_report_id->DefaultValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // lab_report_id
            $this->lab_report_id->ViewValue = $this->lab_report_id->CurrentValue;
            $this->lab_report_id->ViewValue = FormatNumber($this->lab_report_id->ViewValue, $this->lab_report_id->formatPattern());
            ...
            // lab_report_id
            $this->lab_report_id->HrefValue = "";
            $this->lab_report_id->TooltipValue = "";
            ...
            // lab_report_id
            $this->lab_report_id->setupEditAttributes();
            $this->lab_report_id->EditValue = $this->lab_report_id->CurrentValue;
            $this->lab_report_id->PlaceHolder = RemoveHtml($this->lab_report_id->caption());
            if (strval($this->lab_report_id->EditValue) != "" && is_numeric($this->lab_report_id->EditValue)) {
                $this->lab_report_id->EditValue = FormatNumber($this->lab_report_id->EditValue, null);
            }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->lab_report_id->Visible && $this->lab_report_id->Required) {
                if (!$this->lab_report_id->IsDetailKey && EmptyValue($this->lab_report_id->FormValue)) {
                    $this->lab_report_id->addErrorMessage(str_replace("%s", $this->lab_report_id->caption(), $this->lab_report_id->RequiredErrorMessage));
                }
            }
            if (!CheckInteger($this->lab_report_id->FormValue)) {
                $this->lab_report_id->addErrorMessage($this->lab_report_id->getErrorMessage(false));
            }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // lab_report_id
        $this->lab_report_id->setDbValueDef($rsnew, $this->lab_report_id->CurrentValue, $this->lab_report_id->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['lab_report_id'])) { // lab_report_id
            $this->lab_report_id->CurrentValue = $row['lab_report_id'];
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'prescriptions'
    ...
    protected function getAddRow()
    {
        ...
        // lab_report_id
        $this->lab_report_id->setDbValueDef($rsnew, $this->lab_report_id->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['lab_report_id'])) { // lab_report_id
            $this->lab_report_id->setFormValue($row['lab_report_id']);
        }
        if (isset($row['created_by_user_id'])) { // created_by_user_id

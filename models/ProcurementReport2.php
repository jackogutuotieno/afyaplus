...
/**
 * Table class for procurement_report
 */
class ProcurementReport2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "procurement_report";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->batch_number->Lookup = new Lookup($this->batch_number, 'procurement_report2', true, 'batch_number', ["batch_number","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->supplier_name->Lookup = new Lookup($this->supplier_name, 'procurement_report2', true, 'supplier_name', ["supplier_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->category_name->Lookup = new Lookup($this->category_name, 'procurement_report2', true, 'category_name', ["category_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->subcategory_name->Lookup = new Lookup($this->subcategory_name, 'procurement_report2', true, 'subcategory_name', ["subcategory_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        // purchase_month
        $this->purchase_month = new DbField(
            $this, // Table
        ...
        $this->purchase_month->Lookup = new Lookup($this->purchase_month, 'procurement_report2', true, 'purchase_month', ["purchase_month","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        // purchase_year
        $this->purchase_year = new DbField(
            $this, // Table
        ...
        $this->purchase_year->Lookup = new Lookup($this->purchase_year, 'procurement_report2', true, 'purchase_year', ["purchase_year","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->purchase_month->DbValue = $row['purchase_month'];
        $this->purchase_year->DbValue = $row['purchase_year'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("procurementreport2list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "procurementreport2view" => $Language->phrase("View"),
            "procurementreport2edit" => $Language->phrase("Edit"),
            "procurementreport2add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ProcurementReport2View",
            Config("API_ADD_ACTION") => "ProcurementReport2Add",
            Config("API_EDIT_ACTION") => "ProcurementReport2Edit",
            Config("API_DELETE_ACTION") => "ProcurementReport2Delete",
            Config("API_LIST_ACTION") => "ProcurementReport2List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("procurementreport2view", $parm);
        } else {
            $url = $this->keyUrl("procurementreport2view", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "procurementreport2add?" . $parm;
        } else {
            $url = "procurementreport2add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("procurementreport2edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("procurementreport2list", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("procurementreport2add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("procurementreport2list", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("procurementreport2delete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ProcurementReport2List";
    ...
    public function renderEditRow()
    {
        ...
        // purchase_month
        $this->purchase_month->setupEditAttributes();
        if (!$this->purchase_month->Raw) {
            $this->purchase_month->CurrentValue = HtmlDecode($this->purchase_month->CurrentValue);
        }
        $this->purchase_month->EditValue = $this->purchase_month->CurrentValue;
        $this->purchase_month->PlaceHolder = RemoveHtml($this->purchase_month->caption());

        // purchase_year
        $this->purchase_year->setupEditAttributes();
        $this->purchase_year->EditValue = $this->purchase_year->CurrentValue;
        $this->purchase_year->PlaceHolder = RemoveHtml($this->purchase_year->caption());
        if (strval($this->purchase_year->EditValue) != "" && is_numeric($this->purchase_year->EditValue)) {
            $this->purchase_year->EditValue = FormatNumber($this->purchase_year->EditValue, null);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->purchase_month);
                    $doc->exportCaption($this->purchase_year);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->purchase_month);
                        $doc->exportField($this->purchase_year);

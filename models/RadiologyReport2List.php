 ...
 * Page class
 */
class RadiologyReport2List extends RadiologyReport2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyReport2List";
    ...
    public $FormName = "fradiology_report2list";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "radiologyreport2list";
    ...
    public function setVisibility()
    {
        ...
        $this->patient_name_radiology->setVisibility();
        ...
        $this->radiology_month->setVisibility();
    }
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'radiology_report2';
        $this->TableName = 'radiology_report';
        ...
        // Table object (radiology_report2)
        if (!isset($GLOBALS["radiology_report2"]) || $GLOBALS["radiology_report2"]::class == PROJECT_NAMESPACE . "radiology_report2") {
            $GLOBALS["radiology_report2"] = &$this;
        }
        ...
        // Initialize URLs
        $this->AddUrl = "radiologyreport2add";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "radiologyreport2delete";
        $this->MultiUpdateUrl = "radiologyreport2update";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'radiology_report');
        }
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if (!SameString($pageName, GetPageName($this->getListUrl()))) { // Not List page
                    ...
                    $result["view"] = SameString($pageName, "radiologyreport2view"); // If View page, no primary button
                } else { // List page
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fradiology_report2grid";
        }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fradiology_report2srch");
        }
        $filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
        $filterList = Concat($filterList, $this->patient_name_radiology->AdvancedSearch->toJson(), ","); // Field patient_name_radiology
        ...
        $filterList = Concat($filterList, $this->radiology_month->AdvancedSearch->toJson(), ","); // Field radiology_month
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fradiology_report2srch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field patient_name_radiology
        $this->patient_name_radiology->AdvancedSearch->SearchValue = @$filter["x_patient_name_radiology"];
        $this->patient_name_radiology->AdvancedSearch->SearchOperator = @$filter["z_patient_name_radiology"];
        $this->patient_name_radiology->AdvancedSearch->SearchCondition = @$filter["v_patient_name_radiology"];
        $this->patient_name_radiology->AdvancedSearch->SearchValue2 = @$filter["y_patient_name_radiology"];
        $this->patient_name_radiology->AdvancedSearch->SearchOperator2 = @$filter["w_patient_name_radiology"];
        $this->patient_name_radiology->AdvancedSearch->save();
        ...
        // Field radiology_month
        $this->radiology_month->AdvancedSearch->SearchValue = @$filter["x_radiology_month"];
        $this->radiology_month->AdvancedSearch->SearchOperator = @$filter["z_radiology_month"];
        $this->radiology_month->AdvancedSearch->SearchCondition = @$filter["v_radiology_month"];
        $this->radiology_month->AdvancedSearch->SearchValue2 = @$filter["y_radiology_month"];
        $this->radiology_month->AdvancedSearch->SearchOperator2 = @$filter["w_radiology_month"];
        $this->radiology_month->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->patient_name_radiology;
        ...
        $searchFlds[] = &$this->radiology_month;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->patient_name_radiology); // patient_name_radiology
            ...
            $this->updateSort($this->radiology_month); // radiology_month
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->id->setSort("");
                $this->patient_name_radiology->setSort("");
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fradiology_report2list\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fradiology_report2list\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "patient_name_radiology");
            ...
            $this->createColumnOption($option, "radiology_month");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fradiology_report2srch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fradiology_report2srch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fradiology_report2list"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_radiology_report2", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_radiology_report2",
    ...
    public function loadRowValues($row = null)
    {
        ...
        $this->patient_name_radiology->setDbValue($row['patient_name_radiology']);
        ...
        $this->radiology_month->setDbValue($row['radiology_month']);
    }
    ...
    protected function newRow()
    {
        ...
        $row['patient_name_radiology'] = $this->patient_name_radiology->DefaultValue;
        ...
        $row['radiology_month'] = $this->radiology_month->DefaultValue;
        return $row;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // patient_name_radiology
            $this->patient_name_radiology->ViewValue = $this->patient_name_radiology->CurrentValue;
            ...
            // radiology_month
            $this->radiology_month->ViewValue = $this->radiology_month->CurrentValue;
            ...
            // patient_name_radiology
            $this->patient_name_radiology->HrefValue = "";
            $this->patient_name_radiology->TooltipValue = "";
            ...
            // radiology_month
            $this->radiology_month->HrefValue = "";
            $this->radiology_month->TooltipValue = "";
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fradiology_report2list" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fradiology_report2srch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;

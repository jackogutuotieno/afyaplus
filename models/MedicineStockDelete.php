 ...
 * Page class
 */
class MedicineStockDelete extends MedicineStock
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineStockDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinestockdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("medicinestocklist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("medicinestocklist"); // Return to list
                return;
            }
        }

 ...
 * Page class
 */
class WardTypeDelete extends WardType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WardTypeDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "wardtypedelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("wardtypelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("wardtypelist"); // Return to list
                return;
            }
        }

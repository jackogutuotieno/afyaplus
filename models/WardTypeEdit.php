 ...
 * Page class
 */
class WardTypeEdit extends WardType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WardTypeEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "wardtypeedit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // ward_type
        $this->ward_type->setDbValueDef($rsnew, $this->ward_type->CurrentValue, $this->ward_type->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['ward_type'])) { // ward_type
            $this->ward_type->CurrentValue = $row['ward_type'];
        }
    }

 ...
 * Page class
 */
class MedicineStockView extends MedicineStock
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineStockView";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinestockview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "medicinestocklist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "medicinestocklist"; // No matching record, return to list
                    }
                break;
        }

...
/**
 * Table class for patient_appointments
 */
class PatientAppointments extends DbTable
{
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PatientAppointmentsView",
            Config("API_ADD_ACTION") => "PatientAppointmentsAdd",
            Config("API_EDIT_ACTION") => "PatientAppointmentsEdit",
            Config("API_DELETE_ACTION") => "PatientAppointmentsDelete",
            Config("API_LIST_ACTION") => "PatientAppointmentsList",
            default => ""
        };
    }
    ...
    {
        global $Response;
        $listPage = "PatientAppointmentsList";
    ...
    {
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM patient_appointments";
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'patient_appointments');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'patient_appointments', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'patient_appointments', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'patient_appointments', $fldname, $key, $oldvalue);
            }
        }
    }

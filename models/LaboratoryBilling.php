...
/**
 * Table class for laboratory_billing
 */
class LaboratoryBilling extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "laboratory_billing";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "laboratory_billing";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("laboratorybillinglist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "laboratorybillingview" => $Language->phrase("View"),
            "laboratorybillingedit" => $Language->phrase("Edit"),
            "laboratorybillingadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "LaboratoryBillingView",
            Config("API_ADD_ACTION") => "LaboratoryBillingAdd",
            Config("API_EDIT_ACTION") => "LaboratoryBillingEdit",
            Config("API_DELETE_ACTION") => "LaboratoryBillingDelete",
            Config("API_LIST_ACTION") => "LaboratoryBillingList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("laboratorybillingview", $parm);
        } else {
            $url = $this->keyUrl("laboratorybillingview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "laboratorybillingadd?" . $parm;
        } else {
            $url = "laboratorybillingadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("laboratorybillingedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("laboratorybillinglist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("laboratorybillingadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("laboratorybillinglist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("laboratorybillingdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "LaboratoryBillingList";

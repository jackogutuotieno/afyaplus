 ...
 * Page class
 */
class IssueItemsView extends IssueItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IssueItemsView";
    ...
    // CSS class/style
    public $CurrentPageName = "issueitemsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "issueitemslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "issueitemslist"; // No matching record, return to list
                    }
                break;
        }

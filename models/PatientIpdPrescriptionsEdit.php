 ...
 * Page class
 */
class PatientIpdPrescriptionsEdit extends PatientIpdPrescriptions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdPrescriptionsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "patientipdprescriptionsedit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("patient_ipd_prescription_details", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("PatientIpdPrescriptionDetailsGrid");
            if (in_array("patient_ipd_prescription_details", $detailTblVar) && $detailPage->DetailEdit && $editRow) {

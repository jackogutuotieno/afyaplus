 ...
 * Page class
 */
class FullHaemogramReportEdit extends FullHaemogramReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FullHaemogramReportEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "fullhaemogramreportedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("fullhaemogramreportlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "fullhaemogramreportlist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "fullhaemogramreportlist") {
                            ...
                            $returnUrl = "fullhaemogramreportlist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function getEditRow($rsold)
    {
        ...
        // template
        $this->_template->setDbValueDef($rsnew, $this->_template->CurrentValue, $this->_template->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['template'])) { // template
            $this->_template->CurrentValue = $row['template'];
        }

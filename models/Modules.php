...
class Modules extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // module
        $this->module = new DbField(
            $this, // Table
            'x_module', // Variable name
            'module', // Name
            '`module`', // Expression
            '`module`', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`module`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->module->InputTextType = "text";
        $this->module->Nullable = false; // NOT NULL field
        $this->module->Required = true; // Required field
        $this->module->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'modules', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "modules";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("moduleslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "modulesview" => $Language->phrase("View"),
            "modulesedit" => $Language->phrase("Edit"),
            "modulesadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ModulesView",
            Config("API_ADD_ACTION") => "ModulesAdd",
            Config("API_EDIT_ACTION") => "ModulesEdit",
            Config("API_DELETE_ACTION") => "ModulesDelete",
            Config("API_LIST_ACTION") => "ModulesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("modulesview", $parm);
        } else {
            $url = $this->keyUrl("modulesview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("modulesedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("moduleslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("modulesadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("moduleslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("modulesdelete", $parm);
        }
    }

...
/**
 * Table class for lab_test_requests_details
 */
class LabTestRequestsDetails extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "lab_test_requests_details";
        $this->Dbid = 'DB';
        ...
        $this->specimen_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "lab_test_requests_details";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("labtestrequestsdetailslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "labtestrequestsdetailsview" => $Language->phrase("View"),
            "labtestrequestsdetailsedit" => $Language->phrase("Edit"),
            "labtestrequestsdetailsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "labtestrequestsdetailslist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "LabTestRequestsDetailsView",
            Config("API_ADD_ACTION") => "LabTestRequestsDetailsAdd",
            Config("API_EDIT_ACTION") => "LabTestRequestsDetailsEdit",
            Config("API_DELETE_ACTION") => "LabTestRequestsDetailsDelete",
            Config("API_LIST_ACTION") => "LabTestRequestsDetailsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("labtestrequestsdetailsview", $parm);
        } else {
            $url = $this->keyUrl("labtestrequestsdetailsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "labtestrequestsdetailsadd?" . $parm;
        } else {
            $url = "labtestrequestsdetailsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labtestrequestsdetailslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labtestrequestsdetailslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("labtestrequestsdetailsdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "LabTestRequestsDetailsList";
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->specimen_id->EditValue) != "" && is_numeric($this->specimen_id->EditValue)) {
            $this->specimen_id->EditValue = FormatNumber($this->specimen_id->EditValue, null);
        }

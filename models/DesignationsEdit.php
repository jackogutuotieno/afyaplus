 ...
 * Page class
 */
class DesignationsEdit extends Designations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DesignationsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "designationsedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("designationslist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "designationslist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "designationslist") {
                            ...
                            $returnUrl = "designationslist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['designation'])) { // designation
            $this->designation->CurrentValue = $row['designation'];
        }

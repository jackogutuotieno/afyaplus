 ...
 * Page class
 */
class PatientQueueDelete extends PatientQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientQueueDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "patientqueuedelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientqueuelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("patientqueuelist"); // Return to list
                return;
            }
        }

...
class UsersEdit extends Users
{
    ...
    protected function getEditRow($rsold)
    {
        ...
        // designation_id
        $this->designation_id->setDbValueDef($rsnew, $this->designation_id->CurrentValue, $this->designation_id->ReadOnly);
        ...
        // user_role_id
        $this->user_role_id->setDbValueDef($rsnew, $this->user_role_id->CurrentValue, $this->user_role_id->ReadOnly);

        // account_status
        $this->account_status->setDbValueDef($rsnew, $this->account_status->CurrentValue, $this->account_status->ReadOnly);
        ...
        // otp_code
        $this->otp_code->setDbValueDef($rsnew, $this->otp_code->CurrentValue, $this->otp_code->ReadOnly);

        // otp_date
        $this->otp_date->setDbValueDef($rsnew, UnFormatDateTime($this->otp_date->CurrentValue, $this->otp_date->formatPattern()), $this->otp_date->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['designation_id'])) { // designation_id
            $this->designation_id->CurrentValue = $row['designation_id'];
        }
        ...
        if (isset($row['user_role_id'])) { // user_role_id
            $this->user_role_id->CurrentValue = $row['user_role_id'];
        }
        if (isset($row['account_status'])) { // account_status
            $this->account_status->CurrentValue = $row['account_status'];
        }
        ...
        if (isset($row['otp_code'])) { // otp_code
            $this->otp_code->CurrentValue = $row['otp_code'];
        }
        if (isset($row['otp_date'])) { // otp_date
            $this->otp_date->CurrentValue = $row['otp_date'];
        }
    }

...
/**
 * Table class for opd_consultation
 */
class OpdConsultation extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "opd_consultation";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "opd_consultation";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("opdconsultationlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "opdconsultationview" => $Language->phrase("View"),
            "opdconsultationedit" => $Language->phrase("Edit"),
            "opdconsultationadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "OpdConsultationView",
            Config("API_ADD_ACTION") => "OpdConsultationAdd",
            Config("API_EDIT_ACTION") => "OpdConsultationEdit",
            Config("API_DELETE_ACTION") => "OpdConsultationDelete",
            Config("API_LIST_ACTION") => "OpdConsultationList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("opdconsultationview", $parm);
        } else {
            $url = $this->keyUrl("opdconsultationview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "opdconsultationadd?" . $parm;
        } else {
            $url = "opdconsultationadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdconsultationedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdconsultationlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdconsultationadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdconsultationlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("opdconsultationdelete", $parm);
        }
    }

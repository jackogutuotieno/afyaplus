 ...
 * Page class
 */
class PatientVaccinationsAdd extends PatientVaccinations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientVaccinationsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "patientvaccinationsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("patientvaccinationslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "patientvaccinationsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "patientvaccinationslist") {
                            ...
                            $returnUrl = "patientvaccinationslist"; // Return list page content
                        }
                    }

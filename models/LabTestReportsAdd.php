 ...
 * Page class
 */
class LabTestReportsAdd extends LabTestReports
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabTestReportsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "labtestreportsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "labtestreportsview") {
    ...
    public function renderRow()
    {
        ...
        $this->lab_test_requests_queue_id->RowCssClass = "row";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("diagnosis", $detailTblVar) && $detailPage->DetailAdd) {
            $detailPage->run();
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("DiagnosisGrid");
            if (in_array("diagnosis", $detailTblVar) && $detailPage->DetailAdd && $addRow) {
                $detailPage->lab_test_report_id->setSessionValue($this->id->CurrentValue); // Set master key
                $Security->loadCurrentUserLevel($this->ProjectID . "diagnosis"); // Load user level of detail table
                $addRow = $detailPage->gridInsert();
                $Security->loadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
                if (!$addRow) {
                $detailPage->lab_test_report_id->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }

...
/**
 * Table class for moh204b_report
 */
class Moh204bReport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "moh204b_report";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "moh204b_report";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("moh204breportlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "moh204breportview" => $Language->phrase("View"),
            "moh204breportedit" => $Language->phrase("Edit"),
            "moh204breportadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "Moh204bReportView",
            Config("API_ADD_ACTION") => "Moh204bReportAdd",
            Config("API_EDIT_ACTION") => "Moh204bReportEdit",
            Config("API_DELETE_ACTION") => "Moh204bReportDelete",
            Config("API_LIST_ACTION") => "Moh204bReportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("moh204breportview", $parm);
        } else {
            $url = $this->keyUrl("moh204breportview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "moh204breportadd?" . $parm;
        } else {
            $url = "moh204breportadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("moh204breportedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("moh204breportlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("moh204breportadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("moh204breportlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("moh204breportdelete", $parm);
        }
    }

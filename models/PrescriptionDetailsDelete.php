 ...
 * Page class
 */
class PrescriptionDetailsDelete extends PrescriptionDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrescriptionDetailsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "prescriptiondetailsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("prescriptiondetailslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("prescriptiondetailslist"); // Return to list
                return;
            }
        }

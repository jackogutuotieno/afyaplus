 ...
 * Page class
 */
class PatientIpdServicesView extends PatientIpdServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdServicesView";
    ...
    // CSS class/style
    public $CurrentPageName = "patientipdservicesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "patientipdserviceslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "patientipdserviceslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("patientipdserviceslist"), "", $this->TableVar, true);
        $pageId = "view";

...
/**
 * Table class for patient_ipd_prescription_details
 */
class PatientIpdPrescriptionDetails extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "patient_ipd_prescription_details";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->method->Lookup = new Lookup($this->method, 'patient_ipd_prescription_details', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->dose_type->Lookup = new Lookup($this->dose_type, 'patient_ipd_prescription_details', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->formulation->Lookup = new Lookup($this->formulation, 'patient_ipd_prescription_details', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->dose_interval->Lookup = new Lookup($this->dose_interval, 'patient_ipd_prescription_details', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getMasterFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "patient_ipd_prescriptions") {
            $masterTable = Container("patient_ipd_prescriptions");
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "patient_ipd_prescriptions":
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "patient_ipd_prescription_details";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("patientipdprescriptiondetailslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "patientipdprescriptiondetailsview" => $Language->phrase("View"),
            "patientipdprescriptiondetailsedit" => $Language->phrase("Edit"),
            "patientipdprescriptiondetailsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "patientipdprescriptiondetailslist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PatientIpdPrescriptionDetailsView",
            Config("API_ADD_ACTION") => "PatientIpdPrescriptionDetailsAdd",
            Config("API_EDIT_ACTION") => "PatientIpdPrescriptionDetailsEdit",
            Config("API_DELETE_ACTION") => "PatientIpdPrescriptionDetailsDelete",
            Config("API_LIST_ACTION") => "PatientIpdPrescriptionDetailsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("patientipdprescriptiondetailsview", $parm);
        } else {
            $url = $this->keyUrl("patientipdprescriptiondetailsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "patientipdprescriptiondetailsadd?" . $parm;
        } else {
            $url = "patientipdprescriptiondetailsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientipdprescriptiondetailsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientipdprescriptiondetailslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientipdprescriptiondetailsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientipdprescriptiondetailslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("patientipdprescriptiondetailsdelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "patient_ipd_prescriptions" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
    ...
    {
        global $Response;
        $listPage = "PatientIpdPrescriptionDetailsList";

...
/**
 * Table class for patient_ipd_prescriptions
 */
class PatientIpdPrescriptions extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "patient_ipd_prescriptions";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "patient_ipd_prescription_details") {
            $detailUrl = Container("patient_ipd_prescription_details")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "patientipdprescriptionslist";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "patient_ipd_prescriptions";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("patientipdprescriptionslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "patientipdprescriptionsview" => $Language->phrase("View"),
            "patientipdprescriptionsedit" => $Language->phrase("Edit"),
            "patientipdprescriptionsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "patientipdprescriptionslist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PatientIpdPrescriptionsView",
            Config("API_ADD_ACTION") => "PatientIpdPrescriptionsAdd",
            Config("API_EDIT_ACTION") => "PatientIpdPrescriptionsEdit",
            Config("API_DELETE_ACTION") => "PatientIpdPrescriptionsDelete",
            Config("API_LIST_ACTION") => "PatientIpdPrescriptionsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("patientipdprescriptionsview", $parm);
        } else {
            $url = $this->keyUrl("patientipdprescriptionsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "patientipdprescriptionsadd?" . $parm;
        } else {
            $url = "patientipdprescriptionsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("patientipdprescriptionsedit", $parm);
        } else {
            $url = $this->keyUrl("patientipdprescriptionsedit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientipdprescriptionslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("patientipdprescriptionsadd", $parm);
        } else {
            $url = $this->keyUrl("patientipdprescriptionsadd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientipdprescriptionslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("patientipdprescriptionsdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "PatientIpdPrescriptionsList";

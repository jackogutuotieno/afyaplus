 ...
 * Page class
 */
class PatientAdmissionsDelete extends PatientAdmissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientAdmissionsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "patientadmissionsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientadmissionslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("patientadmissionslist"); // Return to list
                return;
            }
        }

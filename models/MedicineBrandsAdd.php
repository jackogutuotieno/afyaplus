 ...
 * Page class
 */
class MedicineBrandsAdd extends MedicineBrands
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineBrandsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinebrandsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("medicinebrandslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "medicinebrandslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "medicinebrandsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "medicinebrandslist") {
                            ...
                            $returnUrl = "medicinebrandslist"; // Return list page content
                        }
                    }

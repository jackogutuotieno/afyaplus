 ...
 * Page class
 */
class PatientIpdVitalsAdd extends PatientIpdVitals
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdVitalsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "patientipdvitalsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "patientipdvitalsview") {

 ...
 * Page class
 */
class LabTestRequestsQueueList extends LabTestRequestsQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabTestRequestsQueueList";
    ...
    public $FormName = "flab_test_requests_queuelist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "labtestrequestsqueuelist";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'lab_test_requests_queue';
        $this->TableName = 'lab_test_requests_queue';
        ...
        // Table object (lab_test_requests_queue)
        if (!isset($GLOBALS["lab_test_requests_queue"]) || $GLOBALS["lab_test_requests_queue"]::class == PROJECT_NAMESPACE . "lab_test_requests_queue") {
            $GLOBALS["lab_test_requests_queue"] = &$this;
        }
        ...
        $this->MultiDeleteUrl = "labtestrequestsqueuedelete";
        $this->MultiUpdateUrl = "labtestrequestsqueueupdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'lab_test_requests_queue');
        }
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if (!SameString($pageName, GetPageName($this->getListUrl()))) { // Not List page
                    ...
                    $result["view"] = SameString($pageName, "labtestrequestsqueueview"); // If View page, no primary button
                } else { // List page
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "flab_test_requests_queuegrid";
        }
        ...
        if ($Security->currentUserID() != "" && !$Security->isAdmin()) { // Non system admin
            if ($this->getCurrentMasterTable() == "lab_test_requests_details") {
                $this->DbMasterFilter = $this->addMasterUserIDFilter($this->DbMasterFilter, "lab_test_requests_details"); // Add master User ID filter
            }
        }
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->lab_test_requests_detail_id->AdvancedSearch->toJson(), ","); // Field lab_test_requests_detail_id
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("flab_test_requests_queuesrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field lab_test_requests_detail_id
        $this->lab_test_requests_detail_id->AdvancedSearch->SearchValue = @$filter["x_lab_test_requests_detail_id"];
        $this->lab_test_requests_detail_id->AdvancedSearch->SearchOperator = @$filter["z_lab_test_requests_detail_id"];
        $this->lab_test_requests_detail_id->AdvancedSearch->SearchCondition = @$filter["v_lab_test_requests_detail_id"];
        $this->lab_test_requests_detail_id->AdvancedSearch->SearchValue2 = @$filter["y_lab_test_requests_detail_id"];
        $this->lab_test_requests_detail_id->AdvancedSearch->SearchOperator2 = @$filter["w_lab_test_requests_detail_id"];
        $this->lab_test_requests_detail_id->AdvancedSearch->save();
        ...
        // Field waiting_time
        $this->waiting_time->AdvancedSearch->SearchValue = @$filter["x_waiting_time"];
        $this->waiting_time->AdvancedSearch->SearchOperator = @$filter["z_waiting_time"];
        $this->waiting_time->AdvancedSearch->SearchCondition = @$filter["v_waiting_time"];
        $this->waiting_time->AdvancedSearch->SearchValue2 = @$filter["y_waiting_time"];
        $this->waiting_time->AdvancedSearch->SearchOperator2 = @$filter["w_waiting_time"];
        $this->waiting_time->AdvancedSearch->save();

        // Field waiting_interval
        $this->waiting_interval->AdvancedSearch->SearchValue = @$filter["x_waiting_interval"];
        $this->waiting_interval->AdvancedSearch->SearchOperator = @$filter["z_waiting_interval"];
        $this->waiting_interval->AdvancedSearch->SearchCondition = @$filter["v_waiting_interval"];
        $this->waiting_interval->AdvancedSearch->SearchValue2 = @$filter["y_waiting_interval"];
        $this->waiting_interval->AdvancedSearch->SearchOperator2 = @$filter["w_waiting_interval"];
        $this->waiting_interval->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->waiting_interval;
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->id->setSort("");
                $this->lab_test_requests_detail_id->setSort("");
                $this->time->setSort("");
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView() && $this->showOptionLink("view")) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"lab_test_requests_queue\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit() && $this->showOptionLink("edit")) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"lab_test_requests_queue\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"flab_test_requests_queuelist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"flab_test_requests_queuelist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"lab_test_requests_queue\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"flab_test_requests_queuesrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"flab_test_requests_queuesrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="flab_test_requests_queuelist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_lab_test_requests_queue", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_lab_test_requests_queue",
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"flab_test_requests_queuesrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    */
    ...
    public function pageLoad()
    {
        ...
        $Language->setPhrase("addlink", "queue test");
    }

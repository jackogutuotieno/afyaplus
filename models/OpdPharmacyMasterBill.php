...
/**
 * Table class for opd_pharmacy_master_bill
 */
class OpdPharmacyMasterBill extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "opd_pharmacy_master_bill";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->line_total = new DbField(
            ...
            'line_total', // Name
            'quantity * selling_price_per_unit', // Expression
            'quantity * selling_price_per_unit', // Basic search expression
            5, // Type
            23, // Size
            -1, // Date/Time format
            false, // Is upload field
            'quantity * selling_price_per_unit', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "opd_pharmacy_master_bill";
    }
    ...
    {
        return "*, quantity * selling_price_per_unit AS `line_total`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("opdpharmacymasterbilllist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "opdpharmacymasterbillview" => $Language->phrase("View"),
            "opdpharmacymasterbilledit" => $Language->phrase("Edit"),
            "opdpharmacymasterbilladd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "opdpharmacymasterbilllist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "OpdPharmacyMasterBillView",
            Config("API_ADD_ACTION") => "OpdPharmacyMasterBillAdd",
            Config("API_EDIT_ACTION") => "OpdPharmacyMasterBillEdit",
            Config("API_DELETE_ACTION") => "OpdPharmacyMasterBillDelete",
            Config("API_LIST_ACTION") => "OpdPharmacyMasterBillList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("opdpharmacymasterbillview", $parm);
        } else {
            $url = $this->keyUrl("opdpharmacymasterbillview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "opdpharmacymasterbilladd?" . $parm;
        } else {
            $url = "opdpharmacymasterbilladd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdpharmacymasterbilledit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdpharmacymasterbilllist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdpharmacymasterbilladd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdpharmacymasterbilllist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("opdpharmacymasterbilldelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "OpdPharmacyMasterBillList";

 ...
 * Page class
 */
class MedicineIpdDispensationDetailsEdit extends MedicineIpdDispensationDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineIpdDispensationDetailsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "medicineipddispensationdetailsedit";

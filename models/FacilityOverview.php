 ...
 * Page class
 */
class FacilityOverview extends ReportTable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FacilityOverview";
    ...
    public $CurrentPageName = "facilityoverview";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'Facility_Overview';
        $this->TableName = 'Facility Overview';
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Facility Overview');
        }

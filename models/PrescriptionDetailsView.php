 ...
 * Page class
 */
class PrescriptionDetailsView extends PrescriptionDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrescriptionDetailsView";
    ...
    // CSS class/style
    public $CurrentPageName = "prescriptiondetailsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "prescriptiondetailslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "prescriptiondetailslist"; // No matching record, return to list
                    }
                break;
        }

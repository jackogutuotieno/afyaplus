...
/**
 * Table class for Patients Appointments
 */
class PatientsAppointments extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->id->SourceTableVar = 'patient_appointments';
        ...
        $this->_title->SourceTableVar = 'patient_appointments';
        ...
        $this->description->SourceTableVar = 'patient_appointments';
        $this->Fields['description'] = &$this->description;

        // doctor_id
        $this->doctor_id = new ReportField(
            $this, // Table
        ...
        $this->start_date->SourceTableVar = 'patient_appointments';
        ...
        $this->date_created->SourceTableVar = 'patient_appointments';
        ...
        $this->is_all_day->Lookup = new Lookup($this->is_all_day, 'Patients_Appointments', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "patient_appointments";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("patientsappointmentslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "patientsappointmentsview" => $Language->phrase("View"),
            "patientsappointmentsedit" => $Language->phrase("Edit"),
            "patientsappointmentsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "PatientsAppointmentsCalendar";
    }
    ...
    {
        return "patientsappointmentslist";
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("patientsappointmentsview", $parm);
        } else {
            $url = $this->keyUrl("patientsappointmentsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "patientsappointmentsadd?" . $parm;
        } else {
            $url = "patientsappointmentsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientsappointmentsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientsappointmentslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientsappointmentsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("patientsappointmentslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("patientsappointmentsdelete", $parm);
        }
    }

 ...
 * Page class
 */
class RadiologyReportSummary extends RadiologyReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyReportSummary";
    ...
    public $CurrentPageName = "radiologyreport";
    ...
    public function __construct()
    {
        ...
        // Table object (Radiology_Report)
        if (!isset($GLOBALS["Radiology_Report"]) || $GLOBALS["Radiology_Report"]::class == PROJECT_NAMESPACE . "Radiology_Report") {
            $GLOBALS["Radiology_Report"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Radiology Report');
        }
    ...
    public function loadRowValues($record)
    {
        $data = [];
        $data["id"] = $record['id'];
        $data["patient_name_radiology"] = $record['patient_name_radiology'];
        ...
        $data["radiology_month"] = $record['radiology_month'];
        $this->Rows[] = $data;
        $this->id->setDbValue($record['id']);
        $this->patient_name_radiology->setDbValue($record['patient_name_radiology']);
        ...
        $this->subcategory->setDbValue($record['subcategory']);
        ...
        $this->radiology_month->setDbValue($record['radiology_month']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::SEARCH) {
            ...
            $this->patient_name_radiology->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->subcategory->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->radiology_month->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == RowType::TOTAL) { // Summary row
            ...
            // patient_name_radiology
            $currentValue = $this->patient_name_radiology->CurrentValue;
            $viewValue = &$this->patient_name_radiology->ViewValue;
            $viewAttrs = &$this->patient_name_radiology->ViewAttrs;
            $cellAttrs = &$this->patient_name_radiology->CellAttrs;
            $hrefValue = &$this->patient_name_radiology->HrefValue;
            $linkAttrs = &$this->patient_name_radiology->LinkAttrs;
            $this->cellRendered($this->patient_name_radiology, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            // subcategory
            $currentValue = $this->subcategory->CurrentValue;
            $viewValue = &$this->subcategory->ViewValue;
            $viewAttrs = &$this->subcategory->ViewAttrs;
            $cellAttrs = &$this->subcategory->CellAttrs;
            $hrefValue = &$this->subcategory->HrefValue;
            $linkAttrs = &$this->subcategory->LinkAttrs;
            $this->cellRendered($this->subcategory, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            // radiology_month
            $currentValue = $this->radiology_month->CurrentValue;
            $viewValue = &$this->radiology_month->ViewValue;
            $viewAttrs = &$this->radiology_month->ViewAttrs;
            $cellAttrs = &$this->radiology_month->CellAttrs;
            $hrefValue = &$this->radiology_month->HrefValue;
            $linkAttrs = &$this->radiology_month->LinkAttrs;
            $this->cellRendered($this->radiology_month, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->patient_name_radiology->Visible) {
            $this->DetailColumnCount += 1;
        }
        ...
        if ($this->radiology_month->Visible) {
            $this->DetailColumnCount += 1;
        }
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fRadiology_Reportsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fRadiology_Reportsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fRadiology_Reportsrch");
        }
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fRadiology_Reportsrch", $filters);

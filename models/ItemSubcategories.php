...
/**
 * Table class for item_subcategories
 */
class ItemSubcategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "item_subcategories";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->category_id->Lookup = new Lookup($this->category_id, 'item_categories', false, 'id', ["category_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "`category_name`");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "item_subcategories";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("itemsubcategorieslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "itemsubcategoriesview" => $Language->phrase("View"),
            "itemsubcategoriesedit" => $Language->phrase("Edit"),
            "itemsubcategoriesadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ItemSubcategoriesView",
            Config("API_ADD_ACTION") => "ItemSubcategoriesAdd",
            Config("API_EDIT_ACTION") => "ItemSubcategoriesEdit",
            Config("API_DELETE_ACTION") => "ItemSubcategoriesDelete",
            Config("API_LIST_ACTION") => "ItemSubcategoriesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("itemsubcategoriesview", $parm);
        } else {
            $url = $this->keyUrl("itemsubcategoriesview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "itemsubcategoriesadd?" . $parm;
        } else {
            $url = "itemsubcategoriesadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("itemsubcategoriesedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("itemsubcategorieslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("itemsubcategoriesadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("itemsubcategorieslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("itemsubcategoriesdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ItemSubcategoriesList";
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'item_subcategories');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'item_subcategories', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'item_subcategories', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'item_subcategories', $fldname, $key, $oldvalue);
            }
        }
    }

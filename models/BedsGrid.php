...
class BedsGrid extends Beds
{
    ...
    public $FormName = "fbedsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "bedsgrid";
    ...
    {
        $this->bed_charges->FormValue = ""; // Clear form value
    ...
    public function emptyRow()
    {
        ...
        if (
            ...
            $this->ward_id->CurrentValue != $this->ward_id->DefaultValue &&
            !($this->ward_id->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->ward_id->CurrentValue == $this->ward_id->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_bed_name") &&
            $CurrentForm->hasValue("o_bed_name") &&
            $this->bed_name->CurrentValue != $this->bed_name->DefaultValue &&
            !($this->bed_name->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->bed_name->CurrentValue == $this->bed_name->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_bed_charges") &&
            $CurrentForm->hasValue("o_bed_charges") &&
            $this->bed_charges->CurrentValue != $this->bed_charges->DefaultValue &&
            !($this->bed_charges->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->bed_charges->CurrentValue == $this->bed_charges->getSessionValue())
        ) {
            return false;
        }
        return true;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_ward_id")) {
            $this->ward_id->setOldValue($CurrentForm->getValue("o_ward_id"));
        }
        ...
        if ($CurrentForm->hasValue("o_bed_name")) {
            $this->bed_name->setOldValue($CurrentForm->getValue("o_bed_name"));
        }
        ...
        if ($CurrentForm->hasValue("o_bed_charges")) {
            $this->bed_charges->setOldValue($CurrentForm->getValue("o_bed_charges"));
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->ward_id->getSessionValue() != "") {
                ...
                $this->ward_id->OldValue = $this->ward_id->CurrentValue;
                $curVal = strval($this->ward_id->CurrentValue);
                if ($curVal != "") {
                    $this->ward_id->ViewValue = $this->ward_id->lookupCacheOption($curVal);
                    if ($this->ward_id->ViewValue === null) { // Lookup from database
    ...
    protected function getEditRow($rsold)
    {
        ...
        // bed_name
        $this->bed_name->setDbValueDef($rsnew, $this->bed_name->CurrentValue, $this->bed_name->ReadOnly);

        // bed_charges
        $this->bed_charges->setDbValueDef($rsnew, $this->bed_charges->CurrentValue, $this->bed_charges->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['bed_name'])) { // bed_name
            $this->bed_name->CurrentValue = $row['bed_name'];
        }
        if (isset($row['bed_charges'])) { // bed_charges
            $this->bed_charges->CurrentValue = $row['bed_charges'];
        }
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "wards") {
            $this->ward_id->Visible = true; // Need to insert foreign key
            $this->ward_id->CurrentValue = $this->ward_id->getSessionValue();
        }

 ...
 * Page class
 */
class MedicineIpdDispensationGrid extends MedicineIpdDispensation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineIpdDispensationGrid";
    ...
    public $FormName = "fmedicine_ipd_dispensationgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "medicineipddispensationgrid";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "medicineipddispensationadd";

 ...
 * Page class
 */
class WardsDelete extends Wards
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WardsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "wardsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("wardslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("wardslist"); // Return to list
                return;
            }
        }

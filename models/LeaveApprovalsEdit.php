 ...
 * Page class
 */
class LeaveApprovalsEdit extends LeaveApprovals
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LeaveApprovalsEdit";
    ...
    public function setVisibility()
    {
        ...
        $this->days_applied->Visible = false;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("leaveapprovalslist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "leaveapprovalslist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "leaveapprovalslist") {
                            ...
                            $returnUrl = "leaveapprovalslist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("leaveapprovalslist"), "", $this->TableVar, true);
        $pageId = "edit";

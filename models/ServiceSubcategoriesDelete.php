 ...
 * Page class
 */
class ServiceSubcategoriesDelete extends ServiceSubcategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServiceSubcategoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "servicesubcategoriesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("servicesubcategorieslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("servicesubcategorieslist"); // Return to list
            return;
        }

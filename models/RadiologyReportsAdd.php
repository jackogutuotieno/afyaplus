 ...
 * Page class
 */
class RadiologyReportsAdd extends RadiologyReports
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyReportsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "radiologyreportsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "radiologyreportsview") {

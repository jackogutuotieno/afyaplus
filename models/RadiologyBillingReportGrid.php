 ...
 * Page class
 */
class RadiologyBillingReportGrid extends RadiologyBillingReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyBillingReportGrid";
    ...
    public $FormName = "fradiology_billing_reportgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "radiologybillingreportgrid";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "radiologybillingreportadd";

...
/**
 * Table class for branding
 */
class Branding extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "branding";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("brandinglist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "brandingview" => $Language->phrase("View"),
            "brandingedit" => $Language->phrase("Edit"),
            "brandingadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "BrandingView",
            Config("API_ADD_ACTION") => "BrandingAdd",
            Config("API_EDIT_ACTION") => "BrandingEdit",
            Config("API_DELETE_ACTION") => "BrandingDelete",
            Config("API_LIST_ACTION") => "BrandingList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("brandingview", $parm);
        } else {
            $url = $this->keyUrl("brandingview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("brandingedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("brandinglist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("brandingadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("brandinglist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("brandingdelete", $parm);
        }
    }

...
class ServiceCategoriesList extends ServiceCategories
{
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fservice_categoriessrch");
        }

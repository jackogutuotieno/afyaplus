 ...
 * Page class
 */
class PatientsDependantsAdd extends PatientsDependants
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientsDependantsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "patientsdependantsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("patientsdependantslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "patientsdependantslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "patientsdependantsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "patientsdependantslist") {
                            ...
                            $returnUrl = "patientsdependantslist"; // Return list page content
                        }
                    }
    ...
    public function renderRow()
    {
        ...
        // relationship
        $this->relationship->RowCssClass = "row";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("patientsdependantslist"), "", $this->TableVar, true);

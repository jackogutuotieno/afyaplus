 ...
 * Page class
 */
class LabTestRequestsDetailsDelete extends LabTestRequestsDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabTestRequestsDetailsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "labtestrequestsdetailsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("labtestrequestsdetailslist"); // Prevent SQL injection, return to list
            return;
        }

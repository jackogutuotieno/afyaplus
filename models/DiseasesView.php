 ...
 * Page class
 */
class DiseasesView extends Diseases
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DiseasesView";
    ...
    // CSS class/style
    public $CurrentPageName = "diseasesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "diseaseslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "diseaseslist"; // No matching record, return to list
                    }
                break;
        }

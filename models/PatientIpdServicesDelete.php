 ...
 * Page class
 */
class PatientIpdServicesDelete extends PatientIpdServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdServicesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientipdserviceslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("patientipdserviceslist"); // Return to list
                return;
            }
        }

 ...
 * Page class
 */
class PatientsDependantsGrid extends PatientsDependants
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientsDependantsGrid";
    ...
    public $FormName = "fpatients_dependantsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "patientsdependantsgrid";
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_relationship") &&
            $CurrentForm->hasValue("o_relationship") &&
            $this->relationship->CurrentValue != $this->relationship->DefaultValue &&
            !($this->relationship->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->relationship->CurrentValue == $this->relationship->getSessionValue())
        ) {
            return false;
        }
        if (
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_relationship")) {
            $this->relationship->setOldValue($CurrentForm->getValue("o_relationship"));
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // relationship
            $this->relationship->setupEditAttributes();
            $this->relationship->EditValue = $this->relationship->options(true);
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->relationship->Visible && $this->relationship->Required) {
    ...
    protected function getEditRow($rsold)
    {
        ...
        // relationship
        $this->relationship->setDbValueDef($rsnew, $this->relationship->CurrentValue, $this->relationship->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['relationship'])) { // relationship
            $this->relationship->CurrentValue = $row['relationship'];
        }
    ...
    protected function getAddRow()
    {
        ...
        // relationship
        $this->relationship->setDbValueDef($rsnew, $this->relationship->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['relationship'])) { // relationship
            $this->relationship->setFormValue($row['relationship']);
        }
        if (isset($row['date_created'])) { // date_created

 ...
 * Page class
 */
class WardTypeView extends WardType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WardTypeView";
    ...
    // CSS class/style
    public $CurrentPageName = "wardtypeview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "wardtypelist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "wardtypelist"; // No matching record, return to list
                    }
                break;
        }

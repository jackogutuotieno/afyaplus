 ...
 * Page class
 */
class VitalsReportSummary extends VitalsReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VitalsReportSummary";
    ...
    public $CurrentPageName = "vitalsreport";
    ...
    public function __construct()
    {
        ...
        // Table object (Vitals_Report)
        if (!isset($GLOBALS["Vitals_Report"]) || $GLOBALS["Vitals_Report"]::class == PROJECT_NAMESPACE . "Vitals_Report") {
            $GLOBALS["Vitals_Report"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Vitals Report');
        }
    ...
    public function loadRowValues($record)
    {
        ...
        $this->pulse->setDbValue($record['pulse']);
        $this->blood_pressure->setDbValue($record['blood_pressure']);
        $this->nurse->setDbValue($record['nurse']);
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::SEARCH) { // Search row
            ...
            $this->height->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // weight
            $this->weight->ViewValue = $this->weight->CurrentValue;
            $this->weight->ViewValue = FormatNumber($this->weight->ViewValue, $this->weight->formatPattern());
            $this->weight->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->temperature->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->pulse->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // blood_pressure
            $this->blood_pressure->ViewValue = $this->blood_pressure->CurrentValue;
            $this->blood_pressure->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // nurse
            $this->nurse->ViewValue = $this->nurse->CurrentValue;
            $this->nurse->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == RowType::TOTAL) { // Summary row
            ...
            $this->cellRendered($this->height, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            $this->cellRendered($this->weight, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            $this->cellRendered($this->temperature, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            $this->cellRendered($this->pulse, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // blood_pressure
            $currentValue = $this->blood_pressure->CurrentValue;
            $viewValue = &$this->blood_pressure->ViewValue;
            $viewAttrs = &$this->blood_pressure->ViewAttrs;
            $cellAttrs = &$this->blood_pressure->CellAttrs;
            $hrefValue = &$this->blood_pressure->HrefValue;
            $linkAttrs = &$this->blood_pressure->LinkAttrs;
            $this->cellRendered($this->blood_pressure, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // nurse
            $currentValue = $this->nurse->CurrentValue;
            $viewValue = &$this->nurse->ViewValue;
            $viewAttrs = &$this->nurse->ViewAttrs;
            $cellAttrs = &$this->nurse->CellAttrs;
            $hrefValue = &$this->nurse->HrefValue;
            $linkAttrs = &$this->nurse->LinkAttrs;
            $this->cellRendered($this->nurse, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->weight->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->temperature->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->pulse->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->blood_pressure->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->nurse->Visible) {
            $this->DetailColumnCount += 1;
        }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fVitals_Reportsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fVitals_Reportsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;

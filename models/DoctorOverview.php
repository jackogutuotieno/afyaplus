 ...
 * Page class
 */
class DoctorOverview extends ReportTable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DoctorOverview";
    ...
    public $CurrentPageName = "doctoroverview";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'Doctor_Overview';
        $this->TableName = 'Doctor Overview';
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Doctor Overview');
        }

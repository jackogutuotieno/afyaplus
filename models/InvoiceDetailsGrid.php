 ...
 * Page class
 */
class InvoiceDetailsGrid extends InvoiceDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvoiceDetailsGrid";
    ...
    public $FormName = "finvoice_detailsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "invoicedetailsgrid";

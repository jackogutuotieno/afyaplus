 ...
 * Page class
 */
class Moh204bReportList extends Moh204bReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Moh204bReportList";
    ...
    public $FormName = "fmoh204b_reportlist";
    ...
    public function setVisibility()
    {
        ...
        $this->patient_name_moh204a->setVisibility();
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'moh204b_report';
        $this->TableName = 'moh204b_report';
        ...
        // Table object (moh204b_report)
        if (!isset($GLOBALS["moh204b_report"]) || $GLOBALS["moh204b_report"]::class == PROJECT_NAMESPACE . "moh204b_report") {
            $GLOBALS["moh204b_report"] = &$this;
        }
        ...
        // Initialize URLs
        $this->AddUrl = "moh204breportadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "moh204breportdelete";
        $this->MultiUpdateUrl = "moh204breportupdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'moh204b_report');
        }
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if (!SameString($pageName, GetPageName($this->getListUrl()))) { // Not List page
                    ...
                    $result["view"] = SameString($pageName, "moh204breportview"); // If View page, no primary button
                } else { // List page
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fmoh204b_reportgrid";
        }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fmoh204b_reportsrch");
        }
        $filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
        $filterList = Concat($filterList, $this->patient_name_moh204a->AdvancedSearch->toJson(), ","); // Field patient_name_moh204a
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fmoh204b_reportsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field patient_name_moh204a
        $this->patient_name_moh204a->AdvancedSearch->SearchValue = @$filter["x_patient_name_moh204a"];
        $this->patient_name_moh204a->AdvancedSearch->SearchOperator = @$filter["z_patient_name_moh204a"];
        $this->patient_name_moh204a->AdvancedSearch->SearchCondition = @$filter["v_patient_name_moh204a"];
        $this->patient_name_moh204a->AdvancedSearch->SearchValue2 = @$filter["y_patient_name_moh204a"];
        $this->patient_name_moh204a->AdvancedSearch->SearchOperator2 = @$filter["w_patient_name_moh204a"];
        $this->patient_name_moh204a->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->patient_name_moh204a;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->patient_name_moh204a); // patient_name_moh204a
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->id->setSort("");
                $this->patient_name_moh204a->setSort("");
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fmoh204b_reportlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fmoh204b_reportlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "patient_name_moh204a");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fmoh204b_reportsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmoh204b_reportsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fmoh204b_reportlist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_moh204b_report", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_moh204b_report",
    ...
    protected function newRow()
    {
        ...
        $row['patient_name_moh204a'] = $this->patient_name_moh204a->DefaultValue;
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fmoh204b_reportsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;

 ...
 * Page class
 */
class RadiologyRequestsEdit extends RadiologyRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyRequestsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "radiologyrequestsedit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("radiology_requests_details", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("RadiologyRequestsDetailsGrid");
            if (in_array("radiology_requests_details", $detailTblVar) && $detailPage->DetailEdit && $editRow) {

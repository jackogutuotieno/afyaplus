 ...
 * Page class
 */
class MedicineDispensationDetailsAdd extends MedicineDispensationDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineDispensationDetailsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinedispensationdetailsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("medicinedispensationdetailslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "medicinedispensationdetailsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "medicinedispensationdetailslist") {
                            ...
                            $returnUrl = "medicinedispensationdetailslist"; // Return list page content
                        }
                    }

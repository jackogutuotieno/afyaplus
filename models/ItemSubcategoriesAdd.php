 ...
 * Page class
 */
class ItemSubcategoriesAdd extends ItemSubcategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemSubcategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "itemsubcategoriesadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("itemsubcategorieslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "itemsubcategorieslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "itemsubcategoriesview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "itemsubcategorieslist") {
                            ...
                            $returnUrl = "itemsubcategorieslist"; // Return list page content
                        }
                    }

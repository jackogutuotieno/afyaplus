 ...
 * Page class
 */
class IpdBillMedicinesGrid extends IpdBillMedicines
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IpdBillMedicinesGrid";
    ...
    public $FormName = "fipd_bill_medicinesgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ipdbillmedicinesgrid";

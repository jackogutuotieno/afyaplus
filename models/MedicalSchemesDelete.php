 ...
 * Page class
 */
class MedicalSchemesDelete extends MedicalSchemes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicalSchemesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "medicalschemesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("medicalschemeslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("medicalschemeslist"); // Return to list
                return;
            }
        }

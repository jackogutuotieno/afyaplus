...
/**
 * Table class for medicine_ipd_dispensation
 */
class MedicineIpdDispensation extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "medicine_ipd_dispensation";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->status->Lookup = new Lookup($this->status, 'medicine_ipd_dispensation', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "medicine_ipd_dispensation_details") {
            $detailUrl = Container("medicine_ipd_dispensation_details")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "medicineipddispensationlist";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "medicine_ipd_dispensation";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("medicineipddispensationlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "medicineipddispensationview" => $Language->phrase("View"),
            "medicineipddispensationedit" => $Language->phrase("Edit"),
            "medicineipddispensationadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "medicineipddispensationlist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MedicineIpdDispensationView",
            Config("API_ADD_ACTION") => "MedicineIpdDispensationAdd",
            Config("API_EDIT_ACTION") => "MedicineIpdDispensationEdit",
            Config("API_DELETE_ACTION") => "MedicineIpdDispensationDelete",
            Config("API_LIST_ACTION") => "MedicineIpdDispensationList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("medicineipddispensationview", $parm);
        } else {
            $url = $this->keyUrl("medicineipddispensationview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "medicineipddispensationadd?" . $parm;
        } else {
            $url = "medicineipddispensationadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("medicineipddispensationedit", $parm);
        } else {
            $url = $this->keyUrl("medicineipddispensationedit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicineipddispensationlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("medicineipddispensationadd", $parm);
        } else {
            $url = $this->keyUrl("medicineipddispensationadd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicineipddispensationlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("medicineipddispensationdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "MedicineIpdDispensationList";

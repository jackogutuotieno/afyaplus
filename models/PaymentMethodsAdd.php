 ...
 * Page class
 */
class PaymentMethodsAdd extends PaymentMethods
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PaymentMethodsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "paymentmethodsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("paymentmethodslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "paymentmethodslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "paymentmethodsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "paymentmethodslist") {
                            ...
                            $returnUrl = "paymentmethodslist"; // Return list page content
                        }
                    }
    ...
    {
        if (isset($row['payment_method'])) { // payment_method
            $this->payment_method->setFormValue($row['payment_method']);
        }

 ...
 * Page class
 */
class ItemSubcategoriesView extends ItemSubcategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemSubcategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "itemsubcategoriesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "itemsubcategorieslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "itemsubcategorieslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("itemsubcategorieslist"), "", $this->TableVar, true);
        $pageId = "view";

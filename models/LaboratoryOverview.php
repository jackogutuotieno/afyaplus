 ...
 * Page class
 */
class LaboratoryOverview extends ReportTable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LaboratoryOverview";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'Laboratory_Overview';
        $this->TableName = 'Laboratory Overview';
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Laboratory Overview');
        }

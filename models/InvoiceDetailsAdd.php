 ...
 * Page class
 */
class InvoiceDetailsAdd extends InvoiceDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvoiceDetailsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "invoicedetailsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "invoicedetailsview") {

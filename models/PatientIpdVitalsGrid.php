 ...
 * Page class
 */
class PatientIpdVitalsGrid extends PatientIpdVitals
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdVitalsGrid";
    ...
    public $FormName = "fpatient_ipd_vitalsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "patientipdvitalsgrid";

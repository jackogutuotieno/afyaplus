 ...
 * Page class
 */
class EmployeesReportSummary extends EmployeesReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeesReportSummary";
    ...
    public $CurrentPageName = "employeesreport";
    ...
    public function __construct()
    {
        ...
        // Table object (Employees_Report)
        if (!isset($GLOBALS["Employees_Report"]) || $GLOBALS["Employees_Report"]::class == PROJECT_NAMESPACE . "Employees_Report") {
            $GLOBALS["Employees_Report"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Employees Report');
        }
    ...
    public function loadRowValues($record)
    {
        ...
        $data["department_name"] = $record['department_name'];
        ...
        $this->department_name->setDbValue($record['department_name']);
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::SEARCH) {
            ...
            $this->employee_name->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // national_id
            $this->national_id->ViewValue = $this->national_id->CurrentValue;
            $this->national_id->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->department_name->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // designation
            $this->designation->ViewValue = $this->designation->CurrentValue;
            $this->designation->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == RowType::TOTAL) { // Summary row
            ...
            // national_id
            $currentValue = $this->national_id->CurrentValue;
            $viewValue = &$this->national_id->ViewValue;
            $viewAttrs = &$this->national_id->ViewAttrs;
            $cellAttrs = &$this->national_id->CellAttrs;
            $hrefValue = &$this->national_id->HrefValue;
            $linkAttrs = &$this->national_id->LinkAttrs;
            $this->cellRendered($this->national_id, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            // department_name
            $currentValue = $this->department_name->CurrentValue;
            $viewValue = &$this->department_name->ViewValue;
            $viewAttrs = &$this->department_name->ViewAttrs;
            $cellAttrs = &$this->department_name->CellAttrs;
            $hrefValue = &$this->department_name->HrefValue;
            $linkAttrs = &$this->department_name->LinkAttrs;
            $this->cellRendered($this->department_name, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            $this->cellRendered($this->designation, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->department_name->Visible) {
            $this->DetailColumnCount += 1;
        }
    ...
    {
        return $this->employee_name->Visible || $this->gender->Visible || $this->department_name->Visible || $this->designation->Visible;
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fEmployees_Reportsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fEmployees_Reportsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    protected function getExtendedFilter()
    {
        ...
        if (Get("cmd") == "reset") {
            ...
            // Field employee_name
            $this->getDropDownValue($this->employee_name);

            // Field gender
            $this->getDropDownValue($this->gender);

            // Field department_name
            $this->getDropDownValue($this->department_name);

            // Field designation
            $this->getDropDownValue($this->designation);
        ...
        if ($restoreSession) {
            $restoreDefault = true;
            if ($this->employee_name->AdvancedSearch->issetSession()) { // Field employee_name
            ...
            if ($this->department_name->AdvancedSearch->issetSession()) { // Field department_name
                $this->department_name->AdvancedSearch->load();
                $restoreDefault = false;
            }
            if ($this->designation->AdvancedSearch->issetSession()) { // Field designation
        ...
        $this->buildDropDownFilter($this->employee_name, $filter, false, true); // Field employee_name
        $this->employee_name->AdvancedSearch->save();
        $this->buildDropDownFilter($this->gender, $filter, false, true); // Field gender
        $this->gender->AdvancedSearch->save();
        $this->buildDropDownFilter($this->department_name, $filter, false, true); // Field department_name
        $this->department_name->AdvancedSearch->save();
        $this->buildDropDownFilter($this->designation, $filter, false, true); // Field designation
    ...
    {
        // Field employee_name
        $this->employee_name->AdvancedSearch->loadDefault();

        // Field gender
        $this->gender->AdvancedSearch->loadDefault();

        // Field department_name
        $this->department_name->AdvancedSearch->loadDefault();

        // Field designation
        $this->designation->AdvancedSearch->loadDefault();
    }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fEmployees_Reportsrch");
        }
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fEmployees_Reportsrch", $filters);

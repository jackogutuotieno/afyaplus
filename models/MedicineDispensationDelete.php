 ...
 * Page class
 */
class MedicineDispensationDelete extends MedicineDispensation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineDispensationDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinedispensationdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("medicinedispensationlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("medicinedispensationlist"); // Return to list
            return;
        }

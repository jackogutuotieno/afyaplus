 ...
 * Page class
 */
class PatientQueueView extends PatientQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientQueueView";
    ...
    // CSS class/style
    public $CurrentPageName = "patientqueueview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "patientqueuelist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "patientqueuelist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("patientqueuelist"), "", $this->TableVar, true);
        $pageId = "view";

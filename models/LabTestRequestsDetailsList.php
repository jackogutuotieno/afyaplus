...
class LabTestRequestsDetailsList extends LabTestRequestsDetails
{
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'lab_test_reports') && $this->showOptionLink()) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail" . ($this->ListOptions->UseDropDownButton ? " dropdown-toggle" : "") . "\" data-action=\"list\" href=\"" . HtmlEncode("labtestreportslist?" . Config("TABLE_SHOW_MASTER") . "=lab_test_requests_details&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";

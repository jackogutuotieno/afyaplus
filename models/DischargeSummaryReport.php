...
/**
 * Table class for discharge_summary_report
 */
class DischargeSummaryReport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "discharge_summary_report";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // admission_date
        $this->admission_date = new DbField(
            $this, // Table
            'x_admission_date', // Variable name
            'admission_date', // Name
            '`admission_date`', // Expression
            CastDateFieldForLike("`admission_date`", 7, "DB"), // Basic search expression
            135, // Type
            76, // Size
            7, // Date/Time format
            false, // Is upload field
            '`admission_date`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->admission_date->InputTextType = "text";
        $this->admission_date->Raw = true;
        $this->admission_date->Nullable = false; // NOT NULL field
        $this->admission_date->Required = true; // Required field
        $this->admission_date->DefaultErrorMessage = str_replace("%s", DateFormat(7), $Language->phrase("IncorrectDate"));
        $this->admission_date->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['admission_date'] = &$this->admission_date;

        // discharge_date
        $this->discharge_date = new DbField(
            $this, // Table
            'x_discharge_date', // Variable name
            'discharge_date', // Name
            '`discharge_date`', // Expression
            CastDateFieldForLike("`discharge_date`", 7, "DB"), // Basic search expression
            135, // Type
            76, // Size
            7, // Date/Time format
            false, // Is upload field
            '`discharge_date`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->discharge_date->InputTextType = "text";
        $this->discharge_date->Raw = true;
        $this->discharge_date->Nullable = false; // NOT NULL field
        $this->discharge_date->Required = true; // Required field
        $this->discharge_date->DefaultErrorMessage = str_replace("%s", DateFormat(7), $Language->phrase("IncorrectDate"));
        $this->discharge_date->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['discharge_date'] = &$this->discharge_date;

        // total_days
        $this->total_days = new DbField(
            $this, // Table
            'x_total_days', // Variable name
            'total_days', // Name
            '`total_days`', // Expression
            '`total_days`', // Basic search expression
            3, // Type
            9, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`total_days`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->total_days->InputTextType = "text";
        $this->total_days->Raw = true;
        $this->total_days->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->total_days->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['total_days'] = &$this->total_days;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "discharge_summary_report";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->discharge_date->DbValue = $row['discharge_date'];
        $this->total_days->DbValue = $row['total_days'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("dischargesummaryreportlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "dischargesummaryreportview" => $Language->phrase("View"),
            "dischargesummaryreportedit" => $Language->phrase("Edit"),
            "dischargesummaryreportadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "dischargesummaryreportlist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DischargeSummaryReportView",
            Config("API_ADD_ACTION") => "DischargeSummaryReportAdd",
            Config("API_EDIT_ACTION") => "DischargeSummaryReportEdit",
            Config("API_DELETE_ACTION") => "DischargeSummaryReportDelete",
            Config("API_LIST_ACTION") => "DischargeSummaryReportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("dischargesummaryreportview", $parm);
        } else {
            $url = $this->keyUrl("dischargesummaryreportview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "dischargesummaryreportadd?" . $parm;
        } else {
            $url = "dischargesummaryreportadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("dischargesummaryreportlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("dischargesummaryreportlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("dischargesummaryreportdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "DischargeSummaryReportList";
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->admission_reason->Raw) {
            $this->admission_reason->CurrentValue = HtmlDecode($this->admission_reason->CurrentValue);
        }
        ...
        if (!$this->discharge_condition->Raw) {
            $this->discharge_condition->CurrentValue = HtmlDecode($this->discharge_condition->CurrentValue);
        }
        ...
        $this->admission_date->EditValue = FormatDateTime($this->admission_date->CurrentValue, $this->admission_date->formatPattern());
        $this->admission_date->PlaceHolder = RemoveHtml($this->admission_date->caption());

        // discharge_date
        $this->discharge_date->setupEditAttributes();
        $this->discharge_date->EditValue = FormatDateTime($this->discharge_date->CurrentValue, $this->discharge_date->formatPattern());
        $this->discharge_date->PlaceHolder = RemoveHtml($this->discharge_date->caption());

        // total_days
        $this->total_days->setupEditAttributes();
        $this->total_days->EditValue = $this->total_days->CurrentValue;
        $this->total_days->PlaceHolder = RemoveHtml($this->total_days->caption());
        if (strval($this->total_days->EditValue) != "" && is_numeric($this->total_days->EditValue)) {
            $this->total_days->EditValue = FormatNumber($this->total_days->EditValue, null);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->discharge_date);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->discharge_date);

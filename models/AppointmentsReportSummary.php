 ...
 * Page class
 */
class AppointmentsReportSummary extends AppointmentsReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AppointmentsReportSummary";
    ...
    public $CurrentPageName = "appointmentsreport";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Appointments Report');
        }
    ...
    public function loadRowValues($record)
    {
        ...
        $data["doctor_name"] = $record['doctor_name'];
        ...
        $data["appointment_month"] = $record['appointment_month'];
        $this->Rows[] = $data;
        ...
        $this->doctor_name->setDbValue($record['doctor_name']);
        $this->start_date->setDbValue($record['start_date']);
        $this->end_date->setDbValue($record['end_date']);
        $this->date_created->setDbValue($record['date_created']);
        $this->date_updated->setDbValue($record['date_updated']);
        $this->appointment_month->setDbValue($record['appointment_month']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::SEARCH) { // Search row
            ...
            $this->appointment_month->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == RowType::TOTAL) { // Summary row
            ...
            // doctor_name
            $currentValue = $this->doctor_name->CurrentValue;
            $viewValue = &$this->doctor_name->ViewValue;
            $viewAttrs = &$this->doctor_name->ViewAttrs;
            $cellAttrs = &$this->doctor_name->CellAttrs;
            $hrefValue = &$this->doctor_name->HrefValue;
            $linkAttrs = &$this->doctor_name->LinkAttrs;
            $this->cellRendered($this->doctor_name, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            $this->cellRendered($this->start_date, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            $this->cellRendered($this->end_date, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            // appointment_month
            $currentValue = $this->appointment_month->CurrentValue;
            $viewValue = &$this->appointment_month->ViewValue;
            $viewAttrs = &$this->appointment_month->ViewAttrs;
            $cellAttrs = &$this->appointment_month->CellAttrs;
            $hrefValue = &$this->appointment_month->HrefValue;
            $linkAttrs = &$this->appointment_month->LinkAttrs;
            $this->cellRendered($this->appointment_month, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->appointment_month->Visible) {
            $this->DetailColumnCount += 1;
        }
    }

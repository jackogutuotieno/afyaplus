...
class ReceiveItems extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->total_items_received = new DbField(
            $this, // Table
            'x_total_items_received', // Variable name
            'total_items_received', // Name
            '`total_items_received`', // Expression
            '`total_items_received`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`total_items_received`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->total_items_received->InputTextType = "text";
        $this->total_items_received->Raw = true;
        $this->total_items_received->Nullable = false; // NOT NULL field
        $this->total_items_received->Required = true; // Required field
        $this->total_items_received->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->total_items_received->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['total_items_received'] = &$this->total_items_received;

 ...
 * Page class
 */
class PrescriptionsDelete extends Prescriptions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PrescriptionsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "prescriptionsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("prescriptionslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("prescriptionslist"); // Return to list
            return;
        }

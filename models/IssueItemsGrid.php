 ...
 * Page class
 */
class IssueItemsGrid extends IssueItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IssueItemsGrid";
    ...
    public $FormName = "fissue_itemsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "issueitemsgrid";
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_item_id") &&
            $CurrentForm->hasValue("o_item_id") &&
            $this->item_id->CurrentValue != $this->item_id->DefaultValue &&
            !($this->item_id->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->item_id->CurrentValue == $this->item_id->getSessionValue())
        ) {
            return false;
        }
        if (

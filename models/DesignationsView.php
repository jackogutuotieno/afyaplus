 ...
 * Page class
 */
class DesignationsView extends Designations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DesignationsView";
    ...
    // CSS class/style
    public $CurrentPageName = "designationsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "designationslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "designationslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("designationslist"), "", $this->TableVar, true);
        $pageId = "view";

 ...
 * Page class
 */
class FullHaemogramTestView extends FullHaemogramTest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FullHaemogramTestView";
    ...
    // CSS class/style
    public $CurrentPageName = "fullhaemogramtestview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "fullhaemogramtestlist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "fullhaemogramtestlist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("fullhaemogramtestlist"), "", $this->TableVar, true);
        $pageId = "view";

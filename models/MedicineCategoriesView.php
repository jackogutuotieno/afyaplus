 ...
 * Page class
 */
class MedicineCategoriesView extends MedicineCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedicineCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "medicinecategoriesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "medicinecategorieslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "medicinecategorieslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("medicinecategorieslist"), "", $this->TableVar, true);
        $pageId = "view";

 ...
 * Page class
 */
class LabTestRequestsDelete extends LabTestRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabTestRequestsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "labtestrequestsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("labtestrequestslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("labtestrequestslist"); // Return to list
                return;
            }
        }

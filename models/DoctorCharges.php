...
/**
 * Table class for doctor_charges
 */
class DoctorCharges extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "doctor_charges";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("doctorchargeslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "doctorchargesview" => $Language->phrase("View"),
            "doctorchargesedit" => $Language->phrase("Edit"),
            "doctorchargesadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DoctorChargesView",
            Config("API_ADD_ACTION") => "DoctorChargesAdd",
            Config("API_EDIT_ACTION") => "DoctorChargesEdit",
            Config("API_DELETE_ACTION") => "DoctorChargesDelete",
            Config("API_LIST_ACTION") => "DoctorChargesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("doctorchargesview", $parm);
        } else {
            $url = $this->keyUrl("doctorchargesview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "doctorchargesadd?" . $parm;
        } else {
            $url = "doctorchargesadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("doctorchargesedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("doctorchargeslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("doctorchargesadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("doctorchargeslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("doctorchargesdelete", $parm);
        }
    }
    ...
    {
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM doctor_charges";

 ...
 * Page class
 */
class RadiologyRequestsDetailsDelete extends RadiologyRequestsDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RadiologyRequestsDetailsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "radiologyrequestsdetailsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("radiologyrequestsdetailslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("radiologyrequestsdetailslist"); // Return to list
                return;
            }
        }

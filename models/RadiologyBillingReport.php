...
class RadiologyBillingReport extends DbTable
{
    ...
    public function rowRendered()
    {
        ...
        $this->patient_id->ViewValue = '<a href="radiologybillingreportview/' . $this->id->ViewValue . '?showdetail=radiology_billing_report_details" target="_blank">' . $this->patient_id->ViewValue . '</a>';
    }

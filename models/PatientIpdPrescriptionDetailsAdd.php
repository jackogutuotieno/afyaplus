 ...
 * Page class
 */
class PatientIpdPrescriptionDetailsAdd extends PatientIpdPrescriptionDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdPrescriptionDetailsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "patientipdprescriptiondetailsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("patientipdprescriptiondetailslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "patientipdprescriptiondetailslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "patientipdprescriptiondetailsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "patientipdprescriptiondetailslist") {
                            ...
                            $returnUrl = "patientipdprescriptiondetailslist"; // Return list page content
                        }
                    }

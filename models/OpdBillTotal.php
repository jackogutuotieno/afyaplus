...
/**
 * Table class for opd_bill_total
 */
class OpdBillTotal extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "opd_bill_total";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "opd_bill_total";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("opdbilltotallist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "opdbilltotalview" => $Language->phrase("View"),
            "opdbilltotaledit" => $Language->phrase("Edit"),
            "opdbilltotaladd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "OpdBillTotalView",
            Config("API_ADD_ACTION") => "OpdBillTotalAdd",
            Config("API_EDIT_ACTION") => "OpdBillTotalEdit",
            Config("API_DELETE_ACTION") => "OpdBillTotalDelete",
            Config("API_LIST_ACTION") => "OpdBillTotalList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("opdbilltotalview", $parm);
        } else {
            $url = $this->keyUrl("opdbilltotalview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdbilltotaledit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdbilltotallist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdbilltotaladd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("opdbilltotallist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("opdbilltotaldelete", $parm);
        }
    }

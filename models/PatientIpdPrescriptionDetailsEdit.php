 ...
 * Page class
 */
class PatientIpdPrescriptionDetailsEdit extends PatientIpdPrescriptionDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientIpdPrescriptionDetailsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "patientipdprescriptiondetailsedit";

 ...
 * Page class
 */
class LabTestRequestsDetailsEdit extends LabTestRequestsDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabTestRequestsDetailsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "labtestrequestsdetailsedit";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->specimen_id->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->specimen_id->setFormValue($val, true, $validate);
            }
        }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if (!CheckInteger($this->specimen_id->FormValue)) {
                $this->specimen_id->addErrorMessage($this->specimen_id->getErrorMessage(false));
            }

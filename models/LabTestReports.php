...
/**
 * Table class for lab_test_reports
 */
class LabTestReports extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "lab_test_reports";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("labtestreportslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "labtestreportsview" => $Language->phrase("View"),
            "labtestreportsedit" => $Language->phrase("Edit"),
            "labtestreportsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "LabTestReportsView",
            Config("API_ADD_ACTION") => "LabTestReportsAdd",
            Config("API_EDIT_ACTION") => "LabTestReportsEdit",
            Config("API_DELETE_ACTION") => "LabTestReportsDelete",
            Config("API_LIST_ACTION") => "LabTestReportsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("labtestreportsview", $parm);
        } else {
            $url = $this->keyUrl("labtestreportsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "labtestreportsadd?" . $parm;
        } else {
            $url = "labtestreportsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labtestreportsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labtestreportslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labtestreportsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("labtestreportslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("labtestreportsdelete", $parm);
        }
    }
    ...
    {
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM lab_test_reports";
    ...
    public function addDetailUserIDFilter($filter, $currentMasterTable)
    {
        ...
        if ($currentMasterTable == "lab_test_requests_details") {
            ...
            if (!$mastertable->userIDAllow()) {
                $subqueryWrk = $mastertable->getUserIDSubquery($this->lab_test_requests_details_id, $mastertable->id);

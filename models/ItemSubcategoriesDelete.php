 ...
 * Page class
 */
class ItemSubcategoriesDelete extends ItemSubcategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemSubcategoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "itemsubcategoriesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("itemsubcategorieslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("itemsubcategorieslist"); // Return to list
                return;
            }
        }

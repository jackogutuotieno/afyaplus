 ...
 * Page class
 */
class FullHaemogramParametersAdd extends FullHaemogramParameters
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FullHaemogramParametersAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "fullhaemogramparametersadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "fullhaemogramparametersview") {

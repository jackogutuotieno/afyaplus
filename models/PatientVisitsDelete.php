 ...
 * Page class
 */
class PatientVisitsDelete extends PatientVisits
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientVisitsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "patientvisitsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientvisitslist"); // Prevent SQL injection, return to list
            return;
        }

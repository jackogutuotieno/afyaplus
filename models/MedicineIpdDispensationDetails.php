...
/**
 * Table class for medicine_ipd_dispensation_details
 */
class MedicineIpdDispensationDetails extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "medicine_ipd_dispensation_details";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    public function getMasterFilterFromSession()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "medicine_ipd_dispensation") {
            $masterTable = Container("medicine_ipd_dispensation");
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "medicine_ipd_dispensation":
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "medicine_ipd_dispensation_details";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("medicineipddispensationdetailslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "medicineipddispensationdetailsview" => $Language->phrase("View"),
            "medicineipddispensationdetailsedit" => $Language->phrase("Edit"),
            "medicineipddispensationdetailsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "medicineipddispensationdetailslist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MedicineIpdDispensationDetailsView",
            Config("API_ADD_ACTION") => "MedicineIpdDispensationDetailsAdd",
            Config("API_EDIT_ACTION") => "MedicineIpdDispensationDetailsEdit",
            Config("API_DELETE_ACTION") => "MedicineIpdDispensationDetailsDelete",
            Config("API_LIST_ACTION") => "MedicineIpdDispensationDetailsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("medicineipddispensationdetailsview", $parm);
        } else {
            $url = $this->keyUrl("medicineipddispensationdetailsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "medicineipddispensationdetailsadd?" . $parm;
        } else {
            $url = "medicineipddispensationdetailsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicineipddispensationdetailsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicineipddispensationdetailslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicineipddispensationdetailsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("medicineipddispensationdetailslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("medicineipddispensationdetailsdelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "medicine_ipd_dispensation" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
    ...
    {
        global $Response;
        $listPage = "MedicineIpdDispensationDetailsList";

 ...
 * Page class
 */
class UrinalysisReportAdd extends UrinalysisReport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UrinalysisReportAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "urinalysisreportadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("urinalysisreportlist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "urinalysisreportlist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "urinalysisreportview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "urinalysisreportlist") {
                            ...
                            $returnUrl = "urinalysisreportlist"; // Return list page content
                        }
                    }
    ...
    protected function getAddRow()
    {
        ...
        // lab_test_reports_id
        $this->lab_test_reports_id->setDbValueDef($rsnew, $this->lab_test_reports_id->CurrentValue, false);

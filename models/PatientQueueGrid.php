 ...
 * Page class
 */
class PatientQueueGrid extends PatientQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientQueueGrid";
    ...
    public $FormName = "fpatient_queuegrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "patientqueuegrid";

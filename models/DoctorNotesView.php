 ...
 * Page class
 */
class DoctorNotesView extends DoctorNotes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DoctorNotesView";
    ...
    // CSS class/style
    public $CurrentPageName = "doctornotesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "doctornoteslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "doctornoteslist"; // No matching record, return to list
                    }
                break;
        }

 ...
 * Page class
 */
class PaymentMethodsEdit extends PaymentMethods
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PaymentMethodsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "paymentmethodsedit";
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['payment_method'])) { // payment_method
            $this->payment_method->CurrentValue = $row['payment_method'];
        }
